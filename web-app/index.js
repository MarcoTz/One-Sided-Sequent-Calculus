(() => {
  ...
  var applySecond = function(dictApply) {
    ...
    return function(a2) {
      return function(b2) {
        return apply1(map52($$const(identity2))(a2))(b2);
      };
    };
  };
  ...
  var showMaybe = function(dictShow) {
    var show51 = show(dictShow);
    return {
      show: function(v) {
        if (v instanceof Just) {
          return "(Just " + (show51(v.value0) + ")");
        }
        ;
  ...
  var showTuple = function(dictShow) {
    ...
    return function(dictShow1) {
      var show125 = show(dictShow1);
      return {
        show: function(v) {
          return "(Tuple " + (show51(v.value0) + (" " + (show125(v.value1) + ")")));
        }
      };
    };
  };
  ...
  var traversableMaybe = {
    traverse: function(dictApplicative) {
      ...
      return function(v) {
        return function(v1) {
          ...
          ;
          if (v1 instanceof Just) {
            return map52(Just.create)(v(v1.value0));
          }
          ;
    ...
    sequence: function(dictApplicative) {
      ...
      return function(v) {
        ...
        ;
        if (v instanceof Just) {
          return map52(Just.create)(v.value0);
        }
        ;
  ...
  var showNonEmpty = function(dictShow) {
    ...
    return function(dictShow1) {
      ...
      return {
        show: function(v) {
          return "(NonEmpty " + (show51(v.value0) + (" " + (show125(v.value1) + ")")));
        }
      };
    };
  };
  ...
  var showList = function(dictShow) {
    ...
    return {
      show: function(v) {
        ...
        ;
        return "(" + (intercalate2(" : ")(map4(show51)(v)) + " : Nil)");
      }
    };
  };
  var showNonEmptyList = function(dictShow) {
    var show51 = show(showNonEmpty(dictShow)(showList(dictShow)));
    return {
      show: function(v) {
        return "(NonEmptyList " + (show51(v) + ")");
      }
    };
  };
  var traversableList = {
              ...
              return function($copy_v2) {
                ...
                function $tco_loop(v, v1, v2) {
                  ...
                  if (v instanceof Cons && v1 instanceof Cons) {
                    ...
                    $copy_v2 = v2 && eq27(v1.value0)(v.value0);
                    return;
                  }
                  ;
                  $tco_done = true;
  ...
  var monadErrorExceptT = function(dictMonad) {
    ...
    return {
      catchError: function(v) {
        return function(k) {
          return bind30(v)(either(function(a2) {
            var v1 = k(a2);
            return v1;
          })(function($200) {
            return pure35(Right.create($200));
          }));
        };
      },
    ...
    return function(dictAlternative) {
      ...
      return function(p2) {
        var go2 = function(acc) {
          return bind113(alt11(map117(Loop.create)(p2))(pure35(new Done(unit))))(function(aa) {
            return pure35(bimap2(function(v) {
  ...
  // output/Loc/index.js
  var SourcePosition = /* @__PURE__ */ function() {
    function SourcePosition2(value0) {
      this.value0 = value0;
    }
    ;
    SourcePosition2.create = function(value0) {
      return new SourcePosition2(value0);
    };
    return SourcePosition2;
  }();
  var Loc = /* @__PURE__ */ function() {
    function Loc2(value0) {
      this.value0 = value0;
    }
    ;
    Loc2.create = function(value0) {
      return new Loc2(value0);
    };
    return Loc2;
  }();
  ...
  var eqSourcePosition = {
    eq: function(x) {
      return function(y) {
        return x.value0.srcCol === y.value0.srcCol && x.value0.srcLine === y.value0.srcLine;
      };
    }
  };
  var eq13 = /* @__PURE__ */ eq(eqSourcePosition);
  var eqLoc = {
    eq: function(x) {
      return function(y) {
        return eq13(x.value0.locEnd)(y.value0.locEnd) && eq13(x.value0.locStart)(y.value0.locStart);
      };
    }
  };
  var defaultPos = /* @__PURE__ */ function() {
    return new SourcePosition({
      srcLine: 0,
      srcCol: 0
    });
  }();
  var defaultLoc = /* @__PURE__ */ function() {
    return new Loc({
      locStart: defaultPos,
      locEnd: defaultPos
    });
  ...
  var zipWithErrorM = function(dictError) {
    ...
    return function(dictMonadError) {
      ...
      var pure35 = pure(MonadThrow0.Monad0().Applicative0());
  ...
  var ErrWithWhere = /* @__PURE__ */ function() {
    function ErrWithWhere2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    ErrWithWhere2.create = function(value0) {
      return function(value1) {
        return new ErrWithWhere2(value0, value1);
      };
    };
  ...
  var ErrOther = /* @__PURE__ */ function() {
    ...
    ;
    ErrOther8.create = function(value0) {
      return function(value1) {
        return new ErrOther8(value0, value1);
      };
    };
    return ErrOther8;
  }();
    ...
    return {
      getMessage: function(v) {
        ...
        if (v instanceof ErrWithWhere) {
          return getMessage(errorDriverError)(v.value0) + (" during " + v.value1);
        }
        ;
        ...
        ;
        throw new Error("Failed pattern match at Driver.Errors (line 13, column 1 - line 22, column 21): " + [v.constructor.name]);
      },
            ...
            return function($copy_b) {
              ...
              function $tco_loop(a2, b2) {
                ...
                if (v instanceof IterNext) {
                  var v2 = stepAsc(b2);
                  if (v2 instanceof IterNext && (eq111(v.value0)(v2.value0) && eq27(v.value1)(v2.value1))) {
                    $tco_var_a = v.value2;
                    $copy_b = v2.value2;
                    return;
                  }
  ...
  var showMap = function(dictShow) {
    ...
    return function(dictShow1) {
      var show125 = show(showArray(showTuple2(dictShow1)));
      return {
        show: function(as) {
          return "(fromFoldable " + (show125(toUnfoldable1(as)) + ")");
        }
      };
    };
  };
  ...
  var traversableMap = {
    traverse: function(dictApplicative) {
      ...
      return function(f) {
        var go2 = function(v) {
          if (v instanceof Leaf) {
            return pure35(Leaf.value);
          }
          ;
          if (v instanceof Node) {
            return apply3(apply3(map117(function(l$prime) {
  ...
  var eqSet = function(dictEq) {
    var eq27 = eq(eqMap(dictEq)(eqUnit));
    return {
      eq: function(v) {
        return function(v1) {
          return eq27(v)(v1);
  ...
  var MkKind = /* @__PURE__ */ function() {
    function MkKind2(value0) {
      this.value0 = value0;
    }
    ;
    MkKind2.create = function(value0) {
      return new MkKind2(value0);
    };
    return MkKind2;
  }();
  var MkKindVar = /* @__PURE__ */ function() {
    function MkKindVar2(value0) {
      this.value0 = value0;
    }
    ;
    MkKindVar2.create = function(value0) {
      return new MkKindVar2(value0);
    };
    return MkKindVar2;
  }();
  ...
  var showVariance = {
    show: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Common (line 98, column 1 - line 100, column 27): " + [v.constructor.name]);
    }
  };
  ...
  var show3 = /* @__PURE__ */ show(showKindvar);
  var showEvaluationOrder = {
    show: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Common (line 114, column 1 - line 116, column 19): " + [v.constructor.name]);
    }
  };
  var show4 = /* @__PURE__ */ show(showEvaluationOrder);
  var showKind = {
    show: function(v) {
      if (v instanceof MkKind) {
        return show4(v.value0);
      }
      ;
      if (v instanceof MkKindVar) {
        return show3(v.value0);
      }
      ;
      throw new Error("Failed pattern match at Common (line 121, column 1 - line 123, column 32): " + [v.constructor.name]);
    }
  };
  var showDeclTy = {
    show: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Common (line 156, column 1 - line 158, column 25): " + [v.constructor.name]);
    }
  };
  var shiftEvalOrderEvaluationO = {
    shiftEvalOrder: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Common (line 127, column 1 - line 129, column 27): " + [v.constructor.name]);
    }
  };
  ...
  var varianceEvalOrder = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Common (line 146, column 1 - line 146, column 68): " + [v.constructor.name]);
  };
  var shiftEvalOrderKind = {
    shiftEvalOrder: function(v) {
      if (v instanceof MkKind) {
        return new MkKind(shiftEvalOrder1(v.value0));
      }
      ;
      if (v instanceof MkKindVar) {
        return v;
      ...
      ;
      throw new Error("Failed pattern match at Common (line 131, column 1 - line 133, column 38): " + [v.constructor.name]);
    }
  };
  ...
  var eq32 = /* @__PURE__ */ eq(eqKindvar);
  ...
  var eq4 = /* @__PURE__ */ eq(eqEvaluationOrder);
  var eqKind = {
    eq: function(x) {
      return function(y) {
        if (x instanceof MkKind && y instanceof MkKind) {
          return eq4(x.value0)(y.value0);
        }
        ;
        if (x instanceof MkKindVar && y instanceof MkKindVar) {
  ...
  var defaultEo = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Common (line 160, column 1 - line 160, column 39): " + [v.constructor.name]);
  };
  ...
  var showTy = {
    show: function(v) {
      ...
      if (v instanceof TyForall) {
        return "forall " + (intercalate3(" ")(map8(show5)(v.value0)) + (". " + show(showTy)(v.value1)));
      }
      ;
      throw new Error("Failed pattern match at Syntax.Desugared.Types (line 19, column 1 - line 25, column 92): " + [v.constructor.name]);
    }
  };
  var eqTy = {
    eq: function(x) {
      return function(y) {
        ...
        if (x instanceof TyDecl && y instanceof TyDecl) {
          return eq14(x.value0)(y.value0) && eq(eqList(eqTy))(x.value1)(y.value1);
        }
        ;
  ...
  var show6 = /* @__PURE__ */ show(showTypevar);
  ...
  var eq15 = /* @__PURE__ */ eq(eqTypename);
  var eq23 = /* @__PURE__ */ eq(/* @__PURE__ */ eqList(eqTypevar));
  var elem2 = /* @__PURE__ */ elem(foldableList)(eqTypevar);
  ...
  var showTy2 = {
    show: function(v) {
      ...
      if (v instanceof TyForall2) {
        return intercalate4(" ")(map9(show6)(v.value0)) + (". " + show(showTy2)(v.value1));
      }
      ;
      throw new Error("Failed pattern match at Syntax.Typed.Types (line 22, column 1 - line 29, column 79): " + [v.constructor.name]);
    }
  };
  var eqTy2 = {
    eq: function(x) {
      return function(y) {
        ...
        if (x instanceof TyDecl2 && y instanceof TyDecl2) {
          return eq15(x.value0)(y.value0) && eq(eqList(eqTy2))(x.value1)(y.value1);
        }
        ;
  ...
  var isSubsumed = function(v) {
    return function(v1) {
      ...
      if (v1 instanceof TyForall2) {
        if (v1.value1 instanceof TyVar2) {
          return elem2(v1.value1.value0)(v1.value0);
        }
        ;
        if (v1.value1 instanceof TyDecl2) {
          return isSubsumed(v)(new TyDecl2(v1.value1.value0, map9(TyForall2.create(v1.value0))(v1.value1.value1)));
        }
        ;
        if (v1.value1 instanceof TyShift2) {
          return isSubsumed(v)(new TyShift2(new TyForall2(v1.value0, v1.value1.value0)));
        }
        ;
        if (v1.value1 instanceof TyCo2) {
          return isSubsumed(v)(new TyCo2(new TyForall2(v1.value0, v1.value1.value0)));
        }
        ;
        if (v1.value1 instanceof TyForall2) {
          return isSubsumed(v)(new TyForall2(append12(v1.value0)(v1.value1.value0), v1.value1.value1));
        }
        ;
        throw new Error("Failed pattern match at Syntax.Typed.Types (line 38, column 37 - line 43, column 69): " + [v1.value1.constructor.name]);
      }
      ;
      ...
      if (v instanceof TyDecl2 && v1 instanceof TyDecl2) {
        return eq15(v.value0)(v1.value0) && $$null(filter(identity9)(map9(function(v2) {
          return isSubsumed(v2.value0)(v2.value1);
  ...
  var embedType = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Syntax.Typed.Types (line 51, column 1 - line 51, column 24): " + [v.constructor.name]);
  };

  // output/Syntax.Kinded.Types/index.js
  var show7 = /* @__PURE__ */ show(showTypevar);
  var show14 = /* @__PURE__ */ show(showKind);
  var show23 = /* @__PURE__ */ show(showTypename);
  var intercalate5 = /* @__PURE__ */ intercalate(foldableList)(monoidString);
  var map10 = /* @__PURE__ */ map(functorList);
  var shiftEvalOrder2 = /* @__PURE__ */ shiftEvalOrder(shiftEvalOrderKind);
  var eq7 = /* @__PURE__ */ eq(eqTypevar);
  var eq16 = /* @__PURE__ */ eq(eqKind);
  var eq24 = /* @__PURE__ */ eq(eqTypename);
  var eq33 = /* @__PURE__ */ eq(/* @__PURE__ */ eqList(eqTypevar));
  ...
  var showTy3 = {
    show: function(v) {
      if (v instanceof TyVar3) {
        return show7(v.value0) + (" : " + show14(v.value1));
      }
      ;
      if (v instanceof TyDecl3 && $$null(v.value1)) {
        return show23(v.value0) + (": " + show14(v.value2));
      }
      ;
      if (v instanceof TyDecl3) {
        return show23(v.value0) + ("(" + (intercalate5(", ")(map10(show(showTy3))(v.value1)) + (") :" + show14(v.value2))));
      }
      ;
      if (v instanceof TyShift3) {
        return "{" + (show(showTy3)(v.value0) + ("}" + (":" + show14(v.value1))));
      }
      ;
      ...
      if (v instanceof TyForall3) {
        return "forall " + (intercalate5(", ")(map10(show7)(v.value0)) + (", " + show(showTy3)(v.value1)));
      }
      ;
      throw new Error("Failed pattern match at Syntax.Kinded.Types (line 19, column 1 - line 26, column 93): " + [v.constructor.name]);
    }
  };
  var shiftEvalOrderTy = {
    shiftEvalOrder: function(v) {
      ...
      ;
      if (v instanceof TyDecl3) {
        return new TyDecl3(v.value0, map10(shiftEvalOrder(shiftEvalOrderTy))(v.value1), shiftEvalOrder2(v.value2));
      }
      ;
      if (v instanceof TyShift3) {
    ...
    eq: function(x) {
      return function(y) {
        if (x instanceof TyVar3 && y instanceof TyVar3) {
          return eq7(x.value0)(y.value0) && eq16(x.value1)(y.value1);
        }
        ;
        if (x instanceof TyDecl3 && y instanceof TyDecl3) {
          return eq24(x.value0)(y.value0) && eq(eqList(eqTy3))(x.value1)(y.value1) && eq16(x.value2)(y.value2);
        }
        ;
        if (x instanceof TyShift3 && y instanceof TyShift3) {
          return eq(eqTy3)(x.value0)(y.value0) && eq16(x.value1)(y.value1);
        }
        ;
        ...
        if (x instanceof TyForall3 && y instanceof TyForall3) {
          return eq33(x.value0)(y.value0) && eq(eqTy3)(x.value1)(y.value1);
        }
        ;
        return false;
      };
  ...
  var embedType2 = function(v) {
    ...
    ;
    if (v instanceof TyDecl3) {
      return new TyDecl2(v.value0, map10(embedType2)(v.value1));
    }
    ;
    if (v instanceof TyShift3) {
  ...
  var show8 = /* @__PURE__ */ show(showVariable);
  var show15 = /* @__PURE__ */ show(showTy3);
  var show24 = /* @__PURE__ */ show(showXtorname);
  ...
  var eq8 = /* @__PURE__ */ eq(eqLoc);
  var eq17 = /* @__PURE__ */ eq(eqVariable);
  var eq25 = /* @__PURE__ */ eq(eqTy3);
  var eq34 = /* @__PURE__ */ eq(eqXtorname);
  var eq43 = /* @__PURE__ */ eq(/* @__PURE__ */ eqList(eqVariable));
  var eq52 = /* @__PURE__ */ eq(eqEvaluationOrder);
  ...
  var XCase = /* @__PURE__ */ function() {
    function XCase5(value0, value1, value22) {
      this.value0 = value0;
      this.value1 = value1;
      this.value2 = value22;
    }
    ;
    XCase5.create = function(value0) {
      return function(value1) {
        return function(value22) {
          return new XCase5(value0, value1, value22);
        };
      };
    };
    return XCase5;
  ...
  var showTerm = {
    show: function(v) {
      if (v instanceof Var) {
        return show8(v.value1) + (" : " + show15(v.value2));
      }
      ;
      if (v instanceof Mu) {
        return show8(v.value1) + (", " + (show(showCommand)(v.value2) + (" : " + show15(v.value3))));
      }
      ;
      if (v instanceof Xtor && $$null(v.value2)) {
        return show24(v.value1) + (" : " + show15(v.value3));
      }
      ;
      if (v instanceof Xtor) {
        return show24(v.value1) + ("(" + (intercalate6(", ")(map11(show(showTerm))(v.value2)) + (") : " + show15(v.value3))));
      }
      ;
      if (v instanceof XCase) {
        return "case { " + (intercalate6(", ")(map11(show(showPattern))(v.value1)) + (" }" + (": " + show15(v.value2))));
      }
      ;
      if (v instanceof ShiftCBV) {
        return "{" + (show(showTerm)(v.value1) + (":CBV} : " + show15(v.value2)));
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Syntax.Kinded.Terms (line 55, column 1 - line 62, column 66): " + [v.constructor.name]);
    }
  };
  var showPattern = {
    show: function(v) {
      if ($$null(v.value0.ptv)) {
        return show24(v.value0.ptxt) + (" => " + show(showCommand)(v.value0.ptcmd));
      }
      ;
      return show24(v.value0.ptxt) + ("(" + (intercalate6(", ")(map11(show8)(v.value0.ptv)) + (") =>" + show(showCommand)(v.value0.ptcmd))));
    }
  };
  var showCommand = {
    show: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Syntax.Kinded.Terms (line 24, column 1 - line 28, column 40): " + [v.constructor.name]);
    }
  };
  var hasLocTerm = {
    getLoc: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Syntax.Kinded.Terms (line 64, column 1 - line 77, column 51): " + [v.constructor.name]);
    },
    setLoc: function(v) {
      return function(v1) {
        if (v1 instanceof Var) {
          return new Var(v, v1.value1, v1.value2);
        }
        ;
        if (v1 instanceof Mu) {
          return new Mu(v, v1.value1, v1.value2, v1.value3);
        }
        ;
        if (v1 instanceof Xtor) {
          return new Xtor(v, v1.value1, v1.value2, v1.value3);
        }
        ;
        if (v1 instanceof XCase) {
          return new XCase(v, v1.value1, v1.value2);
        }
        ;
        if (v1 instanceof ShiftCBV) {
          return new ShiftCBV(v, v1.value1, v1.value2);
        }
        ;
        if (v1 instanceof ShiftCBN) {
          return new ShiftCBN(v, v1.value1, v1.value2);
        }
        ;
        throw new Error("Failed pattern match at Syntax.Kinded.Terms (line 64, column 1 - line 77, column 51): " + [v.constructor.name, v1.constructor.name]);
      };
    }
  };
  var hasLocCommand = {
    getLoc: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Syntax.Kinded.Terms (line 30, column 1 - line 39, column 39): " + [v.constructor.name]);
    },
    setLoc: function(v) {
      return function(v1) {
        ...
        ;
        throw new Error("Failed pattern match at Syntax.Kinded.Terms (line 30, column 1 - line 39, column 39): " + [v.constructor.name, v1.constructor.name]);
      };
    }
  };
  var isValue = function(v) {
    return function(v1) {
      ...
      if (v instanceof CBV && v1 instanceof Xtor) {
        return $$null(filter(identity10)(map11(isValue(CBV.value))(v1.value2)));
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Syntax.Kinded.Terms (line 98, column 1 - line 98, column 46): " + [v.constructor.name, v1.constructor.name]);
    };
  };
    ...
    eq: function(x) {
      return function(y) {
        if (x instanceof Var && y instanceof Var) {
          return eq8(x.value0)(y.value0) && eq17(x.value1)(y.value1) && eq25(x.value2)(y.value2);
        }
        ;
        if (x instanceof Mu && y instanceof Mu) {
          return eq8(x.value0)(y.value0) && eq17(x.value1)(y.value1) && eq(eqCommand)(x.value2)(y.value2) && eq25(x.value3)(y.value3);
        }
        ;
        if (x instanceof Xtor && y instanceof Xtor) {
          return eq8(x.value0)(y.value0) && eq34(x.value1)(y.value1) && eq(eqList(eqTerm))(x.value2)(y.value2) && eq25(x.value3)(y.value3);
        }
        ;
        if (x instanceof XCase && y instanceof XCase) {
          return eq8(x.value0)(y.value0) && eq(eqList(eqPattern))(x.value1)(y.value1) && eq25(x.value2)(y.value2);
        }
        ;
        if (x instanceof ShiftCBV && y instanceof ShiftCBV) {
          return eq8(x.value0)(y.value0) && eq(eqTerm)(x.value1)(y.value1) && eq25(x.value2)(y.value2);
        }
        ;
  ...
  var eqPattern = {
    eq: function(x) {
      return function(y) {
        return eq(eqCommand)(x.value0.ptcmd)(y.value0.ptcmd) && eq43(x.value0.ptv)(y.value0.ptv) && eq34(x.value0.ptxt)(y.value0.ptxt);
      };
    }
  };
  var eqCommand = {
    eq: function(x) {
      return function(y) {
        if (x instanceof Cut && y instanceof Cut) {
          return eq8(x.value0)(y.value0) && eq(eqTerm)(x.value1)(y.value1) && eq52(x.value2)(y.value2) && eq(eqTerm)(x.value3)(y.value3);
        }
        ;
        ...
        if (x instanceof Print && y instanceof Print) {
          return eq8(x.value0)(y.value0) && eq(eqTerm)(x.value1)(y.value1);
        }
        ;
        return false;
      };
  ...
  var XCase2 = /* @__PURE__ */ function() {
    ...
    XCase5.create = function(value0) {
      return function(value1) {
        return new XCase5(value0, value1);
      };
    };
    return XCase5;
  }();
  ...
  var showTerm2 = {
    show: function(v) {
      ...
      if (v instanceof Xtor2 && $$null(v.value2)) {
        return show16(v.value1);
      }
      ;
      if (v instanceof Xtor2) {
        return show16(v.value1) + ("(" + (intercalate7(", ")(map12(show(showTerm2))(v.value2)) + ")"));
      }
      ;
      if (v instanceof XCase2) {
        return "case " + intercalate7(", ")(map12(show(showPattern2))(v.value1));
      }
      ;
  ...
  var showPattern2 = {
    show: function(v) {
      if ($$null(v.value0.ptv)) {
        return show16(v.value0.ptxt) + ("=>" + show(showCommand2)(v.value0.ptcmd));
      }
      ;
      return show16(v.value0.ptxt) + ("(" + (intercalate7(", ")(map12(show9)(v.value0.ptv)) + (") => " + show(showCommand2)(v.value0.ptcmd))));
    }
  };
  var showCommand2 = {
    show: function(v) {
      if (v instanceof Cut2) {
        return "<" + (show(showTerm2)(v.value1) + (" | " + (show25(v.value2) + (" | " + (show(showTerm2)(v.value3) + " >")))));
      }
      ;
      if (v instanceof CutAnnot) {
        return "<" + (show(showTerm2)(v.value1) + (" | " + (show33(v.value2) + (" : " + (show25(v.value3) + (" | " + show(showTerm2)(v.value4)))))));
      }
      ;
  ...
  var RecDecl = /* @__PURE__ */ function() {
    function RecDecl5(value0) {
      this.value0 = value0;
    }
    ;
    RecDecl5.create = function(value0) {
      return new RecDecl5(value0);
    };
    return RecDecl5;
  }();
  ...
  var addRecProgram = function(v) {
    return function(v1) {
      return new Program({
        ...
        progMain: v1.value0.progMain,
        progSrc: v1.value0.progSrc,
        progRecs: insert3(v.value0.recName)(new RecDecl(v.value0))(v1.value0.progRecs)
      });
    };
  };
  ...
  var show10 = /* @__PURE__ */ show(showVariable);
  var show17 = /* @__PURE__ */ show(showTy2);
  var show26 = /* @__PURE__ */ show(showXtorname);
  var intercalate8 = /* @__PURE__ */ intercalate(foldableList)(monoidString);
  var map13 = /* @__PURE__ */ map(functorList);
  var show34 = /* @__PURE__ */ show(showEvaluationOrder);
  ...
  var showTerm3 = {
    show: function(v) {
      if (v instanceof Var3) {
        return show10(v.value1) + (": " + show17(v.value2));
      }
      ;
      if (v instanceof Mu3) {
        return show10(v.value1) + (", " + (show(showCommand3)(v.value2) + (": " + show17(v.value3))));
      }
      ;
      if (v instanceof Xtor3) {
        return show26(v.value1) + (intercalate8(", ")(map13(show(showTerm3))(v.value2)) + (": " + show17(v.value3)));
      }
      ;
      if (v instanceof XCase3) {
        return " case { " + (intercalate8(", ")(map13(show(showPattern3))(v.value1)) + (": " + show17(v.value2)));
      }
      ;
      if (v instanceof ShiftCBV3) {
        return "{" + (show(showTerm3)(v.value1) + (":CBV} : " + show17(v.value2)));
      }
      ;
      if (v instanceof ShiftCBN3) {
        return "{" + (show(showTerm3)(v.value1) + (":CBM} : " + show17(v.value2)));
      }
      ;
      throw new Error("Failed pattern match at Syntax.Typed.Terms (line 57, column 1 - line 63, column 66): " + [v.constructor.name]);
    }
  };
  var showPattern3 = {
    show: function(v) {
      if ($$null(v.value0.ptv)) {
        return show26(v.value0.ptxt) + (" => " + show(showCommand3)(v.value0.ptcmd));
      }
      ;
      return show26(v.value0.ptxt) + ("(" + (intercalate8(", ")(map13(show10)(v.value0.ptv)) + (" => " + show(showCommand3)(v.value0.ptcmd))));
    }
  };
  var showCommand3 = {
    show: function(v) {
      if (v instanceof Cut3) {
        return "<" + (show(showTerm3)(v.value1) + (" | " + (show34(v.value2) + (" | " + show(showTerm3)(v.value3)))));
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Syntax.Typed.Terms (line 27, column 1 - line 31, column 39): " + [v.constructor.name]);
    }
  };
  var setType = function(v) {
    return function(v1) {
      ...
      ;
      throw new Error("Failed pattern match at Syntax.Typed.Terms (line 88, column 1 - line 88, column 30): " + [v.constructor.name, v1.constructor.name]);
    };
  };
  var getType2 = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Syntax.Typed.Terms (line 80, column 1 - line 80, column 22): " + [v.constructor.name]);
  };
  ...
  var RecDecl2 = /* @__PURE__ */ function() {
    function RecDecl5(value0) {
      this.value0 = value0;
    }
    ;
  ...
  var embedXtorSig = function(v) {
    return new XtorSig({
      ...
      sigArgs: map14(embedType)(v.value0.sigArgs)
    });
  };

  // output/Syntax.Kinded.Program/index.js
  var show11 = /* @__PURE__ */ show(showXtorname);
  var intercalate9 = /* @__PURE__ */ intercalate(foldableList)(monoidString);
  var map15 = /* @__PURE__ */ map(functorList);
  var show18 = /* @__PURE__ */ show(showTy3);
  var show27 = /* @__PURE__ */ show(showVariable);
  var show35 = /* @__PURE__ */ show(showTerm);
  var show45 = /* @__PURE__ */ show(showDeclTy);
  var show52 = /* @__PURE__ */ show(showTypename);
  var show62 = /* @__PURE__ */ show(showVariantVar);
  var eq9 = /* @__PURE__ */ eq(/* @__PURE__ */ eqMaybe(eqCommand));
  var show72 = /* @__PURE__ */ show(showModulename);
  var showMap2 = /* @__PURE__ */ showMap(showVariable);
  var show82 = /* @__PURE__ */ show(/* @__PURE__ */ showMaybe(showCommand));
  ...
  var RecDecl3 = /* @__PURE__ */ function() {
    function RecDecl5(value0) {
      this.value0 = value0;
    }
    ;
  ...
  var showXtorSig = {
    show: function(v) {
      if ($$null(v.value0.sigArgs)) {
        return show11(v.value0.sigName);
      }
      ;
      return show11(v.value0.sigName) + ("(" + intercalate9(", ")(map15(show18)(v.value0.sigArgs)));
    }
  };
  var show92 = /* @__PURE__ */ show(showXtorSig);
  var showVarDecl = {
    show: function(v) {
      return show27(v.value0.varName) + (" : " + (show18(v.value0.varTy) + (" := " + show35(v.value0.varBody))));
    }
  };
  var show102 = /* @__PURE__ */ show(/* @__PURE__ */ showMap2(showVarDecl));
  var showRecDecl = {
    show: function(v) {
      return "rec " + (show27(v.value0.recName) + (": " + (show18(v.value0.recTy) + (" := " + show35(v.value0.recBody)))));
    }
  };
  var show112 = /* @__PURE__ */ show(/* @__PURE__ */ showMap2(showRecDecl));
  var showDataDecl = {
    show: function(v) {
      if ($$null(v.value0.declArgs)) {
        return show45(v.value0.declType) + (" " + (show52(v.value0.declName) + ("{" + intercalate9(", ")(map15(show92)(v.value0.declXtors)))));
      }
      ;
      return show45(v.value0.declType) + (" " + (show52(v.value0.declName) + ("(" + (intercalate9(", ")(map15(show62)(v.value0.declArgs)) + (") {" + intercalate9(", ")(map15(show92)(v.value0.declXtors)))))));
    }
  };
  var show122 = /* @__PURE__ */ show(/* @__PURE__ */ showMap(showTypename)(showDataDecl));
  var showProgram = {
    show: function(v) {
      if (eq9(Nothing.value)(v.value0.progMain)) {
        return "Module " + (show72(v.value0.progName) + ("\n " + ("Declarations: " + (show122(v.value0.progDecls) + ("\n " + ("Variables: " + (show102(v.value0.progVars) + ("\n " + ("Recursive Definitions: " + (show112(v.value0.progRecs) + "\n"))))))))));
      }
      ;
      return "Module " + (show72(v.value0.progName) + ("\n " + ("Declarations: " + (show122(v.value0.progDecls) + ("\n " + ("Variables: " + (show102(v.value0.progVars) + ("\n " + ("Recursive Definitions: " + (show112(v.value0.progRecs) + ("\n" + ("Main: " + show82(v.value0.progMain)))))))))))));
    }
  };
  var isEmpty2 = function(v) {
    return isEmpty(v.value0.progDecls) && (isEmpty(v.value0.progVars) && (isEmpty(v.value0.progRecs) && eq9(Nothing.value)(v.value0.progMain)));
  };
  var getXtors = function(v) {
    return v.value0.declXtors;
  };
  var getXtorname = function(v) {
    return v.value0.sigName;
  };
  var getVarsProgram = function(v) {
    return v.value0.progVars;
  };
  var getRecsProgram = function(v) {
    return v.value0.progRecs;
  };
  var getDeclsProgram = function(v) {
  ...
  var embedXtorSig2 = function(v) {
    return new XtorSig2({
      sigPos: v.value0.sigPos,
      sigName: v.value0.sigName,
      sigArgs: map15(embedType2)(v.value0.sigArgs)
    });
  };
  ...
  var addRecProgram2 = function(v) {
    return function(v1) {
      return new Program2({
        ...
        progMain: v1.value0.progMain,
        progSrc: v1.value0.progSrc,
        progRecs: insert4(v.value0.recName)(new RecDecl3(v.value0))(v1.value0.progRecs)
      });
    };
  };
  ...
  var show19 = /* @__PURE__ */ show(showProgram);
  ...
  var eq10 = /* @__PURE__ */ eq(eqXtorname);
  var find1 = /* @__PURE__ */ find(foldableMap);
  var elem3 = /* @__PURE__ */ elem(foldableList)(eqXtorname);
  var show36 = /* @__PURE__ */ show(showTypename);
  var insert5 = /* @__PURE__ */ insert(ordModulename);
  var showEnvironment = {
    show: function(v) {
      var progs = map16(snd)(toUnfoldable5(v.envDefs));
  ...
  var varErr = function(loc) {
    return function(dictError) {
      ...
      return function($$var2) {
        return toError2(loc)("Variable " + (show28($$var2) + " not found in environment"));
      };
    };
  };
  var getVars = function(dictError) {
    return function(dictMonadError) {
      ...
      return function(dictMonadReader) {
        return bind30(asks(dictMonadReader.MonadAsk0())(function(v) {
          return v.envDefs;
        }))(function(defs) {
          var progs = map16(snd)(toUnfoldable5(defs));
          var vars = unions3(map16(getVarsProgram)(progs));
          return pure35(vars);
        });
      };
    };
  ...
  var lookupMVar = function(dictError) {
    ...
    return function(dictMonadError) {
      var map117 = map(dictMonadError.MonadThrow0().Monad0().Bind1().Apply0().Functor0());
      var getVars2 = getVars1(dictMonadError);
      return function(dictMonadReader) {
        var getVars3 = getVars2(dictMonadReader);
        return function(v) {
          return map117(lookup2(v))(getVars3);
        };
      };
    };
  };
  var getRecs = function(dictError) {
    return function(dictMonadError) {
      var Monad0 = dictMonadError.MonadThrow0().Monad0();
      var bind30 = bind(Monad0.Bind1());
      var pure35 = pure(Monad0.Applicative0());
      return function(dictMonadReader) {
        return bind30(asks(dictMonadReader.MonadAsk0())(function(v) {
          ...
          var progs = map16(snd)(toUnfoldable5(defs));
          var recs = unions3(map16(getRecsProgram)(progs));
          return pure35(recs);
        });
      };
    };
  };
  var lookupMRec = function(dictError) {
    var getRecs1 = getRecs(dictError);
    return function(dictMonadError) {
      var map117 = map(dictMonadError.MonadThrow0().Monad0().Bind1().Apply0().Functor0());
      var getRecs2 = getRecs1(dictMonadError);
      return function(dictMonadReader) {
        var getRecs3 = getRecs2(dictMonadReader);
        return function(v) {
          return map117(lookup2(v))(getRecs3);
        };
      };
    };
  };
  var lookupBody = function(dictError) {
    ...
    var lookupMRec1 = lookupMRec(dictError);
    return function(dictMonadError) {
      var MonadThrow0 = dictMonadError.MonadThrow0();
      var Monad0 = MonadThrow0.Monad0();
      var bind30 = bind(Monad0.Bind1());
      var lookupMVar22 = lookupMVar1(dictMonadError);
      var lookupMRec22 = lookupMRec1(dictMonadError);
      var throwError16 = throwError(MonadThrow0);
      var pure35 = pure(Monad0.Applicative0());
      return function(dictMonadReader) {
        var lookupMVar32 = lookupMVar22(dictMonadReader);
        var lookupMRec32 = lookupMRec22(dictMonadReader);
        return function(loc) {
          return function(v) {
            return bind30(lookupMVar32(v))(function(mvar) {
              return bind30(lookupMRec32(v))(function(mrec) {
                var v1 = new Tuple(mvar, mrec);
                ...
                if (v1.value0 instanceof Just) {
                  return pure35(v1.value0.value0.value0.varBody);
                }
                ;
                if (v1.value1 instanceof Just) {
                  return pure35(v1.value1.value0.value0.recBody);
                }
                ;
                throw new Error("Failed pattern match at Environment (line 130, column 3 - line 133, column 55): " + [v1.constructor.name]);
              });
            });
          };
        };
    ...
    return function(dictMonadError) {
      ...
      return function(dictMonadReader) {
        return bind30(asks(dictMonadReader.MonadAsk0())(function(v) {
          ...
          var progs = map16(snd)(toUnfoldable5(defs));
          var decls = unions1(map16(getDeclsProgram)(progs));
          return pure35(decls);
        });
      };
    };
  ...
  var getTypeNames = function(dictError) {
    ...
    return function(dictMonadError) {
      ...
      var pure35 = pure(Monad0.Applicative0());
      return function(dictMonadReader) {
        return bind30(getDecls2(dictMonadReader))(function(decls) {
          return pure35(map16(fst)(toUnfoldable5(decls)));
        });
      };
    };
  };
  var getXtorNames = function(dictError) {
    ...
    return function(dictMonadError) {
      ...
      return function(dictMonadReader) {
        return bind30(getDecls2(dictMonadReader))(function(decls) {
          var declList = map16(snd)(toUnfoldable5(decls));
          var xtors = concatMap(getXtors)(declList);
          return pure35(map16(getXtorname)(xtors));
        });
      };
    };
  };
  var lookupMDecl = function(dictError) {
    ...
    return function(dictMonadError) {
      ...
      return function(dictMonadReader) {
        ...
        return function(tyn) {
          return map117(lookup22(tyn))(getDecls3);
        };
      };
    };
  };
  var lookupMXtor = function(dictError) {
    ...
    return function(dictMonadError) {
      ...
      return function(dictMonadReader) {
        var getDecls3 = getDecls2(dictMonadReader);
        return function(xtn) {
          return bind30(getDecls3)(function(decls) {
            var declLs = map16(snd)(toUnfoldable5(decls));
            var xtors = concatMap(getXtors)(declLs);
            return pure35(find2(function(v) {
              return eq10(v.value0.sigName)(xtn);
            })(xtors));
          });
        };
      };
          ...
          return function(xtn) {
            return bind30(lookupMXtor32(xtn))(function(mxt) {
              ...
              if (mxt instanceof Just) {
                return pure35(mxt.value0);
              }
              ;
              throw new Error("Failed pattern match at Environment (line 147, column 3 - line 149, column 23): " + [mxt.constructor.name]);
            });
          };
        };
      };
  ...
  var lookupXtorMDecl = function(dictError) {
    ...
    return function(dictMonadError) {
      ...
      return function(dictMonadReader) {
        var getDecls3 = getDecls2(dictMonadReader);
        return function(xtn) {
          return map117(find1(function(x) {
            return elem3(xtn)(map16(getXtorname)(getXtors(x)));
          }))(getDecls3);
        };
      };
    };
          ...
          return function(xtn) {
            return bind30(lookupXtorMDecl3(xtn))(function(decl) {
              ...
              if (decl instanceof Just) {
                return pure35(decl.value0);
              }
              ;
              throw new Error("Failed pattern match at Environment (line 157, column 3 - line 159, column 29): " + [decl.constructor.name]);
            });
          };
        };
      };
          ...
          return function(tyn) {
            return bind30(lookupMDecl3(tyn))(function(mdecl) {
              ...
              if (mdecl instanceof Just) {
                return pure35(mdecl.value0);
              }
              ;
              throw new Error("Failed pattern match at Environment (line 115, column 3 - line 117, column 27): " + [mdecl.constructor.name]);
            });
          };
        };
      };
  ...
  var addVarEnv = function(nm) {
    return function($$var2) {
      return function(v) {
        var v1 = lookup1(nm)(v.envDefs);
        if (v1 instanceof Nothing) {
          var newProg = addVarProgram2($$var2)(emptyProg2(nm)(""));
          return {
            envDefs: insert5(nm)(newProg)(v.envDefs)
          };
        }
        ;
        if (v1 instanceof Just) {
          return {
            envDefs: insert5(nm)(addVarProgram2($$var2)(v1.value0))(v.envDefs)
          };
        }
        ;
        throw new Error("Failed pattern match at Environment (line 75, column 3 - line 77, column 93): " + [v1.constructor.name]);
      };
    };
  };
  var addRecEnv = function(nm) {
    return function(rec) {
      return function(v) {
        var v1 = lookup1(nm)(v.envDefs);
        if (v1 instanceof Nothing) {
          var newProg = addRecProgram2(rec)(emptyProg2(nm)(""));
          return {
            envDefs: insert5(nm)(newProg)(v.envDefs)
          };
        }
        ...
        if (v1 instanceof Just) {
          return {
            envDefs: insert5(nm)(addRecProgram2(rec)(v1.value0))(v.envDefs)
          };
        }
        ;
        throw new Error("Failed pattern match at Environment (line 81, column 3 - line 83, column 94): " + [v1.constructor.name]);
      };
    };
  };
  var addDeclEnv = function(nm) {
    return function(decl) {
      return function(v) {
        ...
        if (v1 instanceof Just) {
          return {
            envDefs: insert5(nm)(addDeclProgram2(decl)(v1.value0))(v.envDefs)
          };
        }
        ;
        throw new Error("Failed pattern match at Environment (line 69, column 3 - line 71, column 96): " + [v1.constructor.name]);
      };
    };
  };

  // output/Driver.Definition/index.js
  var show20 = /* @__PURE__ */ show(showEnvironment);
  var throwError2 = /* @__PURE__ */ throwError(/* @__PURE__ */ monadThrowStateT(/* @__PURE__ */ monadThrowExceptT(monadIdentity)));
  var monadExceptT2 = /* @__PURE__ */ monadExceptT(monadIdentity);
  var pure2 = /* @__PURE__ */ pure(/* @__PURE__ */ applicativeStateT(monadExceptT2));
  var bind3 = /* @__PURE__ */ bind(/* @__PURE__ */ bindStateT(monadExceptT2));
  var modify5 = /* @__PURE__ */ modify2(/* @__PURE__ */ monadStateStateT(monadExceptT2));
  ...
  var showDriverState = {
    show: function(v) {
      return "Current environment: " + show20(v.value0.drvEnv);
    }
  };
  var runDriverM = function(drvst) {
    return function(m) {
      return runExcept(runStateT(m)(drvst));
    };
  };
  var liftErr = function(dictError) {
    ...
    return function(v) {
      return function(v1) {
        if (v instanceof Left) {
          return throwError2(new ErrWithWhere(convertError2(v.value0), v1));
        }
        ;
        if (v instanceof Right) {
        ...
        ;
        throw new Error("Failed pattern match at Driver.Definition (line 55, column 1 - line 55, column 68): " + [v.constructor.name, v1.constructor.name]);
      };
    };
  };
  ...
  var debug = function(st) {
    return bind3(modify5(function(v) {
      return new MkDriverState({
        ...
        drvDebug: new Cons(st, v.value0.drvDebug)
      });
    }))(function() {
      return pure2(unit);
    });
  ...
  var addRecDecl = function(nm) {
    return function(rec) {
      return bind3(modify5(function(v) {
        return new MkDriverState({
          drvDebug: v.value0.drvDebug,
          drvEnv: addRecEnv(nm)(rec)(v.value0.drvEnv)
        });
      }))(function() {
        return pure2(unit);
      });
  ...
  var getEdgesEndingAt = function(dictEq) {
    var eq27 = eq(eqVertex(dictEq));
    return function(vert) {
      return function(v) {
        return filter(function(e) {
          return eq27(getEndingVert(e))(vert);
        })(v.value0.grEdges);
      };
    };
  };
  var getEdgesStartingAt = function(dictEq) {
    ...
    return function(vert) {
      return function(v) {
        return filter(function(e) {
          return eq27(getStartingVert(e))(vert);
        })(v.value0.grEdges);
      };
    };
  };
  ...
  var eqEdge = function(dictEq) {
    ...
    return {
      eq: function(x) {
        return function(y) {
          return eq27(x.value0)(y.value0) && eq27(x.value1)(y.value1);
        };
      }
    };
  };
    ...
    return function(dictOrd) {
      ...
      return function(v) {
        return function(v1) {
          ...
          ;
          throw new Error("Failed pattern match at Dependencies.Graph (line 37, column 3 - line 41, column 79): " + [v3.constructor.name]);
        };
      };
    };
  };
  var addEdge = function(dictEq) {
    var elem16 = elem4(eqEdge(dictEq));
    return function(v) {
      return function(v1) {
        var $114 = elem16(new MkEdge(v.value0, v.value1))(v1.value0.grEdges);
        if ($114) {
          return v1;
        }
        ;
  ...
  var bind4 = /* @__PURE__ */ bind(/* @__PURE__ */ bindReaderT(/* @__PURE__ */ bindStateT(monadExceptT3)));
  var monadStateReaderT2 = /* @__PURE__ */ monadStateReaderT(/* @__PURE__ */ monadStateStateT(monadExceptT3));
  var gets2 = /* @__PURE__ */ gets(monadStateReaderT2);
  var modify6 = /* @__PURE__ */ modify2(monadStateReaderT2);
  var applicativeReaderT2 = /* @__PURE__ */ applicativeReaderT(/* @__PURE__ */ applicativeStateT(monadExceptT3));
  ...
  var runDepM = function(env) {
    return function(m) {
      ...
      ;
      throw new Error("Failed pattern match at Dependencies.Definition (line 35, column 17 - line 37, column 31): " + [v.constructor.name]);
    };
  };
  var removeSelfLoops = function(dictShow) {
    return function(dictEq) {
      var notEq3 = notEq(eqVertex(dictEq));
      return bind4(gets2(function(v) {
        return v.value0;
      }))(function(gr) {
        var newEdgs = filter(function(v) {
          return notEq3(v.value0)(v.value1);
        })(gr.grEdges);
    ...
    return function(lb) {
      return function(err) {
        return bind4(gets2(function(v) {
          ...
          ;
          throw new Error("Failed pattern match at Dependencies.Definition (line 50, column 3 - line 52, column 27): " + [mvert.constructor.name]);
        });
      };
    };
  };
  var ensureAcyclic = function(dictShow) {
    return function(dictEq) {
      ...
      var elem16 = elem5(eqVertex(dictEq));
      return function(dictShow1) {
        return function(err) {
              ...
              return function(gr) {
                return function(startV) {
                  return function(seenV) {
                    ...
                    var outg = map17(getEndingVert)(getEdgesStartingAt3(startV)(gr));
                    var elems = map17(function(x) {
                      return elem16(x)(outg);
                    })(newSeenV);
                    return bind4(when2($$null(filter(identity11)(elems)))(throwError3(err)))(function() {
          ...
          return bind4(gets2(function(v) {
            ...
            var verts = toUnfoldable6(gr.grVerts);
  ...
  var show111 = /* @__PURE__ */ show(showVariable);
    ...
    return {
      getMessage: function(v) {
        ...
        if (v instanceof ErrUndefinedVar) {
          return "Variable " + (show111(v.value1) + " was not defined");
        }
        ;
  ...
  var bindReaderT2 = /* @__PURE__ */ bindReaderT(/* @__PURE__ */ bindStateT(monadExceptT4));
  var bind5 = /* @__PURE__ */ bind(bindReaderT2);
  var get2 = /* @__PURE__ */ get(/* @__PURE__ */ monadStateReaderT(/* @__PURE__ */ monadStateStateT(monadExceptT4)));
  ...
  var applicativeReaderT3 = /* @__PURE__ */ applicativeReaderT(/* @__PURE__ */ applicativeStateT(monadExceptT4));
  var pure4 = /* @__PURE__ */ pure(applicativeReaderT3);
  var map1 = /* @__PURE__ */ map(/* @__PURE__ */ functorReaderT(/* @__PURE__ */ functorStateT(/* @__PURE__ */ functorExceptT(functorIdentity))));
  var $$for3 = /* @__PURE__ */ $$for(applicativeReaderT3)(traversableList);
  var discard2 = /* @__PURE__ */ discard(discardUnit)(bindReaderT2);
  var when3 = /* @__PURE__ */ when(applicativeReaderT3);
  var elem6 = /* @__PURE__ */ elem(foldableList)(eqModulename);
  ...
  var getImportOrder = function(mn) {
    return bind5(get2)(function(gr) {
      return bind5(getVertexError2(mn)(new ErrUndefinedModule(mn)))(function(vert) {
        ...
        ;
        return bind5(map1(concat2)($$for3(deps)(getImportOrder)))(function(orders) {
          return discard2(when3(elem6(mn)(orders))(throwError4(new ErrDuplModule(mn))))(function() {
  ...
  var show29 = /* @__PURE__ */ show(showTypevar);
  ...
  var showTy4 = {
    show: function(v) {
      if (v instanceof TyVar4) {
        return show29(v.value0);
      }
      ;
      if (v instanceof TyDecl4 && $$null(v.value1)) {
        return show113(v.value0);
      }
      ;
      if (v instanceof TyDecl4) {
        return show113(v.value0) + ("(" + (intercalate11(", ")(map19(show(showTy4))(v.value1)) + ")"));
      }
      ;
      ...
      if (v instanceof TyForall4) {
        return "forall " + (intercalate11(", ")(map19(show29)(v.value0)) + (". " + show(showTy4)(v.value1)));
      }
      ;
  ...
  var showTerm4 = {
    show: function(v) {
      if (v instanceof Var4) {
        return show30(v.value1);
      }
      ;
      if (v instanceof Mu4) {
        return "mu " + (show30(v.value1) + (". " + show(showCommand4)(v.value2)));
      }
      ;
      if (v instanceof Xtor4 && $$null(v.value2)) {
        return show114(v.value1);
      }
      ;
      if (v instanceof Xtor4) {
        return show114(v.value1) + ("(" + (intercalate12(", ")(map20(show(showTerm4))(v.value2)) + ")"));
      }
      ;
      if (v instanceof XCase4) {
        return "case {" + (intercalate12(", ")(map20(show(showPattern4))(v.value1)) + "}");
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Syntax.Parsed.Terms (line 61, column 1 - line 68, column 49): " + [v.constructor.name]);
    }
  };
  var showPattern4 = {
    show: function(v) {
      if ($$null(v.value0.ptv)) {
        return show114(v.value0.ptxt) + (" => " + show(showCommand4)(v.value0.ptcmd));
      }
      ;
      return show114(v.value0.ptxt) + ("(" + (intercalate12(", ")(map20(show30)(v.value0.ptv)) + (") => " + show(showCommand4)(v.value0.ptcmd))));
    }
  };
  var showCommand4 = {
    show: function(v) {
      if (v instanceof Cut4) {
        return "\u3008" + (show(showTerm4)(v.value1) + (" | " + (show210(v.value2) + (" | " + (show(showTerm4)(v.value3) + "\u3009")))));
      }
      ;
      if (v instanceof CutAnnot2) {
        return "\u3008" + (show(showTerm4)(v.value1) + (" | " + (show37(v.value2) + (" | " + (show210(v.value3) + (" | " + (show(showTerm4)(v.value4) + "\u3009")))))));
      }
      ;
  ...
  var bind6 = /* @__PURE__ */ bind(/* @__PURE__ */ bindReaderT(/* @__PURE__ */ bindStateT(monadExceptT5)));
  var get3 = /* @__PURE__ */ get(/* @__PURE__ */ monadStateReaderT(/* @__PURE__ */ monadStateStateT(monadExceptT5)));
  var map21 = /* @__PURE__ */ map(functorList);
  var getEdgesEndingAt2 = /* @__PURE__ */ getEdgesEndingAt(eqVariable);
  var applicativeReaderT4 = /* @__PURE__ */ applicativeReaderT(/* @__PURE__ */ applicativeStateT(monadExceptT5));
  var pure5 = /* @__PURE__ */ pure(applicativeReaderT4);
  var $$for4 = /* @__PURE__ */ $$for(applicativeReaderT4)(traversableList);
  var monadStateT2 = /* @__PURE__ */ monadStateT(monadExceptT5);
  var foldM2 = /* @__PURE__ */ foldM(foldableSet)(/* @__PURE__ */ monadReaderT(monadStateT2));
  var elem7 = /* @__PURE__ */ elem(foldableList);
  var elem1 = /* @__PURE__ */ elem7(/* @__PURE__ */ eqVertex(eqVariable));
  ...
  var monadReaderReaderT2 = /* @__PURE__ */ monadReaderReaderT(monadStateT2);
  ...
  var elem22 = /* @__PURE__ */ elem7(eqVariable);
  ...
  var getVarOrderFrom = function(vert) {
    return bind6(get3)(function(gr) {
      var preds = map21(getStartingVert)(getEdgesEndingAt2(vert)(gr));
      if (preds instanceof Nil) {
        return pure5(new Cons(vert, Nil.value));
      }
      ;
      return bind6($$for4(preds)(getVarOrderFrom))(function(predOrders) {
        return pure5(new Cons(vert, concat2(predOrders)));
      });
    });
  };
  ...
  var addRec = function(v) {
    return bind6(addVertexM3(v.value0.recName))(function(vert) {
      return pure5(new Tuple(vert, v.value0.recBody));
    });
  };
  var addEdgesVariableT = function(v) {
    return function(v1) {
      return function(v2) {
        ...
        ;
        if (v2 instanceof XCase4) {
          return bind6($$for4(v2.value1)(addEdgesVariablePt(v)(v1)))(function() {
            return pure5(unit);
          });
        }
        ;
        if (v2 instanceof ShiftCBV4) {
          return addEdgesVariableT(v)(v1)(v2.value1);
        }
        ;
        if (v2 instanceof ShiftCBN4) {
          return addEdgesVariableT(v)(v1)(v2.value1);
        }
        ;
        throw new Error("Failed pattern match at Dependencies.VariablesGraph (line 54, column 1 - line 54, column 77): " + [v.constructor.name, v1.constructor.name, v2.constructor.name]);
      };
    };
  };
  ...
  var addEdgesVariableC = function(v) {
    return function(v1) {
      return function(v2) {
        ...
        ;
        if (v2 instanceof Done5) {
          return pure5(unit);
        }
        ;
        if (v2 instanceof Err4) {
          return pure5(unit);
        }
        ;
        if (v2 instanceof Print4) {
          return addEdgesVariableT(v)(v1)(v2.value1);
        }
        ;
        if (v2 instanceof PrintAnnot2) {
          return addEdgesVariableT(v)(v1)(v2.value1);
        }
        ;
        throw new Error("Failed pattern match at Dependencies.VariablesGraph (line 77, column 1 - line 77, column 80): " + [v.constructor.name, v1.constructor.name, v2.constructor.name]);
      };
    };
  };
  var depOrderProgram = function(v) {
    var vars = map21(snd)(toUnfoldable7(v.value0.progVars));
    var recs = map21(snd)(toUnfoldable7(v.value0.progRecs));
    var decls = map21(snd)(toUnfoldable7(v.value0.progDecls));
    return bind6($$for4(vars)(addVariable))(function(vertsTerms) {
      return bind6($$for4(recs)(addRec))(function(recsTerms) {
        ...
        return bind6($$for4(append3(vertsTerms)(recsTerms))(function(v1) {
          ...
          return bind6(removeSelfLoops2)(function() {
            return bind6(ensureAcyclic3(new ErrMutualRec(v.value0.progName)))(function() {
              return bind6(getVarOrder)(function(order) {
                return pure5(map21(getVertexLabel)(order));
              });
            });
          });
        });
  ...
  var show31 = /* @__PURE__ */ show(showVariable);
  var show115 = /* @__PURE__ */ show(showTypename);
  var show211 = /* @__PURE__ */ show(showTy);
  var show38 = /* @__PURE__ */ show(showXtorname);
    ...
    return {
      getMessage: function(v) {
        if (v instanceof ErrVariable) {
          return "Definition for variable " + (show31(v.value1) + "could not be found");
        }
        ;
        if (v instanceof ErrMultipleNames) {
          return show115(v.value1) + " was defined multiple times";
        }
        ;
        if (v instanceof ErrMultipleAnnot) {
          return "Multiple incompatible annotations for variable" + (show31(v.value1) + (": " + (show211(v.value2) + (" and " + show211(v.value3)))));
        }
        ;
        if (v instanceof ErrMultipleXtor) {
          return show38(v.value1) + " was defined multiple times ";
        }
        ;
        ...
        ;
        throw new Error("Failed pattern match at Desugar.Errors (line 17, column 1 - line 30, column 21): " + [v.constructor.name]);
      },
      getLocation: function(v) {
        if (v instanceof ErrVariable) {
          return v.value0;
  ...
  var bind7 = /* @__PURE__ */ bind(/* @__PURE__ */ bindReaderT(/* @__PURE__ */ bindStateT(monadExceptT6)));
  var monadStateReaderT3 = /* @__PURE__ */ monadStateReaderT(/* @__PURE__ */ monadStateStateT(monadExceptT6));
  var modify7 = /* @__PURE__ */ modify2(monadStateReaderT3);
  var pure6 = /* @__PURE__ */ pure(/* @__PURE__ */ applicativeReaderT(/* @__PURE__ */ applicativeStateT(monadExceptT6)));
  var lookupMXtor3 = /* @__PURE__ */ lookupMXtor(errorDesugarError)(/* @__PURE__ */ monadErrorReaderT(/* @__PURE__ */ monadErrorStateT(/* @__PURE__ */ monadErrorExceptT(monadIdentity))))(/* @__PURE__ */ monadReaderReaderT(/* @__PURE__ */ monadStateT(monadExceptT6)));
  var gets3 = /* @__PURE__ */ gets(monadStateReaderT3);
  ...
  var lookup3 = /* @__PURE__ */ lookup(ordVariable);
  ...
  var runDesugarM = function(env) {
    return function(nm) {
      return function(m) {
        ...
        ;
        throw new Error("Failed pattern match at Desugar.Definition (line 48, column 24 - line 50, column 32): " + [v.constructor.name]);
      };
    };
  };
  var getDesMXtor = function(xtn) {
    return bind7(lookupMXtor3(xtn))(function(msig) {
      return bind7(gets3(function(v) {
        return v.value0.desDone;
      }))(function(doneProg) {
        var doneDecls = function(v2) {
          return map22(snd)(toUnfoldable8(v2.value0.progDecls));
        }(doneProg);
        ...
        ;
        throw new Error("Failed pattern match at Desugar.Definition (line 82, column 3 - line 85, column 44): " + [v.constructor.name]);
      });
    });
  };
  var getDesDoneVar = function(loc) {
    return function(v) {
      return bind7(gets3(function(v1) {
        return v1.value0.desDone;
      }))(function(doneProg) {
        var doneVars = function(v12) {
          return v12.value0.progVars;
        }(doneProg);
        var doneRecs = function(v12) {
          return v12.value0.progRecs;
        }(doneProg);
        var v1 = new Tuple(lookup3(v)(doneVars), lookup3(v)(doneRecs));
        if (v1.value0 instanceof Nothing && v1.value1 instanceof Nothing) {
          return throwError5(new ErrVariable(loc, v));
        }
        ;
        if (v1.value0 instanceof Just) {
          return pure6(new Left(v1.value0.value0));
        }
        ;
        if (v1.value1 instanceof Just) {
          return pure6(new Right(v1.value1.value0));
        }
        ;
        throw new Error("Failed pattern match at Desugar.Definition (line 92, column 3 - line 95, column 49): " + [v1.constructor.name]);
      });
    };
  };
  var getDesDoneProg = /* @__PURE__ */ gets3(function(v) {
    return v.value0.desDone;
  });
  var getDesDefNames = /* @__PURE__ */ bind7(getDesDoneProg)(function(doneProg) {
    var doneNames = function(v) {
      return map22(fst)(toUnfoldable8(v.value0.progDecls));
    }(doneProg);
    return bind7(gets3(function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Desugar.Definition (line 66, column 3 - line 68, column 66): " + [curr.constructor.name]);
    });
  });
  ...
  var addDesRec = function(rec) {
    return bind7(modify7(function(v) {
      return new MkDesugarState({
        desCurrDecl: v.value0.desCurrDecl,
        desDone: addRecProgram(rec)(v.value0.desDone)
      });
    }))(function() {
      return pure6(unit);
    });
  ...
  var bind8 = /* @__PURE__ */ bind(/* @__PURE__ */ bindReaderT(/* @__PURE__ */ bindStateT(monadExceptT7)));
  var getTypeNames2 = /* @__PURE__ */ getTypeNames(errorDesugarError)(/* @__PURE__ */ monadErrorReaderT(/* @__PURE__ */ monadErrorStateT(/* @__PURE__ */ monadErrorExceptT(monadIdentity))))(/* @__PURE__ */ monadReaderReaderT(/* @__PURE__ */ monadStateT(monadExceptT7)));
  var elem8 = /* @__PURE__ */ elem(foldableList)(eqTypename);
  var append4 = /* @__PURE__ */ append(semigroupList);
  var applicativeReaderT5 = /* @__PURE__ */ applicativeReaderT(/* @__PURE__ */ applicativeStateT(monadExceptT7));
  ...
  var bind9 = /* @__PURE__ */ bind(/* @__PURE__ */ bindReaderT(/* @__PURE__ */ bindStateT(monadExceptT8)));
  var applicativeReaderT6 = /* @__PURE__ */ applicativeReaderT(/* @__PURE__ */ applicativeStateT(monadExceptT8));
  ...
  var desugarTerm = function(v) {
    if (v instanceof Var4) {
      ...
      return bind9(getDesMXtor(vxt))(function(mxt) {
        ...
        ;
        throw new Error("Failed pattern match at Desugar.Terms (line 20, column 3 - line 22, column 40): " + [mxt.constructor.name]);
      });
    }
    ;
    if (v instanceof Mu4) {
    ...
    ;
    throw new Error("Failed pattern match at Desugar.Terms (line 16, column 1 - line 16, column 41): " + [v.constructor.name]);
  };
  ...
  var desugarCommand = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Desugar.Terms (line 44, column 1 - line 44, column 50): " + [v.constructor.name]);
  };

  // output/Desugar.Program/index.js
  var monadExceptT9 = /* @__PURE__ */ monadExceptT(monadIdentity);
  var bind10 = /* @__PURE__ */ bind(/* @__PURE__ */ bindReaderT(/* @__PURE__ */ bindStateT(monadExceptT9)));
  var applicativeReaderT7 = /* @__PURE__ */ applicativeReaderT(/* @__PURE__ */ applicativeStateT(monadExceptT9));
  var $$for7 = /* @__PURE__ */ $$for(applicativeReaderT7);
  var for1 = /* @__PURE__ */ $$for7(traversableList);
  var pure9 = /* @__PURE__ */ pure(applicativeReaderT7);
  var eq18 = /* @__PURE__ */ eq(eqTy);
  ...
  var monadReaderReaderT3 = /* @__PURE__ */ monadReaderReaderT(/* @__PURE__ */ monadStateT(monadExceptT9));
  ...
  var for2 = /* @__PURE__ */ $$for7(traversableMap);
  var desugarXtorSig = function(v) {
    return bind10(for1(v.value0.sigArgs)(desugarTy))(function(args$prime) {
  ...
  var desugarVar = function(v) {
    return bind10(desugarTerm(v.value0.varBody))(function(t$prime) {
      var newV = new VarDecl({
        varPos: v.value0.varPos,
        varName: v.value0.varName,
        varTy: Nothing.value,
        varBody: t$prime
      });
      return addDesVar(newV);
    });
  };
  var desugarRec = function(v) {
    return bind10(desugarTerm(v.value0.recBody))(function(t$prime) {
      var newR = new RecDecl({
        recPos: v.value0.recPos,
        recName: v.value0.recName,
        recTy: Nothing.value,
        recBody: t$prime
      });
      return addDesRec(newR);
    });
  };
  var desugarMain = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Desugar.Program (line 89, column 1 - line 89, column 49): " + [v.constructor.name]);
  };
  var desugarDecl = function(v) {
    return bind10(setDesCurrDecl(v))(function() {
      return bind10(for1(v.value0.declXtors)(desugarXtorSig))(function(sigs$prime) {
  ...
  var desugarAnnot = function(v) {
    return bind10(getDesDoneVar(v.value0.annotPos)(v.value0.annotName))(function(decl) {
      return bind10(desugarTy(v.value0.annotType))(function(ty$prime) {
        if (decl instanceof Left && decl.value0.value0.varTy instanceof Nothing) {
          return addDesVar(new VarDecl({
            varPos: decl.value0.value0.varPos,
            varName: decl.value0.value0.varName,
            varTy: new Just(ty$prime),
            varBody: decl.value0.value0.varBody
          }));
        }
        ;
        if (decl instanceof Left && decl.value0.value0.varTy instanceof Just) {
          var $64 = eq18(ty$prime)(decl.value0.value0.varTy.value0);
          if ($64) {
            return pure9(unit);
          }
          ;
          return throwError6(new ErrMultipleAnnot(v.value0.annotPos, decl.value0.value0.varName, ty$prime, decl.value0.value0.varTy.value0));
        }
        ;
        if (decl instanceof Right && decl.value0.value0.recTy instanceof Nothing) {
          return addDesRec(new RecDecl({
            recPos: decl.value0.value0.recPos,
            recName: decl.value0.value0.recName,
            recTy: new Just(ty$prime),
            recBody: decl.value0.value0.recBody
          }));
        }
        ;
        if (decl instanceof Right && decl.value0.value0.recTy instanceof Just) {
          var $78 = eq18(ty$prime)(decl.value0.value0.recTy.value0);
          if ($78) {
            return pure9(unit);
          }
          ;
          return throwError6(new ErrMultipleAnnot(v.value0.annotPos, v.value0.annotName, ty$prime, decl.value0.value0.recTy.value0));
        }
        ;
        throw new Error("Failed pattern match at Desugar.Program (line 74, column 3 - line 82, column 111): " + [decl.constructor.name]);
      });
    });
  };
  var checkXtorNames = function($copy_v) {
    return function($copy_v1) {
      ...
      function $tco_loop(v, v1) {
        ...
        ;
        if (v1 instanceof Cons) {
          var $91 = elem12(v1.value0.value0.sigName)(map25(function(v2) {
        ...
        ;
        throw new Error("Failed pattern match at Desugar.Program (line 31, column 1 - line 31, column 67): " + [v.constructor.name, v1.constructor.name]);
      }
      ;
      while (!$tco_done) {
        $tco_result = $tco_loop($tco_var_v, $copy_v1);
  ...
  var checkTypeNames = function($copy_v) {
    return function($copy_v1) {
      ...
      function $tco_loop(v, v1) {
        ...
        ;
        if (v1 instanceof Cons) {
          var $99 = elem23(v1.value0.value0.declName)(map25(function(v2) {
        ...
        ;
        throw new Error("Failed pattern match at Desugar.Program (line 25, column 1 - line 25, column 68): " + [v.constructor.name, v1.constructor.name]);
      }
      ;
      while (!$tco_done) {
        $tco_result = $tco_loop($tco_var_v, $copy_v1);
  ...
  var desugarProgram = function(v) {
    return bind10(getTypeNames3)(function(envTyNames) {
      return bind10(checkTypeNames(envTyNames)(map25(snd)(toUnfoldable9(v.value0.progDecls))))(function() {
        return bind10(getXtorNames2)(function(envXtns) {
          return bind10(checkXtorNames(envXtns)(concatMap(function(v1) {
            return v1.value0.declXtors;
          })(map25(snd)(toUnfoldable9(v.value0.progDecls)))))(function() {
            return bind10(for2(v.value0.progDecls)(desugarDecl))(function() {
              return bind10(for2(v.value0.progVars)(desugarVar))(function() {
                return bind10(for2(v.value0.progRecs)(desugarRec))(function() {
                  return bind10(for2(v.value0.progAnnots)(desugarAnnot))(function() {
  ...
  var eq19 = /* @__PURE__ */ eq(eqCommand);
  var elem10 = /* @__PURE__ */ elem(foldableList)(eqCommand);
  ...
  var ErrXtorArity = /* @__PURE__ */ function() {
    function ErrXtorArity3(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    ErrXtorArity3.create = function(value0) {
      return function(value1) {
        return new ErrXtorArity3(value0, value1);
      };
    };
    return ErrXtorArity3;
  }();
    ...
    return {
      getMessage: function(v) {
        ...
        if (v instanceof ErrLoop) {
          return "Cannot evaluate " + (show39(v.value1) + ", evaluation results in loop");
        }
        ;
        ...
        ;
        throw new Error("Failed pattern match at Eval.Definition (line 30, column 1 - line 41, column 21): " + [v.constructor.name]);
      },
      getLocation: function(v) {
        if (v instanceof ErrXtorArity) {
          return v.value0;
  ...
  var inTrace = function(v) {
    return function(c$prime) {
      return eq19(v.value0)(c$prime) || elem10(v.value0)(v.value1);
    };
  };
  ...
  var freeVariablesList = function(dictFreeVariables) {
    ...
    return {
      freeVars: function(ls) {
        return unions4(map26(freeVars1)(ls));
      }
    };
  };
  var freeVariablesTerm = {
    freeVars: function(v) {
      if (v instanceof Var) {
        return singleton6(v.value1);
      }
      ;
      if (v instanceof Mu) {
        return $$delete3(v.value1)(freeVars(freeVariablesCommand)(v.value2));
      }
      ;
      if (v instanceof Xtor) {
        return unions4(map26(freeVars(freeVariablesTerm))(v.value2));
      }
      ;
      if (v instanceof XCase) {
        return unions4(map26(freeVars(freeVariablesPattern))(v.value1));
      }
      ;
      if (v instanceof ShiftCBV) {
      ...
      ;
      throw new Error("Failed pattern match at FreeVars.FreeVariables (line 23, column 1 - line 29, column 45): " + [v.constructor.name]);
    }
  };
  var freeVariablesPattern = {
    freeVars: function(v) {
      return foldr4($$delete3)(freeVars(freeVariablesCommand)(v.value0.ptcmd))(v.value0.ptv);
    }
  };
  var freeVariablesCommand = {
    freeVars: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at FreeVars.FreeVariables (line 34, column 1 - line 38, column 36): " + [v.constructor.name]);
    }
  };

  // output/Eval.Focusing/index.js
  var map27 = /* @__PURE__ */ map(functorList);
  var freshVar2 = /* @__PURE__ */ freshVar(freeVariablesTerm);
  var getLoc2 = /* @__PURE__ */ getLoc(hasLocTerm);
  var freshVar1 = /* @__PURE__ */ freshVar(/* @__PURE__ */ freeVariablesList(freeVariablesTerm));
  var append5 = /* @__PURE__ */ append(semigroupList);
  var splitArgs = function(v) {
    return function(v1) {
      if (v1 instanceof Nil) {
        return new Tuple(Nil.value, new Tuple(Nothing.value, Nil.value));
      }
      ;
      if (v1 instanceof Cons) {
        var getNonVals = function(v22) {
          return function(v3) {
            ...
            if (v22 instanceof Just) {
              return new Cons(v22.value0, v3);
            }
            ;
            throw new Error("Failed pattern match at Eval.Focusing (line 51, column 5 - line 51, column 55): " + [v22.constructor.name, v3.constructor.name]);
          };
        };
        var v2 = splitArgs(v)(v1.value1);
        var nonVals$prime = getNonVals(v2.value1.value0)(v2.value1.value1);
        var $23 = isValue(v)(v1.value0);
        if ($23) {
          return new Tuple(new Cons(v1.value0, v2.value0), new Tuple(v2.value1.value0, v2.value1.value1));
        }
        ;
        return new Tuple(v2.value0, new Tuple(new Just(v1.value0), nonVals$prime));
      }
      ;
      throw new Error("Failed pattern match at Eval.Focusing (line 44, column 1 - line 44, column 96): " + [v.constructor.name, v1.constructor.name]);
    };
  };
  var focusTerm = function(v) {
    return function(v1) {
      if (v1 instanceof Var) {
        return new Var(v1.value0, v1.value1, v1.value2);
      }
      ;
      if (v1 instanceof Mu) {
        return new Mu(v1.value0, v1.value1, focus(v1.value2), v1.value3);
      }
      ;
      if (v1 instanceof Xtor) {
        var v2 = splitArgs(v)(v1.value2);
        if (v2.value1.value0 instanceof Nothing) {
          return new Xtor(v1.value0, v1.value1, map27(focusTerm(v))(v1.value2), v1.value3);
        }
        ;
        if (v2.value1.value0 instanceof Just) {
          var newV = freshVar2(v1);
          var newVT = new Var(getLoc2(v2.value1.value0.value0), newV, getType(v2.value1.value0.value0));
          var newV2 = freshVar1(new Cons(v1, new Cons(newVT, Nil.value)));
          var tof$prime = focusTerm(v)(v2.value1.value0.value0);
          var newXtor = focusTerm(v)(new Xtor(v1.value0, v1.value1, append5(v2.value0)(append5(new Cons(newVT, Nil.value))(v2.value1.value1)), v1.value3));
          var inner = new Cut(v1.value0, newXtor, CBV.value, new Var(v1.value0, newV2, getType(v2.value1.value0.value0)));
          var outer = new Cut(v1.value0, tof$prime, CBV.value, new Mu(v1.value0, newV, inner, v1.value3));
          return new Mu(v1.value0, newV2, outer, v1.value3);
        }
        ;
        throw new Error("Failed pattern match at Eval.Focusing (line 26, column 3 - line 36, column 28): " + [v2.value1.value0.constructor.name]);
      }
      ;
      if (v1 instanceof XCase) {
        return new XCase(v1.value0, map27(focusPattern)(v1.value1), v1.value2);
      }
      ;
      if (v1 instanceof ShiftCBV) {
        return new ShiftCBV(v1.value0, focusTerm(v)(v1.value1), v1.value2);
      }
      ;
      if (v1 instanceof ShiftCBN) {
        return new ShiftCBN(v1.value0, focusTerm(v)(v1.value1), v1.value2);
      }
      ;
      throw new Error("Failed pattern match at Eval.Focusing (line 21, column 1 - line 21, column 45): " + [v.constructor.name, v1.constructor.name]);
    };
  };
  var focusPattern = function(v) {
    return new Pattern({
      ptxt: v.value0.ptxt,
      ptv: v.value0.ptv,
      ptcmd: focus(v.value0.ptcmd)
    });
  };
  var focus = function(v) {
    if (v instanceof Done2) {
      return new Done2(v.value0);
    }
    ;
    if (v instanceof Err) {
      return new Err(v.value0, v.value1);
    }
    ;
    if (v instanceof Cut) {
      return new Cut(v.value0, focusTerm(v.value2)(v.value1), v.value2, focusTerm(v.value2)(v.value3));
    }
    ;
    if (v instanceof Print) {
      return new Print(v.value0, v.value1);
    }
    ;
    throw new Error("Failed pattern match at Eval.Focusing (line 15, column 1 - line 15, column 28): " + [v.constructor.name]);
  };
  ...
  var substituteVariablesTerm = {
    substVars: function(v) {
      return function(v1) {
        if (v1 instanceof Var) {
          return fromMaybe(v1)(lookup12(v1.value1)(v));
        }
        ;
        if (v1 instanceof Mu) {
          return new Mu(v1.value0, v1.value1, substVars(substituteVariablesComman)($$delete4(v1.value1)(v))(v1.value2), v1.value3);
        }
        ;
        if (v1 instanceof Xtor) {
        ...
        ;
        if (v1 instanceof ShiftCBV) {
          return new ShiftCBV(v1.value0, substVars(substituteVariablesTerm)(v)(v1.value1), v1.value2);
        }
        ;
        if (v1 instanceof ShiftCBN) {
          return new ShiftCBN(v1.value0, substVars(substituteVariablesTerm)(v)(v1.value1), v1.value2);
        }
        ;
        throw new Error("Failed pattern match at Syntax.Kinded.Substitution (line 60, column 1 - line 66, column 78): " + [v.constructor.name, v1.constructor.name]);
      };
    }
  };
  var substituteVariablesPatter = {
    substVars: function(varmap) {
      return function(v) {
        var newMap = foldr5($$delete4)(varmap)(v.value0.ptv);
        return new Pattern({
          ptxt: v.value0.ptxt,
          ptv: v.value0.ptv,
  ...
  var substituteVariablesComman = {
    substVars: function(v) {
      return function(v1) {
        ...
        ;
        throw new Error("Failed pattern match at Syntax.Kinded.Substitution (line 71, column 1 - line 75, column 66): " + [v.constructor.name, v1.constructor.name]);
      };
    }
  };

  // output/Eval.Eval/index.js
  var pure10 = /* @__PURE__ */ pure(/* @__PURE__ */ applicativeReaderT(/* @__PURE__ */ applicativeExceptT(monadIdentity)));
  ...
  var eq20 = /* @__PURE__ */ eq(eqXtorname);
  ...
  var lookupBody2 = /* @__PURE__ */ lookupBody(errorEvalError)(/* @__PURE__ */ monadErrorReaderT(/* @__PURE__ */ monadErrorExceptT(monadIdentity)))(/* @__PURE__ */ monadReaderReaderT(/* @__PURE__ */ monadExceptT(monadIdentity)));
  var setLoc2 = /* @__PURE__ */ setLoc(hasLocTerm);
  var identity12 = /* @__PURE__ */ identity(categoryFn);
  var map29 = /* @__PURE__ */ map(functorList);
  var elem11 = /* @__PURE__ */ elem(foldableList)(eqCommand);
  var getLoc3 = /* @__PURE__ */ getLoc(hasLocCommand);
  var substCase = function($copy_v) {
    return function($copy_v1) {
      return function($copy_v2) {
        var $tco_var_v = $copy_v;
        var $tco_var_v1 = $copy_v1;
        ...
        var $tco_result;
        function $tco_loop(v, v1, v2) {
          if (v1.value0.ptv instanceof Nil && v2 instanceof Nil) {
            $tco_done = true;
            return pure10(v1.value0.ptcmd);
          }
          ;
          if (v1.value0.ptv instanceof Cons && v2 instanceof Cons) {
            var newcmd = substituteVariable2(v1.value0.ptv.value0)(v2.value0)(v1.value0.ptcmd);
            $tco_var_v = v;
            $tco_var_v1 = new Pattern({
              ptxt: v1.value0.ptxt,
              ptv: v1.value0.ptv.value1,
              ptcmd: newcmd
            });
            $copy_v2 = v2.value1;
            return;
          ...
          ;
          if (v1.value0.ptv instanceof Nil && v2 instanceof Cons) {
            $tco_done = true;
            return throwError7(new ErrXtorArity(v, v1.value0.ptxt));
          }
          ;
          if (v1.value0.ptv instanceof Cons && v2 instanceof Nil) {
            $tco_done = true;
            return throwError7(new ErrXtorArity(v, v1.value0.ptxt));
          }
          ;
          throw new Error("Failed pattern match at Eval.Eval (line 64, column 1 - line 64, column 58): " + [v.constructor.name, v1.constructor.name, v2.constructor.name]);
        }
        ;
        while (!$tco_done) {
          $tco_result = $tco_loop($tco_var_v, $tco_var_v1, $copy_v2);
      ...
      return function($copy_v2) {
        ...
        function $tco_loop(v, v1, v2) {
          if (v2 instanceof Nil) {
            $tco_done = true;
            return throwError7(new ErrMissingPt(v, v1));
          }
          ;
          if (v2 instanceof Cons) {
            var $66 = eq20(v2.value0.value0.ptxt)(v1);
            if ($66) {
              $tco_done = true;
              return pure10(new Pattern(v2.value0.value0));
            }
            ;
            $tco_var_v = v;
            $tco_var_v1 = v1;
          ...
          ;
          throw new Error("Failed pattern match at Eval.Eval (line 72, column 1 - line 72, column 61): " + [v.constructor.name, v1.constructor.name, v2.constructor.name]);
        }
        ;
        while (!$tco_done) {
          $tco_result = $tco_loop($tco_var_v, $tco_var_v1, $copy_v2);
  ...
  var coTrans = function(v) {
    if (v instanceof Cut) {
      return new Cut(v.value0, v.value3, shiftEvalOrder3(v.value2), v.value1);
    }
    ;
    if (v instanceof Done2) {
      return new Done2(v.value0);
    ...
    ;
    throw new Error("Failed pattern match at Eval.Eval (line 19, column 1 - line 19, column 30): " + [v.constructor.name]);
  };
  var evalOnce = function(v) {
    ...
    ;
    if (v instanceof Cut && (v.value3 instanceof Mu && isValue(v.value2)(v.value1))) {
      return pure10(substituteVariable2(v.value3.value1)(v.value1)(v.value3.value2));
    }
    ;
    if (v instanceof Cut && v.value1 instanceof ShiftCBV) {
      return pure10(new Cut(v.value0, v.value1.value1, v.value2, v.value3));
    }
    ;
    ...
    ;
    if (v instanceof Cut && (v.value1 instanceof Xtor && (v.value3 instanceof XCase && $$null(filter(identity12)(map29(isValue(v.value2))(v.value1.value2)))))) {
      return bind11(findXtor(v.value0)(v.value1.value1)(v.value3.value1))(function(pt) {
        return substCase(v.value0)(pt)(v.value1.value2);
      });
    }
    ;
    return pure10(coTrans(v));
  };
  var evalFocusedWithTrace = function(v) {
    return function(v1) {
      if (elem11(v)(v1.value1)) {
        return throwError7(new ErrLoop(getLoc3(v), v));
      }
      ;
      return bind11(evalOnce(v))(function(c$prime) {
        var newTr = appendTrace(v1)(c$prime);
        ...
        ;
        if (c$prime instanceof Cut && inTrace(v1)(c$prime)) {
          return throwError7(new ErrLoop(getLoc3(c$prime), v));
        }
        ;
        if (c$prime instanceof Cut) {
          return evalFocusedWithTrace(c$prime)(newTr);
        }
        ;
        throw new Error("Failed pattern match at Eval.Eval (line 36, column 3 - line 41, column 51): " + [c$prime.constructor.name]);
      });
    };
  };
  var evalFocused = function(c) {
    return bind11(evalFocusedWithTrace(c)(emptyTrace(c)))(function(v) {
      return pure10(v.value0);
    });
  };
  var $$eval = function(c) {
    var c$prime = focus(c);
    return evalFocused(c$prime);
  };
  var evalWithTrace = function(c) {
    var c$prime = focus(c);
    return evalFocusedWithTrace(c$prime)(emptyTrace(c$prime));
  };

  // output/InferDecl/index.js
  var show40 = /* @__PURE__ */ show(showTypevar);
  var show117 = /* @__PURE__ */ show(showTypename);
  var show212 = /* @__PURE__ */ show(showTy);
  var fromFoldable4 = /* @__PURE__ */ fromFoldable(ordTypevar)(foldableList);
  var map30 = /* @__PURE__ */ map(functorList);
  var monadExceptT10 = /* @__PURE__ */ monadExceptT(monadIdentity);
  var bind12 = /* @__PURE__ */ bind(/* @__PURE__ */ bindStateT(monadExceptT10));
  var monadStateStateT2 = /* @__PURE__ */ monadStateStateT(monadExceptT10);
  var modify8 = /* @__PURE__ */ modify2(monadStateStateT2);
  var applicativeStateT2 = /* @__PURE__ */ applicativeStateT(monadExceptT10);
  var pure11 = /* @__PURE__ */ pure(applicativeStateT2);
  var gets4 = /* @__PURE__ */ gets(monadStateStateT2);
  var lookup4 = /* @__PURE__ */ lookup(ordTypevar);
    ...
    return {
      getMessage: function(v) {
        if (v instanceof ErrUndefinedTyVar) {
          return "Type Variable " + (show40(v.value1) + " was not defined");
        }
        ;
        if (v instanceof ErrUndefinedType) {
          return "Type " + (show117(v.value1) + " was not defined");
        }
        ;
        if (v instanceof ErrIllegalType) {
          return "Type " + (show212(v.value1) + " is not allowed in data declaration");
        }
        ;
  ...
  var setCurrVars = function(vars) {
    return function(isco) {
      ...
      var newM = fromFoldable4(map30(function(v) {
  ...
  var inferType = function(v) {
    return function(v1) {
      if (v1 instanceof TyVar) {
        return bind12(gets4(function(v3) {
          return v3.value0.currVars;
        }))(function(vars) {
          var v3 = lookup4(v1.value0)(vars);
          if (v3 instanceof Nothing) {
            return throwError8(new ErrUndefinedTyVar(v, v1.value0));
          }
          ;
          if (v3 instanceof Just) {
            return pure11(new TyVar3(v1.value0, new MkKind(v3.value0)));
          }
          ;
          throw new Error("Failed pattern match at InferDecl (line 89, column 3 - line 91, column 44): " + [v3.constructor.name]);
        });
      }
      ;
      if (v1 instanceof TyDecl) {
        return bind12($$for8(v1.value1)(inferType(v)))(function(args$prime) {
          return bind12(gets4(function(v2) {
            return v2.value0.declsDone;
          }))(function(decls) {
            var v2 = lookup13(v1.value0)(decls);
            if (v2 instanceof Nothing) {
              return bind12(gets4(function(v3) {
                ...
                if (eo instanceof Just) {
                  return pure11(new TyDecl3(v1.value0, args$prime, new MkKind(eo.value0)));
                }
                ;
                throw new Error("Failed pattern match at InferDecl (line 99, column 7 - line 101, column 59): " + [eo.constructor.name]);
              });
            }
            ;
            if (v2 instanceof Just) {
              return pure11(new TyDecl3(v1.value0, args$prime, new MkKind(defaultEo(v2.value0.value0.declType))));
            }
            ;
            throw new Error("Failed pattern match at InferDecl (line 96, column 3 - line 102, column 91): " + [v2.constructor.name]);
          });
        });
      }
      ;
      if (v1 instanceof TyCo) {
        return map111(TyCo3.create)(inferType(v)(v1.value0));
      }
      ;
      if (v1 instanceof TyShift) {
        return map111(shiftEvalOrder4)(inferType(v)(v1.value0));
      }
      ;
  ...
  var inferXtorSig = function(v) {
    return bind12($$for8(v.value0.sigArgs)(inferType(v.value0.sigPos)))(function(args$prime) {
      return pure11(new XtorSig3({
        sigPos: v.value0.sigPos,
        sigName: v.value0.sigName,
        sigArgs: args$prime
      }));
  ...
  var inferDecl = function(v) {
    return bind12(setCurrVars(v.value0.declArgs)(v.value0.declType))(function() {
      return bind12(setCurrPol(defaultEo(v.value0.declType)))(function() {
        return bind12($$for8(v.value0.declXtors)(inferXtorSig))(function(xtors$prime) {
          return pure11(new DataDecl2({
            declPos: v.value0.declPos,
            declName: v.value0.declName,
            declArgs: v.value0.declArgs,
            declType: v.value0.declType,
  ...
  var errorKindError = /* @__PURE__ */ function() {
    return {
      getMessage: function(v) {
        ...
        ;
        throw new Error("Failed pattern match at Kinding.Errors (line 14, column 1 - line 21, column 21): " + [v.constructor.name]);
      },
      getLocation: function(v) {
        if (v instanceof ErrOther6) {
          return v.value0;
  ...
  var pure12 = /* @__PURE__ */ pure(applicativeReaderT8);
  var bind13 = /* @__PURE__ */ bind(/* @__PURE__ */ bindReaderT(/* @__PURE__ */ bindExceptT(monadIdentity)));
  var $$for9 = /* @__PURE__ */ $$for(applicativeReaderT8)(traversableList);
  ...
  var kindType = function(v) {
    if (v instanceof TyVar2) {
      return pure12(new TyVar3(v.value0, defaultKind));
    }
    ;
    if (v instanceof TyDecl2) {
      return bind13($$for9(v.value1)(kindType))(function(tyArgs$prime) {
        return pure12(new TyDecl3(v.value0, tyArgs$prime, defaultKind));
      });
    }
    ;
    if (v instanceof TyShift2) {
      return map31(function(x) {
        return new TyShift3(x, defaultKind);
      })(kindType(v.value0));
    }
    ;
    if (v instanceof TyCo2) {
      return map31(TyCo3.create)(kindType(v.value0));
    }
    ;
    if (v instanceof TyForall2) {
      return map31(TyForall3.create(v.value0))(kindType(v.value1));
    }
    ;
  ...
  var bind14 = /* @__PURE__ */ bind(/* @__PURE__ */ bindReaderT(/* @__PURE__ */ bindExceptT(monadIdentity)));
  var applicativeReaderT9 = /* @__PURE__ */ applicativeReaderT(/* @__PURE__ */ applicativeExceptT(monadIdentity));
  var pure13 = /* @__PURE__ */ pure(applicativeReaderT9);
  var $$for10 = /* @__PURE__ */ $$for(applicativeReaderT9)(traversableList);
  var map32 = /* @__PURE__ */ map(/* @__PURE__ */ functorReaderT(/* @__PURE__ */ functorExceptT(functorIdentity)));
  var kindTerm = function(v) {
    if (v instanceof Var3) {
      return bind14(kindType(v.value2))(function(ty$prime) {
        return pure13(new Var(v.value0, v.value1, ty$prime));
      });
    }
    ;
    if (v instanceof Mu3) {
      return bind14(kindCommand(v.value2))(function(c$prime) {
        return bind14(kindType(v.value3))(function(ty$prime) {
          return pure13(new Mu(v.value0, v.value1, c$prime, ty$prime));
        });
      });
    }
    ;
    if (v instanceof Xtor3) {
      return bind14($$for10(v.value2)(kindTerm))(function(args$prime) {
        return bind14(kindType(v.value3))(function(ty$prime) {
          return pure13(new Xtor(v.value0, v.value1, args$prime, ty$prime));
        });
      });
    }
    ;
    if (v instanceof XCase3) {
      return bind14($$for10(v.value1)(kindPattern))(function(pts$prime) {
        return bind14(kindType(v.value2))(function(ty$prime) {
          return pure13(new XCase(v.value0, pts$prime, ty$prime));
        });
      });
    }
    ;
    if (v instanceof ShiftCBV3) {
      return bind14(kindTerm(v.value1))(function(t$prime) {
        return bind14(kindType(v.value2))(function(ty$prime) {
          return pure13(new ShiftCBV(v.value0, t$prime, ty$prime));
        });
      });
    }
    ;
    if (v instanceof ShiftCBN3) {
      return bind14(kindTerm(v.value1))(function(t$prime) {
        return bind14(kindType(v.value2))(function(ty$prime) {
          return pure13(new ShiftCBN(v.value0, t$prime, ty$prime));
        });
      });
    }
    ;
    throw new Error("Failed pattern match at Kinding.Terms (line 14, column 1 - line 14, column 35): " + [v.constructor.name]);
  };
  var kindPattern = function(v) {
    return bind14(kindCommand(v.value0.ptcmd))(function(c$prime) {
      return pure13(new Pattern({
        ptxt: v.value0.ptxt,
        ptv: v.value0.ptv,
        ptcmd: c$prime
      }));
  ...
  var kindCommand = function(v) {
    if (v instanceof Cut3) {
      return bind14(kindTerm(v.value1))(function(t$prime) {
        return bind14(kindTerm(v.value3))(function(u$prime) {
          return pure13(new Cut(v.value0, t$prime, v.value2, u$prime));
        });
      });
    }
    ;
    if (v instanceof Done4) {
      return pure13(new Done2(v.value0));
    }
    ;
    if (v instanceof Err3) {
      return pure13(new Err(v.value0, v.value1));
    }
    ;
    if (v instanceof Print3) {
      return map32(Print.create(v.value0))(kindTerm(v.value1));
    }
    ;
  ...
  var bind15 = /* @__PURE__ */ bind(/* @__PURE__ */ bindReaderT(/* @__PURE__ */ bindExceptT(monadIdentity)));
  var applicativeReaderT10 = /* @__PURE__ */ applicativeReaderT(/* @__PURE__ */ applicativeExceptT(monadIdentity));
  var pure14 = /* @__PURE__ */ pure(applicativeReaderT10);
  var kindVariable = function(v) {
    return bind15(kindType(v.value0.varTy))(function(ty$prime) {
      return bind15(kindTerm(v.value0.varBody))(function(bd$prime) {
        return pure14(new VarDecl3({
          varPos: v.value0.varPos,
          varName: v.value0.varName,
          varTy: ty$prime,
          varBody: bd$prime
  ...
  var kindRecDecl = function(v) {
    return bind15(kindType(v.value0.recTy))(function(ty$prime) {
      return bind15(kindTerm(v.value0.recBody))(function(bd$prime) {
        return pure14(new RecDecl3({
          recPos: v.value0.recPos,
          recName: v.value0.recName,
          recTy: ty$prime,
          recBody: bd$prime
  ...
  var parseErrorToParserErr = function(v) {
    return new ErrParser(defaultLoc, v.value0);
  };
  ...
  var runParserT = function(dictMonadRec) {
    ...
    return function(s) {
      return function(p2) {
        ...
        return map52(fst)(runParserT$prime1(initialState2)(p2));
      };
    };
  };
  ...
  var MkR = /* @__PURE__ */ function() {
    function MkR2(value0) {
      this.value0 = value0;
    }
    ;
    MkR2.create = function(value0) {
      return new MkR2(value0);
    };
    return MkR2;
  }();
  ...
  var showKeyword = {
    show: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Parser.Keywords (line 31, column 1 - line 51, column 26): " + [v.constructor.name]);
    }
  };
  var allKws = /* @__PURE__ */ function() {
    return new Cons(KwModule.value, new Cons(KwData.value, new Cons(Kwmu.value, new Cons(KwMu.value, new Cons(KwCase.value, new Cons(KwDone.value, new Cons(KwForall.value, new Cons(Kwforall.value, new Cons(KwCo.value, new Cons(Kwco.value, new Cons(KwImport.value, new Cons(KwMain.value, new Cons(KwMain.value, new Cons(KwError.value, new Cons(KwRec.value, new Cons(KwCBV.value, new Cons(KwCBN.value, new Cons(KwCodata.value, Nil.value))))))))))))))))));
  }();
  ...
  var showSym = {
    show: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Parser.Symbols (line 24, column 1 - line 41, column 25): " + [v.constructor.name]);
    }
  };
  ...
  var $$try2 = function(v) {
    return function(v1, more, lift5, $$throw2, done) {
  ...
  var sepBy1 = function(p2) {
    return function(sep) {
      return bind16(p2)(function(a2) {
        return bind16(manyRec2(applySecond2(sep)(p2)))(function(as) {
          return pure15(cons$prime(a2)(as));
        });
      });
    };
  };
  var sepBy = function(p2) {
    return function(sep) {
      return alt2(map33(toList2)(sepBy1(p2)(sep)))(pure15(Nil.value));
    };
  };
  var option = function(a2) {
    return function(p2) {
      return alt2(p2)(pure15(a2));
    };
  };
  var optionMaybe = function(p2) {
    return option(Nothing.value)(map33(Just.create)(p2));
  };
  ...
  var many1 = function(p2) {
    return apply2(map33(cons$prime)(p2))(manyRec2(p2));
  };
  ...
  var show118 = /* @__PURE__ */ show(showString);
  var show213 = /* @__PURE__ */ show(showChar);
  ...
  var string = function(str) {
    return consumeWith(function(input3) {
      ...
      ;
      return new Left("Expected " + show118(str));
    });
  };
  var $$char = function(c) {
  ...
  var show41 = /* @__PURE__ */ show(showSym);
  var pure16 = /* @__PURE__ */ pure(applicativeParserT);
  var show119 = /* @__PURE__ */ show(showKeyword);
  var elem14 = /* @__PURE__ */ elem(foldableList)(eqString);
  var map34 = /* @__PURE__ */ map(functorList);
  var show214 = /* @__PURE__ */ show(showString);
  var alt3 = /* @__PURE__ */ alt(altParserT);
  var parseSymbol = function(sym) {
    return bind17(string(show41(sym)))(function() {
      return pure16(unit);
    });
  };
  var parseKeyword = function(kw) {
    return bind17(string(show119(kw)))(function() {
      return pure16(unit);
    });
  };
  var parseIdentifier = /* @__PURE__ */ bind17(/* @__PURE__ */ map(functorParserT)(/* @__PURE__ */ show(/* @__PURE__ */ showNonEmptyList(showChar)))(/* @__PURE__ */ many1(alphaNum)))(function(ident) {
    var $15 = elem14(ident)(map34(show119)(allKws));
    if ($15) {
      return fail("identifier cannot be a keyword, got " + show214(ident));
    }
    ;
    return pure16(ident);
  });
  var parseComment = /* @__PURE__ */ function() {
    return $$try2(bind17(parseSymbol(SymMinus.value))(function() {
      return bind17(parseSymbol(SymMinus.value))(function() {
        return bind17(manyTill(anyChar)($$char("\n")))(function() {
          return pure16(unit);
        });
      });
    }));
  ...
  var sc = /* @__PURE__ */ function() {
    var manySpace = bind17(many1(space))(function() {
      return pure16(unit);
    });
    return choice(foldableArray)([manySpace, parseComment]);
  }();
  var parseParens = function(p2) {
    return bind17(parseSymbol(SymParensO.value))(function() {
      return bind17(sc)(function() {
        return bind17(p2)(function(a2) {
          return bind17(sc)(function() {
            return bind17(parseSymbol(SymParensC.value))(function() {
              return pure16(a2);
            });
          });
        });
  ...
  var parseCommaSep = /* @__PURE__ */ function() {
    return bind17(parseSymbol(SymComma.value))(function() {
      return sc;
    });
  }();
  ...
  var getCurrPos = /* @__PURE__ */ bind17(position)(function(v) {
    return pure16(new SourcePosition({
      srcCol: v.column,
      srcLine: v.line
    }));
  });
  var getCurrLoc = function(startPos) {
    return bind17(getCurrPos)(function(currPos) {
      return pure16(new Loc({
        locStart: startPos,
        locEnd: currPos
      }));
    });
  ...
  var parseVariance = /* @__PURE__ */ function() {
    return alt4(bind18(parseSymbol(SymPlus.value))(function() {
      return pure17(Covariant.value);
    }))(bind18(parseSymbol(SymMinus.value))(function() {
      return pure17(Contravariant.value);
    }));
  }();
  ...
  var parseVariantVar = /* @__PURE__ */ bind18(parseTypevar)(function(tyv) {
    return bind18(sc)(function() {
      return bind18(parseSymbol(SymColon.value))(function() {
        return bind18(sc)(function() {
          return bind18(parseVariance)(function($$var2) {
            return pure17(new VariantVar({
              variantVar: tyv,
  ...
  var parseEvaluationOrder = /* @__PURE__ */ function() {
    return alt4(bind18(parseKeyword(KwCBV.value))(function() {
      return pure17(CBV.value);
    }))(bind18(parseKeyword(KwCBN.value))(function() {
      return pure17(CBN.value);
    }));
  }();
  var parseDataCodata = /* @__PURE__ */ function() {
    return alt4(bind18(parseKeyword(KwData.value))(function() {
      return pure17(Data.value);
    }))(bind18(parseKeyword(KwCodata.value))(function() {
  ...
  var parseCutAnnot = /* @__PURE__ */ alt6(/* @__PURE__ */ $$try2(/* @__PURE__ */ bind20(parseTy)(function(ty) {
    return bind20(sc)(function() {
      return bind20(parseSymbol(SymColon.value))(function() {
        return bind20(sc)(function() {
          return bind20(parseEvaluationOrder)(function(eo) {
            return pure19(new Tuple(eo, new Just(ty)));
          });
        });
      });
    });
  ...
  var $lazy_parseCommand = /* @__PURE__ */ $runtime_lazy6("parseCommand", "Parser.Terms", function() {
    var tyAnnot = function(ps) {
      return bind20(parseTy)(function(ty) {
        return bind20(sc)(function() {
          return bind20(ps)(function() {
            return bind20(ps)(function() {
              return bind20(sc)(function() {
                return pure19(ty);
              });
    ...
    var charlsToStr = function(v) {
      ...
      ;
      if (v instanceof Cons) {
        return singleton4(v.value0) + charlsToStr(v.value1);
      }
      ;
      throw new Error("Failed pattern match at Parser.Terms (line 216, column 5 - line 216, column 39): " + [v.constructor.name]);
    };
    return alt6(bind20(getCurrPos)(function(startPos) {
      return bind20(parseAngO)(function() {
        return bind20(sc)(function() {
          return bind20($lazy_parseTerm(115))(function(t) {
            return bind20(sc)(function() {
                ...
                return bind20(sc)(function() {
                  return bind20(parseCutAnnot)(function(v) {
                    return bind20(sc)(function() {
                      return bind20(parseSymbol(SymBar.value))(function() {
                        return bind20(sc)(function() {
                          return bind20($lazy_parseTerm(123))(function(u2) {
                            return bind20(sc)(function() {
                              return bind20(parseAngC)(function() {
                                return bind20(getCurrLoc(startPos))(function(loc) {
                                  ...
                                  ;
                                  throw new Error("Failed pattern match at Parser.Terms (line 127, column 3 - line 129, column 46): " + [v.value1.constructor.name]);
                                });
                              });
                            });
                          });
    ...
    }))(alt6(bind20(getCurrPos)(function(startPos) {
      return bind20(parseKeyword(KwDone.value))(function() {
        return bind20(getCurrLoc(startPos))(function(loc) {
          return pure19(new Done5(loc));
        });
      });
    }))(alt6(bind20(getCurrPos)(function(startPos) {
      return bind20(parseKeyword(KwError.value))(function() {
        return bind20(sc)(function() {
          return bind20(parseSymbol(SymQuot.value))(function() {
            return bind20(manyTill(anyChar)($$char("\n")))(function(msg) {
              return bind20(parseSymbol(SymQuot.value))(function() {
                return bind20(getCurrLoc(startPos))(function(loc) {
                  return pure19(new Err4(loc, charlsToStr(msg)));
                });
              });
            });
          });
      ...
      return bind20(sc)(function() {
        return bind20(alt6(parseKeyword(KwPrint.value))(parseKeyword(Kwprint.value)))(function() {
          return bind20(sc)(function() {
            return bind20($lazy_parseTerm(155))(function(t) {
              return bind20(sc)(function() {
                return bind20(getCurrLoc(startPos))(function(loc) {
                ...
                return bind20(parseSymbol(SymColon.value))(function() {
                  return bind20(parseSymbol(SymColon.value))(function() {
                    return bind20(sc)(function() {
                      return bind20(parseTy)(function(ty) {
                        return bind20(getCurrLoc(startPos))(function(loc) {
                          return pure19(new PrintAnnot2(loc, t, ty));
                        });
                      });
                    });
                  });
    ...
    }))(alt6($$try2(bind20(getCurrPos)(function(startPos) {
      return bind20($lazy_parseTerm(178))(function(t) {
        return bind20(sc)(function() {
          return bind20(parseAngC)(function() {
            return bind20(parseAngC)(function() {
              return bind20(sc)(function() {
                return bind20(optionMaybe($$try2(tyAnnot(parseAngC))))(function(mty) {
                  return bind20($lazy_parseTerm(184))(function(u2) {
                    return bind20(getCurrLoc(startPos))(function(loc) {
                      ...
                      ;
                      throw new Error("Failed pattern match at Parser.Terms (line 186, column 3 - line 188, column 46): " + [mty.constructor.name]);
                    });
                  });
                });
              });
    ...
    })))($$try2(bind20(getCurrPos)(function(startPos) {
      return bind20($lazy_parseTerm(193))(function(t) {
        return bind20(sc)(function() {
          return bind20(parseAngO)(function() {
            return bind20(parseAngO)(function() {
              return bind20(sc)(function() {
                return bind20(optionMaybe($$try2(tyAnnot(parseAngO))))(function(mty) {
                  return bind20($lazy_parseTerm(199))(function(u2) {
                    return bind20(getCurrLoc(startPos))(function(loc) {
                      if (mty instanceof Nothing) {
                      ...
                      ;
                      throw new Error("Failed pattern match at Parser.Terms (line 201, column 3 - line 203, column 46): " + [mty.constructor.name]);
                    });
                  });
                });
              });
  ...
  var $lazy_parsePattern = /* @__PURE__ */ $runtime_lazy6("parsePattern", "Parser.Terms", function() {
    return bind20(parseXtorname)(function(nm) {
      return bind20(sc)(function() {
        return bind20(optionMaybe(parseParens(sepBy(parseVariable)(parseCommaSep))))(function(args) {
          return bind20(sc)(function() {
            return bind20(parseSymbol(SymEq.value))(function() {
              return bind20(parseAngC)(function() {
                return bind20(sc)(function() {
                  return bind20($lazy_parseCommand(101))(function(c) {
                    ...
                    ;
                    throw new Error("Failed pattern match at Parser.Terms (line 102, column 3 - line 104, column 61): " + [args.constructor.name]);
                  });
                });
              });
            });
  ...
  var $lazy_parseTerm = /* @__PURE__ */ $runtime_lazy6("parseTerm", "Parser.Terms", function() {
    return alt6(bind20(getCurrPos)(function(startPos) {
      return bind20(alt6(parseKeyword(KwMu.value))(parseKeyword(Kwmu.value)))(function() {
        return bind20(sc)(function() {
          return bind20(parseVariable)(function(v) {
            return bind20(sc)(function() {
              return bind20(parseSymbol(SymDot.value))(function() {
                return bind20(sc)(function() {
                  return bind20($lazy_parseCommand(36))(function(c) {
                    return bind20(getCurrLoc(startPos))(function(loc) {
      ...
      return bind20(parseKeyword(KwCase.value))(function() {
        return bind20(sc)(function() {
          return bind20(parseSymbol(SymBrackO.value))(function() {
            return bind20(sc)(function() {
              return bind20(sepBy($lazy_parsePattern(47))(parseCommaSep))(function(pts) {
                return bind20(sc)(function() {
                  return bind20(parseSymbol(SymBrackC.value))(function() {
                    return bind20(getCurrLoc(startPos))(function(loc) {
                      return pure19(new XCase4(loc, pts));
                    });
                  });
                });
              });
      ...
      return bind20(parseSymbol(SymBrackO.value))(function() {
        return bind20(sc)(function() {
          return bind20($lazy_parseTerm(58))(function(t) {
            return bind20(sc)(function() {
              return bind20(parseSymbol(SymColon.value))(function() {
                return bind20(sc)(function() {
                  return bind20(parseEvaluationOrder)(function(eo) {
                    return bind20(parseSymbol(SymBrackC.value))(function() {
                      return bind20(getCurrLoc(startPos))(function(loc) {
                        if (eo instanceof CBV) {
                          return pure19(new ShiftCBV4(loc, t));
                        }
                        ;
                        ...
                        ;
                        throw new Error("Failed pattern match at Parser.Terms (line 65, column 3 - line 67, column 33): " + [eo.constructor.name]);
                      });
                    });
                  });
                });
      ...
      return bind20(parseXtorname)(function(nm) {
        return bind20(sc)(function() {
          return bind20(parseSymbol(SymParensO.value))(function() {
            return bind20(sc)(function() {
              return bind20(sepBy($lazy_parseTerm(76))(parseCommaSep))(function(args) {
                return bind20(sc)(function() {
    ...
    }))(bind20(getCurrPos)(function(startPos) {
      return bind20(parseVariable)(function(v) {
        return bind20(getCurrLoc(startPos))(function(loc) {
          return pure19(new Var4(loc, v));
        });
      });
    })))));
  });
  var parseCommand = /* @__PURE__ */ $lazy_parseCommand(108);
  var parseTerm = /* @__PURE__ */ $lazy_parseTerm(25);

  // output/Syntax.Parsed.Program/index.js
  var show215 = /* @__PURE__ */ show(showVariable);
  ...
  var RecDecl4 = /* @__PURE__ */ function() {
    function RecDecl5(value0) {
      this.value0 = value0;
    }
    ;
  ...
  var showVarDecl2 = {
    show: function(v) {
      return show215(v.value0.varName) + (":=" + (show310(v.value0.varBody) + ";"));
    }
  };
  ...
  var addVarProgram3 = function(v) {
    return function(v1) {
      return new Program3({
        progName: v1.value0.progName,
        progDecls: v1.value0.progDecls,
        progRecs: v1.value0.progRecs,
        progAnnots: v1.value0.progAnnots,
        progImports: v1.value0.progImports,
        progMain: v1.value0.progMain,
        progSrc: v1.value0.progSrc,
        progVars: insert7(v.value0.varName)(new VarDecl4(v.value0))(v1.value0.progVars)
      });
    };
  };
  var addRecProgram3 = function(v) {
    return function(v1) {
      return new Program3({
        progName: v1.value0.progName,
        progDecls: v1.value0.progDecls,
        ...
        progMain: v1.value0.progMain,
        progSrc: v1.value0.progSrc,
        progRecs: insert7(v.value0.recName)(new RecDecl4(v.value0))(v1.value0.progRecs)
      });
    };
  };
  ...
  var addDeclProgram3 = function(v) {
    return function(v1) {
      return new Program3({
        progName: v1.value0.progName,
        progVars: v1.value0.progVars,
        ...
        progMain: v1.value0.progMain,
        progSrc: v1.value0.progSrc,
        progDecls: insert13(v.value0.declName)(new DataDecl3(v.value0))(v1.value0.progDecls)
      });
    };
  };
  var addAnnotProgram = function(v) {
    return function(v1) {
      return new Program3({
        progName: v1.value0.progName,
        progDecls: v1.value0.progDecls,
        ...
        progMain: v1.value0.progMain,
        progSrc: v1.value0.progSrc,
        progAnnots: insert7(v.value0.annotName)(new AnnotDecl(v.value0))(v1.value0.progAnnots)
      });
    };
  };
  ...
  var show46 = /* @__PURE__ */ show(showTypename);
  var member1 = /* @__PURE__ */ member(ordVariable);
  var show120 = /* @__PURE__ */ show(showVarDecl2);
  ...
  var parseXtorSig = /* @__PURE__ */ bind21(getCurrPos)(function(startPos) {
    return bind21(parseXtorname)(function(nm) {
      return bind21(optionMaybe(parseParens(sepBy(parseTy)(parseCommaSep))))(function(args) {
        return bind21(getCurrLoc(startPos))(function(loc) {
          if (args instanceof Nothing) {
            return pure20(new XtorSig4({
              sigPos: loc,
              sigName: nm,
              sigArgs: Nil.value
            }));
  ...
  var parseTypeAnnot = /* @__PURE__ */ bind21(getCurrPos)(function(startPos) {
    return bind21(parseVariable)(function(nm) {
      return bind21(sc)(function() {
        return bind21(parseSymbol(SymColon.value))(function() {
          return bind21(parseSymbol(SymColon.value))(function() {
  ...
  var parseRecDecl = /* @__PURE__ */ function() {
    return bind21(parseKeyword(KwRec.value))(function() {
      return bind21(sc)(function() {
        return bind21(parseVarDecl)(function(v) {
          return pure20(new RecDecl4({
            recPos: v.value0.varPos,
            recName: v.value0.varName,
            recBody: v.value0.varBody
          }));
        });
      });
    });
  ...
  var parseModuleDecl = /* @__PURE__ */ function() {
    return alt7(bind21(parseKeyword(KwModule.value))(function() {
  ...
  var parseImport = /* @__PURE__ */ bind21(getCurrPos)(function(startPos) {
    return bind21(parseKeyword(KwImport.value))(function() {
      return bind21(space)(function() {
        return bind21(sc)(function() {
  ...
  var parseDataDecl = /* @__PURE__ */ bind21(getCurrPos)(function(startPos) {
    return bind21(parseDataCodata)(function(isco) {
      return bind21(space)(function() {
        return bind21(sc)(function() {
          return bind21(parseTypename)(function(nm) {
            return bind21(sc)(function() {
              return bind21(parseTyArgs)(function(args) {
                return bind21(sc)(function() {
                  return bind21(parseSymbol(SymBrackO.value))(function() {
                    return bind21(sc)(function() {
                      return bind21(sepBy(parseXtorSig)(parseCommaSep))(function(xtors) {
                        return bind21(sc)(function() {
                          return bind21(parseSymbol(SymBrackC.value))(function() {
                            return bind21(getCurrLoc(startPos))(function(loc) {
                              return pure20(new DataDecl3({
                                declPos: loc,
                                declName: nm,
                                declArgs: args,
                                declType: isco,
  ...
  var parseDecl = /* @__PURE__ */ function() {
    return alt7(map35(MkI.create)(parseImport))(alt7(map35(MkD.create)(parseDataDecl))(alt7(map35(MkM.create)(parseMain))(alt7(map35(MkR.create)(parseRecDecl))(alt7(map35(MkV.create)($$try2(parseVarDecl)))(map35(MkA.create)($$try2(parseTypeAnnot)))))));
  }();
  var parseProgram = function(src9) {
    var foldFun = function(v) {
      return function(v1) {
        if (v1 instanceof MkD) {
          var $20 = member3(v1.value0.value0.declName)(v.value0.progDecls);
          if ($20) {
            return fail("multiple declarations for type " + show46(v1.value0.value0.declName));
          }
          ;
        ...
        if (v1 instanceof MkV) {
          var $24 = member1(v1.value0.value0.varName)(v.value0.progVars);
          if ($24) {
            return fail("multiple declarations for variable " + show120(v1.value0));
          }
          ;
          return pure20(addVarProgram3(v1.value0)(v));
        }
        ;
        if (v1 instanceof MkA) {
          return pure20(addAnnotProgram(v1.value0)(v));
        }
        ;
        if (v1 instanceof MkI) {
          return pure20(addImportProgram(v1.value0)(v));
        }
        ;
        if (v1 instanceof MkM) {
          var $30 = isJust(v.value0.progMain);
          if ($30) {
            return fail("multiple definitions of main");
          }
          ;
          return pure20(setMainProgram2(v1.value0)(v));
        }
        ;
        if (v1 instanceof MkR) {
          return pure20(addRecProgram3(v1.value0)(v));
        }
        ;
        throw new Error("Failed pattern match at Parser.Program (line 46, column 5 - line 46, column 57): " + [v.constructor.name, v1.constructor.name]);
      };
    };
    return bind21(parseModuleDecl)(function(nm) {
      return bind21(sc)(function() {
        return bind21(manyTill(bind21(parseDecl)(function(decl) {
          return bind21(sc)(function() {
            return pure20(decl);
          });
        }))(eof))(function(decls) {
          return foldM5(foldFun)(emptyProg3(nm)(src9))(decls);
        });
      });
    });
  };
  ...
  var show47 = /* @__PURE__ */ show(showTerm2);
  var show121 = /* @__PURE__ */ show(showCommand2);
  var show216 = /* @__PURE__ */ show(showVariable);
  var show311 = /* @__PURE__ */ show(showTypevar);
  var show48 = /* @__PURE__ */ show(showTy2);
  var show53 = /* @__PURE__ */ show(showTerm3);
  var show63 = /* @__PURE__ */ show(showTy);
  var show73 = /* @__PURE__ */ show(showTypename);
  var show83 = /* @__PURE__ */ show(showXtorname);
  ...
  var ErrKindNeq = /* @__PURE__ */ function() {
    function ErrKindNeq2(value0, value1, value22, value32) {
      this.value0 = value0;
      this.value1 = value1;
      this.value2 = value22;
      this.value3 = value32;
    ...
    ;
    ErrKindNeq2.create = function(value0) {
      return function(value1) {
        return function(value22) {
          return function(value32) {
            return new ErrKindNeq2(value0, value1, value22, value32);
          };
        };
      };
    };
  ...
  var ErrBadPattern = /* @__PURE__ */ function() {
    function ErrBadPattern2(value0, value1, value22, value32) {
      this.value0 = value0;
      this.value1 = value1;
      this.value2 = value22;
      this.value3 = value32;
    ...
    ;
    ErrBadPattern2.create = function(value0) {
      return function(value1) {
        return function(value22) {
          return function(value32) {
            return new ErrBadPattern2(value0, value1, value22, value32);
          };
        };
      };
    };
    return ErrBadPattern2;
  }();
  ...
  var whileTerm = function(t) {
    return "while type checking " + show47(t);
  };
  var whileCmd = function(c) {
    return "while type checking " + show121(c);
  };
  var errorCheckerError = /* @__PURE__ */ function() {
    return {
      getMessage: function(v) {
        if (v instanceof ErrNoAnnot) {
          return "No annotation for " + (show216(v.value1) + ", cannot type check.");
        }
        ;
        if (v instanceof ErrUndefinedVar2) {
          return "Variable " + (show216(v.value1) + " was not defined ");
        }
        ;
        ...
        if (v instanceof ErrTyCoForShift) {
          return "Cannot use co-type of " + (show48(v.value2) + (" for shift term " + show53(v.value1)));
        }
        ;
        if (v instanceof ErrKindNeq) {
          return "Kinds of types " + (show48(v.value1) + (" and " + (show48(v.value2) + (" are not equal " + whileTerm(v.value3)))));
        }
        ;
        if (v instanceof ErrNotSubsumed) {
          return "Type " + (show48(v.value1) + (" should be subsumed by " + show48(v.value2)));
        }
        ;
        if (v instanceof ErrKindUnclear) {
          return "Kind of type " + (show63(v.value1) + " is unclear");
        }
        ;
        if (v instanceof ErrTypeNeq) {
          return "Types " + (show48(v.value1) + (" and " + (show48(v.value2) + (" should be equal " + whileTerm(v.value3)))));
        }
        ;
        if (v instanceof ErrNotTyDecl) {
          return "Type " + (show48(v.value2) + (" should be " + (show73(v.value1) + (" " + whileTerm(v.value3)))));
        }
        ;
        if (v instanceof ErrTypeArity) {
          return "Wrong number of arguments for type " + show73(v.value1);
        }
        ;
        if (v instanceof ErrXtorArity2) {
          return "Wrong number of arguments for xtor " + show83(v.value1);
        }
        ;
        if (v instanceof ErrBadPattern) {
          return "Malformed case: found patterns for " + (intercalate15(", ")(map36(show83)(v.value1)) + (", expected " + (intercalate15(", ")(map36(show83)(v.value2)) + (" " + whileTerm(v.value3)))));
        }
        ;
        if (v instanceof ErrCutKind) {
          return "Kind of types " + (show48(v.value1) + (" and " + (show48(v.value2) + (" in cut are not equal " + whileCmd(v.value3)))));
        }
        ;
        if (v instanceof ErrBadType) {
          return "Cannot typecheck " + (show47(v.value1) + (" with type " + show48(v.value2)));
        }
        ;
        if (v instanceof ErrUnclearType) {
          return "Type of term " + (show121(v.value1) + " is unclear");
        }
        ;
        if (v instanceof ErrList) {
          return intercalate15("\n ")(map36(getMessage(errorCheckerError))(v.value1));
        }
        ;
  ...
  var monadStateReaderT4 = /* @__PURE__ */ monadStateReaderT(/* @__PURE__ */ monadStateStateT(monadExceptT11));
  var gets5 = /* @__PURE__ */ gets(monadStateReaderT4);
  var bind22 = /* @__PURE__ */ bind(/* @__PURE__ */ bindReaderT(/* @__PURE__ */ bindStateT(monadExceptT11)));
  var monadErrorReaderT4 = /* @__PURE__ */ monadErrorReaderT(/* @__PURE__ */ monadErrorStateT(/* @__PURE__ */ monadErrorExceptT(monadIdentity)));
  var monadReaderReaderT4 = /* @__PURE__ */ monadReaderReaderT(/* @__PURE__ */ monadStateT(monadExceptT11));
  var lookupMVar3 = /* @__PURE__ */ lookupMVar(errorCheckerError)(monadErrorReaderT4)(monadReaderReaderT4);
  var lookupMRec2 = /* @__PURE__ */ lookupMRec(errorCheckerError)(monadErrorReaderT4)(monadReaderReaderT4);
  var lookup5 = /* @__PURE__ */ lookup(ordVariable);
  var pure21 = /* @__PURE__ */ pure(/* @__PURE__ */ applicativeReaderT(/* @__PURE__ */ applicativeStateT(monadExceptT11)));
  ...
  var insert8 = /* @__PURE__ */ insert(ordVariable);
  ...
  var runCheckM = function(env) {
    return function(m) {
      ...
      ;
      throw new Error("Failed pattern match at TypeCheck.Definition (line 42, column 19 - line 44, column 31): " + [v.constructor.name]);
    };
  };
  var getCheckerVars = /* @__PURE__ */ gets5(function(v) {
    return v.value0.checkVars;
  });
  var getMTypeVar = function(v) {
    return bind22(getCheckerVars)(function(vars) {
      return bind22(lookupMVar3(v))(function(mvar) {
        return bind22(lookupMRec2(v))(function(mrec) {
          var v1 = new Tuple(lookup5(v)(vars), new Tuple(mvar, mrec));
          if (v1.value0 instanceof Nothing && (v1.value1.value0 instanceof Nothing && v1.value1.value1 instanceof Nothing)) {
            return pure21(Nothing.value);
          }
          ;
          if (v1.value0 instanceof Just) {
            return pure21(new Just(v1.value0.value0));
          }
          ;
          if (v1.value1.value0 instanceof Just) {
            return pure21(new Just(embedType2(v1.value1.value0.value0.value0.varTy)));
          }
          ;
          if (v1.value1.value1 instanceof Just) {
            return pure21(new Just(embedType2(v1.value1.value1.value0.value0.recTy)));
          }
          ;
          throw new Error("Failed pattern match at TypeCheck.Definition (line 75, column 3 - line 79, column 86): " + [v1.constructor.name]);
        });
      });
    });
  };
  var getTypeVar = function(loc) {
    return function(v) {
      return bind22(getMTypeVar(v))(function(mty) {
        ...
        ;
        if (mty instanceof Just) {
          return pure21(mty.value0);
        }
        ;
        throw new Error("Failed pattern match at TypeCheck.Definition (line 84, column 3 - line 86, column 23): " + [mty.constructor.name]);
      });
    };
  };
  var withCheckerVars = function(newVars) {
    return function(fun) {
      return bind22(getCheckerVars)(function(currVars) {
        return bind22(modify9(function(v) {
          return new MkCheckState({
            checkTyVars: v.value0.checkTyVars,
            checkVars: union5(currVars)(newVars)
          });
        }))(function() {
          return bind22(fun)(function(res) {
            return bind22(modify9(function(v) {
              return new MkCheckState({
                checkTyVars: v.value0.checkTyVars,
                checkVars: currVars
  ...
  var getCheckerTyVars = /* @__PURE__ */ gets5(function(v) {
    return v.value0.checkTyVars;
  });
  var addCheckerVar = function(v) {
    return function(ty) {
      return bind22(modify9(function(v1) {
        return new MkCheckState({
          checkTyVars: v1.value0.checkTyVars,
          checkVars: insert8(v)(ty)(v1.value0.checkVars)
        });
      }))(function() {
        return pure21(unit);
      });
  ...
  var lookup6 = /* @__PURE__ */ lookup(ordTypevar);
    ...
    substTyvars: function(v) {
      return function(v1) {
        if (v1 instanceof TyVar2) {
          return fromMaybe(v1)(lookup6(v1.value0)(v));
        }
        ;
        if (v1 instanceof TyDecl2) {
          return new TyDecl2(v1.value0, map37(substTyvars(substituteTypevarsTy)(v))(v1.value1));
        }
        ;
        if (v1 instanceof TyShift2) {
        ...
        ;
        if (v1 instanceof TyForall2) {
          var newmap = foldr6($$delete6)(v)(v1.value0);
          return new TyForall2(v1.value0, substTyvars(substituteTypevarsTy)(newmap)(v1.value1));
        }
        ;
        throw new Error("Failed pattern match at Syntax.Typed.Substitution (line 26, column 1 - line 31, column 121): " + [v.constructor.name, v1.constructor.name]);
      };
    }
  };
  ...
  var bind23 = /* @__PURE__ */ bind(/* @__PURE__ */ bindReaderT(/* @__PURE__ */ bindStateT(monadExceptT12)));
  var elem15 = /* @__PURE__ */ elem(foldableList)(eqTypevar);
  var applicativeReaderT11 = /* @__PURE__ */ applicativeReaderT(/* @__PURE__ */ applicativeStateT(monadExceptT12));
  var pure22 = /* @__PURE__ */ pure(applicativeReaderT11);
  ...
  var lookupDecl2 = /* @__PURE__ */ lookupDecl(errorCheckerError)(monadErrorReaderT5)(/* @__PURE__ */ monadReaderReaderT(/* @__PURE__ */ monadStateT(monadExceptT12)));
  var zipWithErrorM2 = /* @__PURE__ */ zipWithErrorM(errorCheckerError)(monadErrorReaderT5);
  var $$for11 = /* @__PURE__ */ $$for(applicativeReaderT11)(traversableList);
  var checkType = function(v) {
    return function(v1) {
      if (v1 instanceof TyVar) {
        return bind23(getCheckerTyVars)(function(tyVars) {
      ...
      ;
      if (v1 instanceof TyDecl) {
        return bind23(lookupDecl2(v)(v1.value0))(function(v2) {
          return bind23(zipWithErrorM2(v1.value1)(v2.value0.declArgs)(new ErrTypeArity(v, v1.value0)))(function() {
            return bind23($$for11(v1.value1)(checkType(v)))(function(args$prime) {
              return pure22(new TyDecl2(v1.value0, args$prime));
            });
          });
        });
      }
      ;
      if (v1 instanceof TyCo) {
        return bind23(checkType(v)(v1.value0))(function(ty$prime) {
          return pure22(new TyCo2(ty$prime));
        });
      }
      ;
      if (v1 instanceof TyShift) {
        return bind23(checkType(v)(v1.value0))(function(ty$prime) {
          return pure22(new TyShift2(ty$prime));
        });
      }
      ;
      if (v1 instanceof TyForall) {
        return bind23($$for11(v1.value0)(addCheckerTyVar))(function() {
          return bind23(checkType(v)(v1.value1))(function(ty$prime) {
            return pure22(new TyForall2(v1.value0, ty$prime));
          });
        });
      }
      ;
      throw new Error("Failed pattern match at TypeCheck.Types (line 21, column 1 - line 21, column 40): " + [v.constructor.name, v1.constructor.name]);
    };
  };

  // output/TypeCheck.Terms/index.js
  var monadExceptT13 = /* @__PURE__ */ monadExceptT(monadIdentity);
  var bind24 = /* @__PURE__ */ bind(/* @__PURE__ */ bindReaderT(/* @__PURE__ */ bindStateT(monadExceptT13)));
  var applicativeReaderT12 = /* @__PURE__ */ applicativeReaderT(/* @__PURE__ */ applicativeStateT(monadExceptT13));
  var $$for12 = /* @__PURE__ */ $$for(applicativeReaderT12)(traversableList);
  var pure23 = /* @__PURE__ */ pure(applicativeReaderT12);
  ...
  var map38 = /* @__PURE__ */ map(/* @__PURE__ */ functorReaderT(/* @__PURE__ */ functorStateT(/* @__PURE__ */ functorExceptT(functorIdentity))));
  var lookup7 = /* @__PURE__ */ lookup(ordVariable);
  var monadErrorReaderT6 = /* @__PURE__ */ monadErrorReaderT(/* @__PURE__ */ monadErrorStateT(/* @__PURE__ */ monadErrorExceptT(monadIdentity)));
  var monadReaderReaderT5 = /* @__PURE__ */ monadReaderReaderT(/* @__PURE__ */ monadStateT(monadExceptT13));
  var lookupMVar4 = /* @__PURE__ */ lookupMVar(errorCheckerError)(monadErrorReaderT6)(monadReaderReaderT5);
  var lookupMRec3 = /* @__PURE__ */ lookupMRec(errorCheckerError)(monadErrorReaderT6)(monadReaderReaderT5);
  var map112 = /* @__PURE__ */ map(functorMaybe);
  var lookupXtorDecl2 = /* @__PURE__ */ lookupXtorDecl(errorCheckerError)(monadErrorReaderT6)(monadReaderReaderT5);
  var lookupXtor2 = /* @__PURE__ */ lookupXtor(errorCheckerError)(monadErrorReaderT6)(monadReaderReaderT5);
  var unless2 = /* @__PURE__ */ unless(applicativeReaderT12);
  var eq21 = /* @__PURE__ */ eq(eqTypename);
  var map210 = /* @__PURE__ */ map(functorList);
  var zipWithErrorM3 = /* @__PURE__ */ zipWithErrorM(errorCheckerError)(monadErrorReaderT6);
  var substTyvars2 = /* @__PURE__ */ substTyvars(substituteTypevarsTy);
  var fromFoldable7 = /* @__PURE__ */ fromFoldable(ordTypevar)(foldableList);
  ...
  var fromFoldable1 = /* @__PURE__ */ fromFoldable2(foldableList)(ordXtorname);
  var getLoc4 = /* @__PURE__ */ getLoc(hasLocTerm2);
  var eq26 = /* @__PURE__ */ eq(eqTy2);
  var getLoc1 = /* @__PURE__ */ getLoc(hasLocCommand2);
  var checkTerm = function(v) {
    return function(v1) {
      if (v1 instanceof TyForall2) {
        return bind24($$for12(v1.value0)(addCheckerTyVar))(function() {
          return bind24(checkTerm(v)(v1.value1))(function(t$prime) {
            var newTy = new TyForall2(v1.value0, getType2(t$prime));
            return pure23(setType(t$prime)(newTy));
          });
        });
      }
      ;
      if (v1 instanceof TyCo2) {
        return bind24(checkTerm(v)(v1.value0))(function(t$prime) {
      ...
      ;
      if (v instanceof Var2) {
        var firstJust = function($copy_v3) {
          var $tco_done = false;
          var $tco_result;
          function $tco_loop(v3) {
            ...
            ;
            if (v3 instanceof Cons && v3.value0 instanceof Just) {
              $tco_done = true;
              return pure23(v3.value0.value0);
            }
            ;
            if (v3 instanceof Cons && v3.value0 instanceof Nothing) {
              $copy_v3 = v3.value1;
              return;
            }
            ;
            throw new Error("Failed pattern match at TypeCheck.Terms (line 56, column 5 - line 56, column 54): " + [v3.constructor.name]);
          }
          ;
          while (!$tco_done) {
        ...
        return bind24(map38(lookup7(v.value1))(getCheckerVars))(function(checkerTy) {
          return bind24(lookupMVar4(v.value1))(function(vardecl) {
            return bind24(lookupMRec3(v.value1))(function(recdecl) {
              var mvarty = map112(function(v3) {
                return embedType2(v3.value0.varTy);
              })(vardecl);
              var mrecty = map112(function(v3) {
                return embedType2(v3.value0.recTy);
              })(recdecl);
              return bind24(firstJust(new Cons(checkerTy, new Cons(mvarty, new Cons(mrecty, Nil.value)))))(function(ty$prime) {
                var $86 = isSubsumed(v1)(ty$prime);
                if ($86) {
      ...
      ;
      if (v instanceof Mu2) {
        return bind24(addCheckerVar(v.value1)(v1))(function() {
          return bind24(checkCommand(v.value2))(function(c$prime) {
            return pure23(new Mu3(v.value0, v.value1, c$prime, v1));
          });
        });
      }
      ;
      if (v instanceof Xtor2 && v1 instanceof TyDecl2) {
        return bind24(lookupXtorDecl2(v.value0)(v.value1))(function(v2) {
          return bind24(lookupXtor2(v.value0)(v.value1))(function(v3) {
            return bind24(unless2(eq21(v1.value0)(v2.value0.declName))(throwError12(new ErrNotTyDecl(v.value0, v2.value0.declName, v1, v))))(function() {
              var argVars = map210(function(v4) {
                return v4.value0.variantVar;
              })(v2.value0.declArgs);
              return bind24(zipWithErrorM3(argVars)(v1.value1)(new ErrTypeArity(v.value0, v1.value0)))(function(varSubsts) {
                var argsEmbedded = map210(embedType2)(v3.value0.sigArgs);
                var xtArgTys = map210(substTyvars2(fromFoldable7(varSubsts)))(argsEmbedded);
                return bind24(zipWithErrorM3(v.value2)(xtArgTys)(new ErrXtorArity2(v.value0, v.value1)))(function(argsToCheck) {
                  return bind24($$for12(argsToCheck)(function(v4) {
                    return checkTerm(v4.value0)(v4.value1);
                  }))(function(argsChecked) {
                    return pure23(new Xtor3(v.value0, v.value1, argsChecked, v1));
                  });
                });
              });
            });
      ...
      if (v instanceof XCase2 && (v.value1 instanceof Cons && v1 instanceof TyDecl2)) {
        var checkPattern = function(v2) {
          return function(varmap) {
            return bind24(lookupXtor2(v.value0)(v2.value0.ptxt))(function(v3) {
              var argsEmbedded = map210(embedType2)(v3.value0.sigArgs);
              var xtargs$prime = map210(substTyvars2(varmap))(argsEmbedded);
              return bind24(zipWithErrorM3(v2.value0.ptv)(xtargs$prime)(new ErrXtorArity2(v.value0, v3.value0.sigName)))(function(argsZipped) {
                return bind24(getCheckerVars)(function(currVars) {
                  var newVars = foldr7(function(v4) {
                    return function(m) {
                      return insert9(v4.value0)(v4.value1)(m);
                    };
                  })(currVars)(argsZipped);
                  return bind24(withCheckerVars(newVars)(checkCommand(v2.value0.ptcmd)))(function(c$prime) {
                    return pure23(new Pattern3({
                      ptxt: v2.value0.ptxt,
                      ptv: v2.value0.ptv,
                      ptcmd: c$prime
                    }));
        ...
        return bind24(lookupXtorDecl2(v.value0)(v.value1.value0.value0.ptxt))(function(v2) {
          return bind24(unless2(eq21(v1.value0)(v2.value0.declName))(throwError12(new ErrNotTyDecl(v.value0, v2.value0.declName, v1, v))))(function() {
            ...
            return bind24(unless2(eq110(fromFoldable1(ptxtns))(fromFoldable1(declxtns)))(throwError12(new ErrBadPattern(v.value0, ptxtns, declxtns, v))))(function() {
              return bind24(zipWithErrorM3(map210(function(v3) {
                return v3.value0.variantVar;
              })(v2.value0.declArgs))(v1.value1)(new ErrTypeArity(v.value0, v1.value0)))(function(varmap) {
                return bind24($$for12(v.value1)(function(x) {
                  return checkPattern(x)(fromFoldable7(varmap));
                }))(function(pts$prime) {
                  return pure23(new XCase3(v.value0, pts$prime, v1));
                });
              });
            });
          });
      ...
      if (v instanceof ShiftCBV2 && v1 instanceof TyShift2) {
        return bind24(checkTerm(v.value1)(v1.value0))(function(t$prime) {
          var newTy = new TyShift2(getType2(t$prime));
          return pure23(new ShiftCBV3(v.value0, t$prime, newTy));
        });
      }
      ;
      if (v instanceof ShiftCBN2 && v1 instanceof TyShift2) {
        return bind24(checkTerm(v.value1)(v1.value0))(function(t$prime) {
          var newTy = new TyShift2(getType2(t$prime));
          return pure23(new ShiftCBN3(v.value0, t$prime, newTy));
        });
      }
      ;
  ...
  var checkCommand = function(v) {
    if (v instanceof Cut2 && (v.value1 instanceof Var2 && v.value3 instanceof Var2)) {
      return bind24(getMTypeVar(v.value1.value1))(function(mty1) {
        return bind24(getMTypeVar(v.value3.value1))(function(mty2) {
          ...
          if (v3.value0 instanceof Just && v3.value1 instanceof Nothing) {
            return pure23(new Cut3(v.value0, new Var3(v.value1.value0, v.value1.value1, v3.value0.value0), v.value2, new Var3(v.value3.value0, v.value3.value1, v3.value0.value0)));
          }
          ;
          if (v3.value0 instanceof Nothing && v3.value1 instanceof Just) {
            return pure23(new Cut3(v.value0, new Var3(v.value1.value0, v.value1.value1, v3.value1.value0), v.value2, new Var3(v.value3.value0, v.value3.value1, v3.value1.value0)));
          }
          ;
          if (v3.value0 instanceof Just && v3.value1 instanceof Just) {
            var $145 = eq26(v3.value0.value0)(v3.value1.value0);
            if ($145) {
          ...
          ;
          throw new Error("Failed pattern match at TypeCheck.Terms (line 123, column 3 - line 127, column 156): " + [v3.constructor.name]);
        });
      });
    }
    ;
    if (v instanceof Cut2 && v.value1 instanceof Var2) {
      return bind24(getTypeVar(v.value1.value0)(v.value1.value1))(function(ty) {
        return bind24(checkTerm(v.value3)(ty))(function(u$prime) {
          return pure23(new Cut3(v.value0, new Var3(v.value1.value0, v.value1.value1, ty), v.value2, u$prime));
        });
      });
    }
    ;
    if (v instanceof Cut2 && v.value3 instanceof Var2) {
      return bind24(getTypeVar(v.value3.value0)(v.value3.value1))(function(ty) {
        return bind24(checkTerm(v.value1)(ty))(function(t$prime) {
          return pure23(new Cut3(v.value0, t$prime, v.value2, new Var3(v.value3.value0, v.value3.value1, ty)));
        });
      });
    }
    ;
    if (v instanceof Cut2) {
      return throwError12(new ErrUnclearType(getLoc1(v), v));
    }
    ;
    if (v instanceof CutAnnot) {
      return bind24(checkType(v.value0)(v.value2))(function(ty1) {
        return bind24(checkType(v.value0)(v.value2))(function(ty2) {
          return bind24(checkTerm(v.value1)(ty1))(function(t$prime) {
            return bind24(checkTerm(v.value4)(ty2))(function(u$prime) {
              return pure23(new Cut3(v.value0, t$prime, v.value3, u$prime));
            });
          });
        });
      });
    ...
    ;
    if (v instanceof Done3) {
      return pure23(new Done4(v.value0));
    }
    ;
    if (v instanceof Err2) {
      return pure23(new Err3(v.value0, v.value1));
    }
    ;
    if (v instanceof Print2 && v.value1 instanceof Var2) {
      return bind24(getTypeVar(v.value1.value0)(v.value1.value1))(function(ty) {
        return pure23(new Print3(v.value0, new Var3(v.value1.value0, v.value1.value1, ty)));
      });
    }
    ;
    if (v instanceof Print2) {
    ...
    ;
    if (v instanceof PrintAnnot) {
      return bind24(checkType(v.value0)(v.value2))(function(ty$prime) {
        return bind24(checkTerm(v.value1)(ty$prime))(function(t$prime) {
          return pure23(new Print3(v.value0, t$prime));
        });
      });
    }
    ;
    throw new Error("Failed pattern match at TypeCheck.Terms (line 119, column 1 - line 119, column 46): " + [v.constructor.name]);
  };
  ...
  var pure24 = /* @__PURE__ */ pure(/* @__PURE__ */ applicativeReaderT(/* @__PURE__ */ applicativeStateT(monadExceptT14)));
  var bind25 = /* @__PURE__ */ bind(/* @__PURE__ */ bindReaderT(/* @__PURE__ */ bindStateT(monadExceptT14)));
  var getTypeAnnot = function(v) {
    return function(v1) {
      return function(v2) {
        ...
        ;
        if (v2 instanceof Just) {
          return pure24(v2.value0);
        }
        ;
        throw new Error("Failed pattern match at TypeCheck.Program (line 20, column 1 - line 20, column 61): " + [v.constructor.name, v1.constructor.name, v2.constructor.name]);
      };
    };
  };
  var checkVarDecl = function(v) {
    return bind25(getTypeAnnot(v.value0.varPos)(v.value0.varName)(v.value0.varTy))(function(ty) {
      return bind25(checkType(v.value0.varPos)(ty))(function(ty$prime) {
        return bind25(checkTerm(v.value0.varBody)(ty$prime))(function(t$prime) {
          return pure24(new VarDecl2({
            varPos: v.value0.varPos,
            varName: v.value0.varName,
            varTy: ty$prime,
            varBody: t$prime
  ...
  var checkRecDecl = function(v) {
    return bind25(getTypeAnnot(v.value0.recPos)(v.value0.recName)(v.value0.recTy))(function(ty) {
      return bind25(checkType(v.value0.recPos)(ty))(function(ty$prime) {
        return bind25(addCheckerVar(v.value0.recName)(ty$prime))(function() {
          return bind25(checkTerm(v.value0.recBody)(ty$prime))(function(t$prime) {
            return pure24(new RecDecl2({
              recPos: v.value0.recPos,
              recName: v.value0.recName,
              recTy: ty$prime,
              recBody: t$prime
  ...
  var applicativeStateT3 = /* @__PURE__ */ applicativeStateT(monadExceptT15);
  var pure25 = /* @__PURE__ */ pure(applicativeStateT3);
  var bind26 = /* @__PURE__ */ bind(/* @__PURE__ */ bindStateT(monadExceptT15));
  var gets6 = /* @__PURE__ */ gets(/* @__PURE__ */ monadStateStateT(monadExceptT15));
  var show49 = /* @__PURE__ */ show(showCommand);
  var liftErr2 = /* @__PURE__ */ liftErr(errorEvalError);
  var throwError14 = /* @__PURE__ */ throwError(/* @__PURE__ */ monadThrowStateT(/* @__PURE__ */ monadThrowExceptT(monadIdentity)));
  var show123 = /* @__PURE__ */ show(showVariable);
  var liftErr1 = /* @__PURE__ */ liftErr(errorCheckerError);
  var liftErr22 = /* @__PURE__ */ liftErr(errorKindError);
  var show217 = /* @__PURE__ */ show(showTypename);
  ...
  var elemIndex4 = /* @__PURE__ */ elemIndex2(eqModulename);
  var show312 = /* @__PURE__ */ show(showModulename);
  var liftErr5 = /* @__PURE__ */ liftErr(errorDesugarError);
  var lookup8 = /* @__PURE__ */ lookup(ordModulename);
  var show410 = /* @__PURE__ */ show(/* @__PURE__ */ showList(showModulename));
  var map39 = /* @__PURE__ */ map(functorList);
  var $$for13 = /* @__PURE__ */ $$for(applicativeStateT3);
  var for12 = /* @__PURE__ */ $$for13(traversableList);
  var for22 = /* @__PURE__ */ $$for13(traversableMap);
  var toUnfoldable10 = /* @__PURE__ */ toUnfoldable3(unfoldableList);
  var show54 = /* @__PURE__ */ show(/* @__PURE__ */ showList(showVariable));
  var elemIndex1 = /* @__PURE__ */ elemIndex2(eqVariable);
  var append14 = /* @__PURE__ */ append(semigroupList);
  var fromFoldable8 = /* @__PURE__ */ fromFoldable(ordVariable)(foldableList);
  var for3 = /* @__PURE__ */ $$for13(traversableMaybe);
  var map113 = /* @__PURE__ */ map(/* @__PURE__ */ functorStateT(/* @__PURE__ */ functorExceptT(functorIdentity)));
  ...
  var runProgramTrace = function(v) {
    ...
    return bind26(gets6(function(v1) {
      return v1.value0.drvEnv;
    }))(function(env) {
      return bind26(debug("evaluating " + show49(main3)))(function() {
        var evaled = runEvalM(env)(evalWithTrace(main3));
        return liftErr2(evaled)("evaluation (with trace)");
      });
    });
  };
  var runProgram = function(v) {
    if (isNothing(v.value0.progMain)) {
      return pure25(new Done2(defaultLoc));
    }
    ;
    var main3 = fromMaybe(new Done2(defaultLoc))(v.value0.progMain);
    return bind26(gets6(function(v1) {
  ...
  var inferVarDecl = function(v) {
    return function(v1) {
      ...
      ;
      return bind26(debug("type checking variable " + show123(v1.value0.varName)))(function() {
        return bind26(gets6(function(v3) {
  ...
  var inferRecDecl = function(v) {
    return function(v1) {
      if (isNothing(v1.value0.recTy)) {
        return throwError14(new ErrTypeInference(v1.value0.recPos));
      }
      ;
      return bind26(debug("type checking recursive variable " + show123(v1.value0.recName)))(function() {
        return bind26(gets6(function(v2) {
          return v2.value0.drvEnv;
        }))(function(env) {
          var r$prime = runCheckM(env)(checkRecDecl(v1));
          return bind26(liftErr1(r$prime)("type checking (recursive)"))(function(r$prime$prime) {
            var rk = runKindM(env)(kindRecDecl(r$prime$prime));
            return bind26(liftErr22(rk)("kind recdecl"))(function(rk$prime) {
              return bind26(addRecDecl(v)(rk$prime))(function() {
                return pure25(rk$prime);
              });
            });
          });
        });
  ...
  var inferDataDecl = function(mn) {
    return function(v) {
      return bind26(debug("infering declaration " + show217(v.value0.declName)))(function() {
  ...
  var inferCommand = function(c) {
    return bind26(gets6(function(v) {
  ...
  var getInferOrder = function(mn) {
    return function(progs) {
      return bind26(gets6(function(v) {
        return v.value0.drvEnv;
      }))(function(env) {
        var order = runDepM(env)(depOrderModule(mn)(progs));
        return bind26(liftErr4(order)("dependency order (modules)"))(function(order$prime) {
          var indexFun = function(v) {
            return function(v1) {
              return compare4(elemIndex4(v.value0.progName)(order$prime))(elemIndex4(v1.value0.progName)(order$prime));
            };
          };
          return pure25(sortBy(indexFun)(progs));
        });
      });
    };
  };
  var desugarProg = function(v) {
    return bind26(debug("desugaring program " + show312(v.value0.progName)))(function() {
      return bind26(gets6(function(v1) {
        return v1.value0.drvEnv;
      }))(function(env) {
  ...
  var inferProgram = function(v) {
    return function(imports) {
      var getRights = function(v1) {
        if (v1 instanceof Nil) {
          return Nil.value;
        }
        ;
        if (v1 instanceof Cons && v1.value0 instanceof Left) {
          return getRights(v1.value1);
        }
        ;
        if (v1 instanceof Cons && v1.value0 instanceof Right) {
          return new Cons(v1.value0.value0, getRights(v1.value1));
        }
        ;
        throw new Error("Failed pattern match at Driver.Driver (line 123, column 7 - line 123, column 59): " + [v1.constructor.name]);
      };
      var getLefts = function(v1) {
        if (v1 instanceof Nil) {
          return Nil.value;
        }
        ;
        if (v1 instanceof Cons && v1.value0 instanceof Right) {
          return getLefts(v1.value1);
        }
        ;
        if (v1 instanceof Cons && v1.value0 instanceof Left) {
          return new Cons(v1.value0.value0, getLefts(v1.value1));
        }
        ;
        throw new Error("Failed pattern match at Driver.Driver (line 118, column 7 - line 118, column 58): " + [v1.constructor.name]);
      };
      return bind26(gets6(function(v1) {
        return v1.value0.drvEnv;
      }))(function(v1) {
        var currProg = fromMaybe(emptyProg2(v.value0.progName)(""))(lookup8(v.value0.progName)(v1.envDefs));
        var $130 = !isEmpty2(currProg);
        if ($130) {
          return pure25(currProg);
        }
        ;
        var imports$prime = filter(function(v2) {
          return isNothing(lookup8(v2.value0.progName)(v1.envDefs));
        })(imports);
        return bind26(debug("ordering imports"))(function() {
          return bind26(getInferOrder(v)(imports$prime))(function(depsOrdered) {
            return bind26(debug("infering imports in order: " + show410(map39(function(v2) {
              return v2.value0.progName;
            })(depsOrdered))))(function() {
              return bind26(for12(depsOrdered)(function(x) {
                return inferProgram(x)(Nil.value);
              }))(function() {
                return bind26(debug("desugaring program " + show312(v.value0.progName)))(function() {
                  return bind26(desugarProg(v))(function(v2) {
                    return bind26(debug("inferring declarations in " + show312(v.value0.progName)))(function() {
                      return bind26(for22(v2.value0.progDecls)(inferDataDecl(v2.value0.progName)))(function(decls$prime) {
                        var varNames = map39(fst)(toUnfoldable10(v.value0.progVars));
                        return bind26(debug("ordering variables " + (show54(varNames) + (" in " + show312(v.value0.progName)))))(function() {
                          return bind26(gets6(function(v3) {
                            return v3.value0.drvEnv;
                          }))(function(env$prime) {
                            var progOrder = runDepM(env$prime)(depOrderProgram(v));
                            return bind26(liftErr4(progOrder)("dependency order (variables)"))(function(progOrder$prime) {
                              return bind26(debug("inferring variables in order " + show54(progOrder$prime)))(function() {
                                var nameFun = function(v3) {
                                  if (v3 instanceof Left) {
                                    return v3.value0.value0.varName;
                                  }
                                  ;
                                  if (v3 instanceof Right) {
                                    return v3.value0.value0.recName;
                                  }
                                  ;
                                  throw new Error("Failed pattern match at Driver.Driver (line 94, column 9 - line 94, column 58): " + [v3.constructor.name]);
                                };
                                var indexFun = function(v11) {
                                  return function(v21) {
                                    return compare4(elemIndex1(nameFun(v11))(progOrder$prime))(elemIndex1(nameFun(v21))(progOrder$prime));
                                  };
                                };
                                var varsRecs = append14(map39(Left.create)(map39(snd)(toUnfoldable10(v2.value0.progVars))))(map39(Right.create)(map39(snd)(toUnfoldable10(v2.value0.progRecs))));
                                var varsRecsSorted = sortBy(indexFun)(varsRecs);
                                var inferFun = function(v3) {
                                  if (v3 instanceof Left) {
                                    return bind26(inferVarDecl(v.value0.progName)(v3.value0))(function(var$prime) {
                                      return pure25(new Left(var$prime));
                                    });
                                  }
                                  ;
                                  if (v3 instanceof Right) {
                                    return bind26(inferRecDecl(v.value0.progName)(v3.value0))(function(rec$prime) {
                                      return pure25(new Right(rec$prime));
                                    });
                                  }
                                  ;
                                  throw new Error("Failed pattern match at Driver.Driver (line 100, column 9 - line 100, column 87): " + [v3.constructor.name]);
                                };
                                return bind26(for12(varsRecsSorted)(inferFun))(function(varRecsInferred) {
                                  var varsInferred = getLefts(varRecsInferred);
                                  var recsInferred = getRights(varRecsInferred);
                                  var varFun = function(v3) {
                                    return new Tuple(v3.value0.varName, new VarDecl3(v3.value0));
                                  };
                                  var recFun = function(v3) {
                                    return new Tuple(v3.value0.recName, new RecDecl3(v3.value0));
                                  };
                                  var varMap = fromFoldable8(map39(varFun)(varsInferred));
                                  var recsMap = fromFoldable8(map39(recFun)(recsInferred));
                                  return bind26(debug("inferring main"))(function() {
                                    return bind26(for3(v2.value0.progMain)(inferCommand))(function(main$prime) {
                                      return pure25(new Program2({
                                        progName: v.value0.progName,
                                        progDecls: decls$prime,
                                        progVars: varMap,
                                        progRecs: recsMap,
                                        progMain: main$prime,
                                        progSrc: v2.value0.progSrc
                                      }));
                                    });
                                  });
                                });
  ...
  var getMessage2 = /* @__PURE__ */ getMessage(errorDriverError);
  var show50 = /* @__PURE__ */ show(showCommand);
  var show124 = /* @__PURE__ */ show(showDriverState);
  var show218 = /* @__PURE__ */ show(/* @__PURE__ */ showList(showCommand));
  ...
  var ResSucc = /* @__PURE__ */ function() {
    function ResSucc2(value0, value1, value22) {
      this.value0 = value0;
      this.value1 = value1;
      this.value2 = value22;
    }
    ...
    ResSucc2.create = function(value0) {
      return function(value1) {
        return function(value22) {
          return new ResSucc2(value0, value1, value22);
        };
      };
    };
    return ResSucc2;
  }();
  var ExTuple = /* @__PURE__ */ function() {
    function ExTuple2() {
    }
    ;
    ExTuple2.value = new ExTuple2();
    return ExTuple2;
  }();
  var ExList = /* @__PURE__ */ function() {
    function ExList2() {
    }
    ;
    ExList2.value = new ExList2();
    return ExList2;
  }();
  var ExFun = /* @__PURE__ */ function() {
    function ExFun2() {
    }
    ;
    ExFun2.value = new ExFun2();
    return ExFun2;
  }();
  var ExNat = /* @__PURE__ */ function() {
    function ExNat2() {
    }
    ;
    ExNat2.value = new ExNat2();
    return ExNat2;
  }();
  var ExampleSelect = /* @__PURE__ */ function() {
    function ExampleSelect2(value0) {
      this.value0 = value0;
    }
    ;
    ExampleSelect2.create = function(value0) {
      return new ExampleSelect2(value0);
    };
  ...
  var tupleStr = "data Pair(a:+,b:+){\n	Tup(a,b)\n}\n\ndata Nat {\n	Z,\n	S(Nat)\n}\n\ndata Fun(a:+,b:-) {\n	Ap(a,b)\n}\n\nprintCons :: forall X.X;\nprintCons := mu x.Print x;\n\nswap :: forall X Y. Fun(Pair(X,Y),Pair(Y,X));\nswap := case { Ap(p,a) =&gt;\n	&lt; case { \n		Tup(b,c) =&gt; &lt; Tup(c,b) | Pair(Y,X): CBV | a&gt;\n	} | CBV | p&gt;\n};\n\npair1 :: Pair(Nat,Nat);\npair1 := Tup(Z,S(Z));\n\n main := &lt; swap | CBV | Ap(pair1,printCons)&gt;;";
  var toRunResult = function(v) {
    if (v instanceof Left) {
      return new ResErr(getMessage2(v.value0));
    }
    ;
    if (v instanceof Right && v.value0.value0 instanceof Left) {
      return new ResSucc(show50(v.value0.value0.value0), "", show124(v.value0.value1));
    }
    ;
    if (v instanceof Right && v.value0.value0 instanceof Right) {
      return new ResSucc(show50(v.value0.value0.value0.value0), show218(v.value0.value0.value0.value1), show124(v.value0.value1));
    }
    ;
    throw new Error("Failed pattern match at Definitions (line 39, column 1 - line 39, column 96): " + [v.constructor.name]);
  };
  var runProg = function(progSource) {
    return toRunResult(runDriverM(initialDriverState)(runStr(progSource)(true)));
  };
  var natStr = "data Nat {\n	Z,\n	S(Nat)\n}\n\ndata Fun(a:+,b:-) { \n	Ap(a,b)\n}\n\nprintCons :: Forall X.X;\nprintCons := mu x. Print x;\n\npred :: Fun(Nat,Nat);\npred := case { Ap(n,a) =&gt;\n	&lt; case { \n		Z =&gt; &lt; Z | CBV | a&gt;,\nt		S(m) =&gt; &lt; m | CBV | a &gt;\n	} | CBV | n&gt;\n};\n\nnat1 :: Nat;\nnat1 := S(S(Z));\n\n main := &lt; pred | CBV | Ap(nat1,printCons)&gt;;";
  var listStr = "";
  var indexToEx = function(v) {
    if (v === 0) {
      return ExTuple.value;
    }
    ;
    if (v === 1) {
      return ExList.value;
  ...
  var funStr = "data Fun(a:+,b:-){ \n	Ap(a,b)\n}\n\ndata Unit {MkUnit}\n\nprintCons :: Forall X.X;\nprintCons := mu x. Print x;\n\nid :: forall X. Fun(X,X);\nid := case { Ap(x,a) =&gt; &lt;x | CBV | a&gt; };\n\nmain := &lt; id | CBV | Ap(MkUnit,printCons)&gt;; ";
  var getExSource = function(v) {
    if (v instanceof ExTuple) {
      return tupleStr;
    }
    ;
    if (v instanceof ExList) {
      return listStr;
    }
    ;
    if (v instanceof ExFun) {
      return funStr;
    }
    ;
    if (v instanceof ExNat) {
      return natStr;
    }
    ;
    throw new Error("Failed pattern match at Definitions (line 54, column 1 - line 54, column 34): " + [v.constructor.name]);
  };
  var initialState = function(v) {
    if (v instanceof ExampleSelect) {
      return {
        progSrc: getExSource(v.value0),
        runRes: new ResSucc("", "", "")
      };
    }
    ;
  ...
  var pure27 = /* @__PURE__ */ pure(applicativeAff);
  var bind1 = /* @__PURE__ */ bind(bindAff);
  var bindFlipped4 = /* @__PURE__ */ bindFlipped(bindAff);
  var $$finally = function(fin) {
    return function(a2) {
      return bracket(pure27(unit))($$const(fin))($$const(a2));
    };
  };
  var parallelAff = {
  ...
  var joinFiber = function(v) {
    return makeAff(function(k) {
      return map40(effectCanceler)(v.join(k));
    });
  };
  var functorFiber = {
    map: function(f) {
  ...
  var killFiber = function(e) {
    return function(v) {
      return bind1(liftEffect2(v.isSuspended))(function(suspended) {
        if (suspended) {
          return liftEffect2($$void3(v.kill(e, $$const(pure26(unit)))));
        }
        ;
        return makeAff(function(k) {
          return map40(effectCanceler)(v.kill(e, k));
        });
      });
    };
  };
  ...
  var nonCanceler = /* @__PURE__ */ $$const(/* @__PURE__ */ pure27(unit));

  // output/Events/index.js
  var selectExample = function(i2) {
    return new ExampleSelect(indexToEx(i2));
  };
  ...
  var handleAction = function(dictMonadState) {
    ...
    var bind30 = bind(dictMonadState.Monad0().Bind1());
    var gets7 = gets(dictMonadState);
    return function(inp) {
      if (inp instanceof ExampleSelect) {
        return modify_3(function(st) {
          ...
          ;
          $11.progSrc = getExSource(inp.value0);
          return $11;
        });
      }
      ;
      if (inp instanceof ProgramInput) {
        return modify_3(function(st) {
          ...
          ;
          $15.progSrc = inp.value0;
          return $15;
        });
      }
      ;
      if (inp instanceof RunProg) {
        return bind30(gets7(function(st) {
          return st.progSrc;
        }))(function(src9) {
      ...
      ;
      throw new Error("Failed pattern match at Events (line 21, column 20 - line 27, column 37): " + [inp.constructor.name]);
    };
  };
  ...
  var selectElement = function(query2) {
    return bind27(liftEffect3(bindFlipped5(composeKleisliFlipped2(function() {
      ...
      return pure28(bindFlipped1(fromElement)(mel));
    });
  };
  ...
  var awaitLoad = /* @__PURE__ */ makeAff(function(callback) {
    return function __do2() {
      ...
      if (rs instanceof Loading) {
        var et = map43(toEventTarget)(windowImpl)();
  ...
  var runGraft = /* @__PURE__ */ unGraft(function(v) {
    var go2 = function(v2) {
      ...
      if (v2 instanceof Elem) {
        return new Elem(v2.value0, v2.value1, v.value0(v2.value2), map44(go2)(v2.value3));
      }
      ;
      if (v2 instanceof Keyed) {
        return new Keyed(v2.value0, v2.value1, v.value0(v2.value2), map44(map115(go2))(v2.value3));
      }
      ;
  ...
  var pure29 = /* @__PURE__ */ pure(applicativeEither);
  ...
  var readInt = function(dictMonad) {
    var map52 = map(dictMonad.Bind1().Apply0().Functor0());
    var readNumber1 = readNumber(dictMonad);
    return function(value14) {
      var error4 = new Left(singleton7(new TypeMismatch("Int", tagOf(value14))));
      var fromNumber2 = function() {
        var $155 = maybe(error4)(pure29);
        return function($156) {
          return $155(fromNumber($156));
        };
      }();
      return mapExceptT(map52(either($$const(error4))(fromNumber2)))(readNumber1(value14));
    };
  };
  ...
  var buildProp = function(emit) {
    return function(el) {
      ...
      var haltProp = function(state3) {
        var v = lookup9("ref")(state3.props);
        ...
        var go2 = function($copy_v) {
          ...
          function $tco_loop(v) {
            if (v.value1.value0 instanceof Pure) {
              var v1 = goApply1(v.value0)(v.value1.value1)(pure35(v.value1.value0.value0));
  ...
  var uncons5 = function(v) {
    ...
    if (v instanceof CatCons) {
      return new Just(new Tuple(v.value0, function() {
        ...
        ;
        return foldr8(link)(CatNil.value)(v.value1);
      }()));
    }
    ;
  ...
  var pure30 = /* @__PURE__ */ pure(freeApplicative);
    ...
    return function(k) {
      var go2 = function(f) {
        ...
        if (v instanceof Return) {
          return map117(Done.create)(pure111(v.value0));
        }
        ;
  ...
  var create3 = function __do() {
    ...
    return {
      ...
      listener: function(a2) {
        return bind28(read(subscribers))(traverse_1(function(k) {
          return k(a2);
        }));
      }
    };
  ...
  var buildThunk = function(toVDom) {
    ...
    var $lazy_patchThunk = $runtime_lazy11("patchThunk", "Halogen.VDom.Thunk", function() {
    ...
    return function(v) {
      ...
      if (v instanceof Query) {
        return unCoyoneda(function(g) {
          var $45 = map45(maybe(v.value1(unit))(g));
          return function($46) {
  ...
  var defaultEval = /* @__PURE__ */ function() {
    return {
      handleAction: $$const(pure31(unit)),
      handleQuery: $$const(pure31(Nothing.value)),
  ...
  var lookup14 = /* @__PURE__ */ lookup(ordForkId);
  ...
  var unsubscribe3 = function(sid) {
    return function(ref2) {
      return function __do2() {
        ...
        return traverse_4(unsubscribe)(bindFlipped6(lookup11(sid))(subs))();
      };
    };
  };
  ...
  var evalQ = function(render2) {
    return function(ref2) {
      return function(q2) {
        return bind110(liftEffect4(read(ref2)))(function(v) {
          return evalM(render2)(ref2)(v["component"]["eval"](new Query(map47(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
        ...
        var go2 = function(ref2) {
          return function(v1) {
            ...
            if (v1 instanceof Subscribe) {
              return bind110(fresh(SubscriptionId)(ref2))(function(sid) {
                return bind110(liftEffect4(subscribe(v1.value0(sid))(function(act) {
                  ...
                  return bind110(liftEffect4(read(ref2)))(function(v2) {
                    return discard1(liftEffect4(modify_(map211(insert11(sid)(finalize)))(v2.subscriptions)))(function() {
            ...
            if (v1 instanceof Join) {
              return bind110(liftEffect4(read(ref2)))(function(v2) {
                return bind110(liftEffect4(read(v2.forks)))(function(forkMap) {
                  return discard1(traverse_32(joinFiber)(lookup14(v1.value0)(forkMap)))(function() {
                    return pure32(v1.value1);
                  });
                });
              });
            ...
            if (v1 instanceof Kill) {
              return bind110(liftEffect4(read(ref2)))(function(v2) {
                return bind110(liftEffect4(read(v2.forks)))(function(forkMap) {
                  return discard1(traverse_32(killFiber(error("Cancelled")))(lookup14(v1.value0)(forkMap)))(function() {
                    return pure32(v1.value1);
                  });
                });
              });
            ...
            if (v1 instanceof GetRef) {
              return bind110(liftEffect4(read(ref2)))(function(v2) {
                return pure32(v1.value1(lookup23(v1.value0)(v2.refs)));
              });
            }
            ;
            ...
            return function(childrenInRef) {
              return function(childrenOutRef) {
                return unComponentSlot(function(slot) {
                  return function __do2() {
                    var childrenIn = map48(slot.pop)(read(childrenInRef))();
                    var $$var2 = function() {
                    ...
                    return bind29(read($$var2))(renderStateX2(function(v) {
                      if (v instanceof Nothing) {
                        return $$throw("Halogen internal error: child was not initialized in renderChild");
                      }
                      ;
                      if (v instanceof Just) {
                        return pure33(renderSpec2.renderChild(v.value0));
                      }
                      ;
  ...
  var runUI2 = function(component2) {
    return function(i2) {
      return function(element3) {
        return bind112(liftEffect6(map50(toDocument)(bindFlipped8(document)(windowImpl))))(function(document2) {
  ...
  var unsafeReadProp = function(dictMonad) {
    ...
    var pure35 = pure(applicativeExceptT(dictMonad));
    return function(k) {
      return function(value14) {
        return unsafeReadPropImpl(fail3(new TypeMismatch("object", typeOf(value14))), pure35, k, value14);
      };
    };
  };
  ...
  var handler$prime = function(et) {
    return function(f) {
      return handler(et)(function(ev) {
        return map51(Action.create)(f(ev));
      });
    };
  };
  ...
  var resDiv = function(v) {
    if (v instanceof ResErr) {
      return div2([class_("results")])([h2_([text5("Results")]), div2([class_("evalError")])([text5(v.value0)])]);
    }
    ;
    if (v instanceof ResSucc) {
      return div2([class_("results")])([h1_([text5("Results")]), div2([class_("code"), id2("resultStr")])([text5(v.value0)]), br_, div_([text5("Types in Program")]), br_, textarea([id2("typeStr"), readOnly3(true), value13(v.value2)]), br_, div_([text5("Evaluation Trace")]), br_, textarea([id2("traceStr"), readOnly3(true), value13(v.value1)])]);
    }
    ;
    throw new Error("Failed pattern match at Layout (line 25, column 1 - line 25, column 45): " + [v.constructor.name]);
  };
  var progDiv = function(src9) {
    return div2([class_("prog")])([textarea([id2("progInput"), value13(src9), onValueChange(getSrc)]), button([id2("runButton"), onClick(runSrc)])([text5("Run")])]);
  };
  var exampleDiv = /* @__PURE__ */ function() {
    return div2([id2("examples")])([div2([id2("tuple")])([text5(getExSource(ExTuple.value))]), div2([id2("list")])([text5(getExSource(ExList.value))]), div2([id2("nat")])([text5(getExSource(ExNat.value))]), div2([id2("fun")])([text5(getExSource(ExFun.value))])]);
  }();
  var exSelect = /* @__PURE__ */ div_([/* @__PURE__ */ text5("Choose Example"), /* @__PURE__ */ select3([/* @__PURE__ */ id2("exampleSelect"), /* @__PURE__ */ onSelectedIndexChange(selectExample)])([/* @__PURE__ */ option2([/* @__PURE__ */ value13("tuple")])([/* @__PURE__ */ text5("Tuples")]), /* @__PURE__ */ option2([/* @__PURE__ */ value13("list")])([/* @__PURE__ */ text5("Lists")]), /* @__PURE__ */ option2([/* @__PURE__ */ value13("nat")])([/* @__PURE__ */ text5("Natural Numbers")]), /* @__PURE__ */ option2([/* @__PURE__ */ value13("fun")])([/* @__PURE__ */ text5("Functions")])])]);
  var debugDiv = function(src9) {
    return div_([text5(src9)]);
  };
  var layout = function(src9) {
    return function(res) {
      return body([])([h1_([text5("One Sided Sequent Calculus")]), debugDiv(src9), exSelect, progDiv(src9), resDiv(res), exampleDiv]);
    };
  };
  ...
  var uiRunner = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind(bindAff)(awaitBody)(function(body2) {
    return runUI2(component)(new ExampleSelect(ExTuple.value))(body2);
  }));
