(() => {
  ...
  var applyFirst = function(dictApply) {
    ...
    return function(a2) {
      return function(b2) {
        return apply1(map52($$const)(a2))(b2);
      };
    };
  };
            ...
            eqRecord: function(v) {
              return function(ra) {
                return function(rb) {
                  ...
                  return eq36(get4(ra))(get4(rb)) && tail2;
                };
              };
            }
          };
    ...
    return function(dictAlternative) {
      ...
      return function(p2) {
        var go2 = function(acc) {
          return bind113(alt11(map117(Loop.create)(p2))(pure34(new Done(unit))))(function(aa) {
            return pure34(bimap2(function(v) {
            ...
            return function($copy_b) {
              ...
              function $tco_loop(a2, b2) {
                ...
                if (v instanceof IterNext) {
                  var v2 = stepAsc(b2);
                  if (v2 instanceof IterNext && (eq111(v.value0)(v2.value0) && eq210(v.value1)(v2.value1))) {
                    $tco_var_a = v.value2;
                    $copy_b = v2.value2;
                    return;
                  }
  ...
  var show4 = /* @__PURE__ */ show(showModulename);
    ...
    return {
      getMessage: function(v) {
        ...
        if (v instanceof ErrNotFound) {
          return "Could not find " + (show4(v.value0) + " in Environment");
        }
        ;
        if (v instanceof ErrNotStdLib) {
          return "Modules " + (intercalate3(", ")(map8(show4)(v.value0)) + " are not in standard library");
        }
        ;
        ...
        ;
        throw new Error("Failed pattern match at Driver.Errors (line 17, column 1 - line 30, column 21): " + [v.constructor.name]);
      },
  ...
  var showTy = {
    show: function(v) {
      ...
      if (v instanceof TyDecl) {
        return show1(v.value0) + ("(" + (intercalate4(", ")(map9(show(showTy))(v.value1)) + ")"));
      }
      ;
      ...
      if (v instanceof TyForall) {
        return "forall " + (intercalate4(" ")(map9(show5)(v.value0)) + (". " + show(showTy)(v.value1)));
      }
      ;
  ...
  var showTy2 = {
    show: function(v) {
      ...
      if (v instanceof TyDecl2) {
        return show12(v.value0) + (" ( " + (intercalate5(", ")(map10(show(showTy2))(v.value1)) + ")"));
      }
      ;
      ...
      if (v instanceof TyForall2) {
        return "forall " + (intercalate5(" ")(map10(show6)(v.value0)) + (". " + show(showTy2)(v.value1)));
      }
      ;
  ...
  var show7 = /* @__PURE__ */ show(showVariable);
  var show13 = /* @__PURE__ */ show(showXtorname);
  ...
  var showTerm = {
    show: function(v) {
      if (v instanceof Var) {
        return show7(v.value1);
      }
      ;
      if (v instanceof Mu) {
        return "mu " + (show7(v.value1) + (", " + show(showCommand)(v.value2)));
      }
      ;
      if (v instanceof Xtor && $$null(v.value2)) {
        return show13(v.value1);
      }
      ;
      if (v instanceof Xtor) {
        return show13(v.value1) + ("(" + (intercalate6(", ")(map12(show(showTerm))(v.value2)) + ")"));
      }
      ;
  ...
  var showPattern = {
    show: function(v) {
      if ($$null(v.value0.ptv)) {
        return show13(v.value0.ptxt) + (" => " + show(showCommand)(v.value0.ptcmd));
      }
      ;
      return show13(v.value0.ptxt) + ("(" + (intercalate6(", ")(map12(show7)(v.value0.ptv)) + (") =>" + show(showCommand)(v.value0.ptcmd))));
    }
  };
  var showCommand = {
    show: function(v) {
  ...
  var showTerm2 = {
    show: function(v) {
      if (v instanceof Var2) {
        return show8(v.value1);
      }
      ;
      if (v instanceof Mu2) {
        return "mu " + (show8(v.value1) + (". " + show(showCommand2)(v.value2)));
      }
      ;
      ...
      if (v instanceof Xtor2) {
        return show14(v.value1) + ("(" + (intercalate7(", ")(map13(show(showTerm2))(v.value2)) + ")"));
      }
      ;
  ...
  var showPattern2 = {
    show: function(v) {
      if ($$null(v.value0.ptv)) {
        return show14(v.value0.ptxt) + ("=>" + show(showCommand2)(v.value0.ptcmd));
      }
      ;
      return show14(v.value0.ptxt) + ("(" + (intercalate7(", ")(map13(show8)(v.value0.ptv)) + (") => " + show(showCommand2)(v.value0.ptcmd))));
    }
  };
  var showCommand2 = {
    show: function(v) {
  ...
  var show15 = /* @__PURE__ */ show(showTy2);
  ...
  var showTerm3 = {
    show: function(v) {
      if (v instanceof Var3) {
        return show9(v.value1) + (": " + show15(v.value2));
      }
      ;
      if (v instanceof Mu3) {
        return show9(v.value1) + (", " + (show(showCommand3)(v.value2) + (": " + show15(v.value3))));
      }
      ;
      if (v instanceof Xtor3) {
        return show24(v.value1) + (intercalate8(", ")(map14(show(showTerm3))(v.value2)) + (": " + show15(v.value3)));
      }
      ;
      if (v instanceof XCase3) {
        return " case { " + (intercalate8(", ")(map14(show(showPattern3))(v.value1)) + (": " + show15(v.value2)));
      }
      ;
      if (v instanceof ShiftCBV3) {
        return "{" + (show(showTerm3)(v.value1) + (":CBV} : " + show15(v.value2)));
      }
      ;
      if (v instanceof ShiftCBN3) {
        return "{" + (show(showTerm3)(v.value1) + (":CBM} : " + show15(v.value2)));
      }
      ;
  ...
  var showPattern3 = {
    show: function(v) {
      ...
      ;
      return show24(v.value0.ptxt) + ("(" + (intercalate8(", ")(map14(show9)(v.value0.ptv)) + (" => " + show(showCommand3)(v.value0.ptcmd))));
    }
  };
  var showCommand3 = {
    show: function(v) {
  ...
  var xtorErr = function(loc) {
    return function(dictError) {
      ...
      return function(xtn) {
        return toError2(loc)("Xtor " + (show16(xtn) + " not found in environment"));
      };
    };
  };
    ...
    return function(dictMonadError) {
      ...
      return function(dictMonadReader) {
        return bind30(getDecls2(dictMonadReader))(function(decls) {
          return pure34(map17(fst)(toUnfoldable6(decls)));
        });
      };
    };
  };
    ...
    return function(dictMonadError) {
      ...
      return function(dictMonadReader) {
        return bind30(getDecls2(dictMonadReader))(function(decls) {
          ...
          return pure34(concatMap(function(v) {
    ...
    return function(dictMonadError) {
      ...
      return function(dictMonadReader) {
        return bind30(getXtors2(dictMonadReader))(function(xtors) {
          return pure34(map17(function(v) {
      ...
      return function(dictMonadReader) {
        ...
        return function(xtn) {
          return bind30(getXtors3)(function(xtors) {
            return pure34(find2(function(v) {
      ...
      return function(dictMonadReader) {
        ...
        return function(xtn) {
          return bind30(getDecls3)(function(decls) {
            ...
            return pure34(find2(inDecl)(declLs));
          });
        };
      };
    };
  ...
  var getEdgesEndingAt = function(dictEq) {
    var eq30 = eq(eqVertex(dictEq));
    return function(vert) {
      return function(v) {
        return filter(function(e) {
          return eq30(getEndingVert(e))(vert);
        })(v.value0.grEdges);
      };
    };
  };
  var getEdgesStartingAt = function(dictEq) {
    ...
    return function(vert) {
      return function(v) {
        return filter(function(e) {
          return eq30(getStartingVert(e))(vert);
        })(v.value0.grEdges);
      };
    };
  };
  ...
  var eqEdge = function(dictEq) {
    ...
    return {
      eq: function(x) {
        return function(y) {
          return eq30(x.value0)(y.value0) && eq30(x.value1)(y.value1);
        };
      }
    };
  };
  ...
  var addVertex = function(dictEq) {
    ...
    return function(dictOrd) {
      var insert11 = insert2(ordVertex(dictOrd));
      return function(v) {
        return function(v1) {
          ...
          if (v3 instanceof Nothing) {
            return new Tuple(v, new MkGraph({
              grVerts: insert11(v)(v1.value0.grVerts),
  ...
  var addEdge = function(dictEq) {
    var elem14 = elem4(eqEdge(dictEq));
    return function(v) {
      return function(v1) {
  ...
  var removeSelfLoops = function(dictShow) {
    return function(dictEq) {
      var notEq4 = notEq(eqVertex(dictEq));
      return bind4(gets3(function(v) {
        return v.value0;
      }))(function(gr) {
        var newEdgs = filter(function(v) {
          return notEq4(v.value0)(v.value1);
        })(gr.grEdges);
  ...
  var ensureAcyclic = function(dictShow) {
    return function(dictEq) {
      ...
      var elem14 = elem5(eqVertex(dictEq));
  ...
  var show10 = /* @__PURE__ */ show(showModulename);
    ...
    return {
      getMessage: function(v) {
        if (v instanceof ErrDuplModule) {
          return "Module " + (show10(v.value0) + " was defined multiple times");
        }
        ;
        if (v instanceof ErrUndefinedModule) {
          return "Module " + (show10(v.value0) + " was not defined");
        }
        ;
        if (v instanceof ErrMutualRec) {
          return "Mutual Recusrion in module " + show10(v.value0);
        }
        ;
        if (v instanceof ErrUndefinedVar) {
          return "Variable " + (show17(v.value1) + " was not defined");
        }
        ;
  ...
  var show11 = /* @__PURE__ */ show(showTypevar);
  var show18 = /* @__PURE__ */ show(showTypename);
  ...
  var eq17 = /* @__PURE__ */ eq(eqTypename);
  var eq26 = /* @__PURE__ */ eq(/* @__PURE__ */ eqList(eqTypevar));
  ...
  var showTy4 = {
    show: function(v) {
      ...
      if (v instanceof TyDecl4) {
        return show18(v.value0) + ("(" + (intercalate9(", ")(map20(show(showTy4))(v.value1)) + ")"));
      }
      ;
      ...
      if (v instanceof TyForall4) {
        return "forall " + (intercalate9(", ")(map20(show11)(v.value0)) + (". " + show(showTy4)(v.value1)));
      }
      ;
    ...
    eq: function(x) {
      return function(y) {
        ...
        if (x instanceof TyDecl4 && y instanceof TyDecl4) {
          return eq17(x.value0)(y.value0) && eq(eqList(eqTy4))(x.value1)(y.value1);
        }
        ;
        ...
        if (x instanceof TyForall4 && y instanceof TyForall4) {
          return eq26(x.value0)(y.value0) && eq(eqTy4)(x.value1)(y.value1);
        }
        ;
        return false;
      };
  ...
  var show19 = /* @__PURE__ */ show(showVariable);
  ...
  var eq18 = /* @__PURE__ */ eq(eqVariable);
  var eq27 = /* @__PURE__ */ eq(eqXtorname);
  var eq35 = /* @__PURE__ */ eq(/* @__PURE__ */ eqList(eqVariable));
  var eq44 = /* @__PURE__ */ eq(eqEvaluationOrder);
  var eq53 = /* @__PURE__ */ eq(eqTy4);
  ...
  var showTerm4 = {
    show: function(v) {
      if (v instanceof Var4) {
        return show19(v.value1);
      }
      ;
      if (v instanceof Mu4) {
        return "mu " + (show19(v.value1) + (". " + show(showCommand4)(v.value2)));
      }
      ;
      if (v instanceof Xtor4 && $$null(v.value2)) {
        return show110(v.value1);
      }
      ;
      if (v instanceof Xtor4) {
        return show110(v.value1) + ("(" + (intercalate10(", ")(map21(show(showTerm4))(v.value2)) + ")"));
      }
      ;
  ...
  var showPattern4 = {
    show: function(v) {
      if ($$null(v.value0.ptv)) {
        return show110(v.value0.ptxt) + (" => " + show(showCommand4)(v.value0.ptcmd));
      }
      ;
      return show110(v.value0.ptxt) + ("(" + (intercalate10(", ")(map21(show19)(v.value0.ptv)) + (") => " + show(showCommand4)(v.value0.ptcmd))));
    }
  };
  var showCommand4 = {
    show: function(v) {
      if (v instanceof Cut4) {
        return "\u3008" + (show(showTerm4)(v.value1) + (" | " + (show26(v.value2) + (" | " + (show(showTerm4)(v.value3) + "\u3009")))));
      }
      ;
      if (v instanceof CutAnnot2) {
        return "\u3008" + (show(showTerm4)(v.value1) + (" | " + (show36(v.value2) + (" | " + (show26(v.value3) + (" | " + (show(showTerm4)(v.value4) + "\u3009")))))));
      }
      ;
  ...
  var hasLocCommand3 = {
    getLoc: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Syntax.Parsed.Terms (line 30, column 1 - line 43, column 55): " + [v.constructor.name]);
    },
    setLoc: function(v) {
      return function(v1) {
        ...
        ;
        throw new Error("Failed pattern match at Syntax.Parsed.Terms (line 30, column 1 - line 43, column 55): " + [v.constructor.name, v1.constructor.name]);
      };
    }
  };
  var eqTerm2 = {
    eq: function(x) {
      return function(y) {
        if (x instanceof Var4 && y instanceof Var4) {
          return x.value0.locEnd.srcCol === y.value0.locEnd.srcCol && x.value0.locEnd.srcLine === y.value0.locEnd.srcLine && (x.value0.locStart.srcCol === y.value0.locStart.srcCol && x.value0.locStart.srcLine === y.value0.locStart.srcLine) && eq18(x.value1)(y.value1);
        }
        ;
        if (x instanceof Mu4 && y instanceof Mu4) {
          return x.value0.locEnd.srcCol === y.value0.locEnd.srcCol && x.value0.locEnd.srcLine === y.value0.locEnd.srcLine && (x.value0.locStart.srcCol === y.value0.locStart.srcCol && x.value0.locStart.srcLine === y.value0.locStart.srcLine) && eq18(x.value1)(y.value1) && eq(eqCommand3)(x.value2)(y.value2);
        }
        ;
        if (x instanceof Xtor4 && y instanceof Xtor4) {
          return x.value0.locEnd.srcCol === y.value0.locEnd.srcCol && x.value0.locEnd.srcLine === y.value0.locEnd.srcLine && (x.value0.locStart.srcCol === y.value0.locStart.srcCol && x.value0.locStart.srcLine === y.value0.locStart.srcLine) && eq27(x.value1)(y.value1) && eq(eqList(eqTerm2))(x.value2)(y.value2);
        }
        ;
  ...
  var eqPattern2 = {
    eq: function(x) {
      return function(y) {
        return eq(eqCommand3)(x.value0.ptcmd)(y.value0.ptcmd) && eq35(x.value0.ptv)(y.value0.ptv) && eq27(x.value0.ptxt)(y.value0.ptxt);
      };
    }
  };
  var eqCommand3 = {
  ...
  var addEdgesVariableT = function(v) {
    return function(v1) {
      return function(v2) {
        if (v2 instanceof Var4) {
          return bind6(lookupMVar2(v2.value1))(function(mdef) {
            return bind6(lookupMXtor2(function(v3) {
              ...
              var $73 = isJust(mdef) || (isJust(mxtor) || elem22(v2.value1)(v1));
              if ($73) {
                return pure5(unit);
              }
              ;
        ...
        ;
        throw new Error("Failed pattern match at Dependencies.VariablesGraph (line 41, column 1 - line 41, column 77): " + [v.constructor.name, v1.constructor.name, v2.constructor.name]);
      };
    };
  };
  ...
  var addEdgesVariableC = function(v) {
    return function(v1) {
      return function(v2) {
        ...
        ;
        throw new Error("Failed pattern match at Dependencies.VariablesGraph (line 64, column 1 - line 64, column 80): " + [v.constructor.name, v1.constructor.name, v2.constructor.name]);
      };
    };
  };
  var depOrderProgram = function(v) {
    return bind6($$for4(v.value0.progVars)(addVariable))(function(vertsTerms) {
    ...
    return {
      getMessage: function(v) {
        if (v instanceof ErrVariable) {
          return "Definition for variable " + (show20(v.value1) + "could not be found");
        }
        ;
        ...
        if (v instanceof ErrMultipleAnnot) {
          return "Multiple incompatible annotations for variable" + (show20(v.value1) + (": " + (show27(v.value2) + (" and " + show27(v.value3)))));
        }
        ;
    ...
    return bind7(lookupMXtor3(xtn))(function(msig) {
      return bind7(gets4(function(v) {
        ...
        var doneDecls = function(v2) {
          return map23(snd)(toUnfoldable8(v2.value0.progDecls));
        }(doneProg);
  ...
  var getDesDefNames = /* @__PURE__ */ bind7(getDesDoneProg)(function(doneProg) {
    var doneNames = function(v) {
      return map23(fst)(toUnfoldable8(v.value0.progDecls));
    }(doneProg);
    return bind7(gets4(function(v) {
    ...
    return bind10(getDesDoneVar(v.value0.annotPos)(v.value0.annotName))(function(v1) {
      return bind10(desugarTy(v.value0.annotType))(function(ty$prime) {
        ...
        if (v1.value0.varTy instanceof Just) {
          var $60 = eq19(ty$prime)(v1.value0.varTy.value0);
          if ($60) {
            return pure9(unit);
          }
          ;
  ...
  var eq20 = /* @__PURE__ */ eq(eqCommand);
  ...
  var evalWithTrace = function(c) {
    return function(tr2) {
      return bind11(evalOnce(c))(function(c$prime) {
        return bind11(when3(eq20(c)(c$prime))(throwError7(new ErrLoop(getLoc1(c), c))))(function() {
  ...
  var applicativeReaderT11 = /* @__PURE__ */ applicativeReaderT(/* @__PURE__ */ applicativeExceptT(monadIdentity));
  var pure14 = /* @__PURE__ */ pure(applicativeReaderT11);
  ...
  var show117 = /* @__PURE__ */ show(/* @__PURE__ */ showMaybe(/* @__PURE__ */ showList(showVariable)));
  var show212 = /* @__PURE__ */ show(showCommand4);
  ...
  var parseErr = /* @__PURE__ */ function() {
    var charlsToStr = function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Parser.Terms (line 178, column 5 - line 178, column 39): " + [v.constructor.name]);
    };
    return bind20(getCurrPos)(function(startPos) {
      return bind20(parseKeyword(KwError.value))(function() {
        var v = trace2("parsed keyword error ")(function(v1) {
          return unit;
        });
        return bind20(sc)(function() {
          return bind20(parseSymbol(SymQuot.value))(function() {
            var v1 = trace2('parsed "')(function(v2) {
              return unit;
            });
            return bind20(many(noneOf(['"'])))(function(msg) {
              return bind20(parseSymbol(SymQuot.value))(function() {
                return bind20(getCurrLoc(startPos))(function(loc) {
  ...
  var $lazy_parseC = /* @__PURE__ */ $runtime_lazy6("parseC", "Parser.Terms", function() {
    return alt6(/* @__PURE__ */ function(v) {
      ...
      return $lazy_parseCut(129);
    }(unit))(alt6(function(v) {
      return $$try2($lazy_parseCutCBV(130));
    }(unit))(alt6(function(v) {
      return $$try2($lazy_parseCutCBN(131));
    }(unit))(alt6(function(v) {
      return $$try2($lazy_parsePrint(132));
    }(unit))(function(v) {
      return $$try2($lazy_parsePrintAnnot(133));
    }(unit)))))));
  });
  var $lazy_parseCommand = /* @__PURE__ */ $runtime_lazy6("parseCommand", "Parser.Terms", function() {
    return alt6(parseParens(function(v) {
      return $lazy_parseC(123);
    }(unit)))(function(v) {
      return $lazy_parseC(123);
    }(unit));
  });
  var $lazy_parseCut = /* @__PURE__ */ $runtime_lazy6("parseCut", "Parser.Terms", function() {
    return bind20(getCurrPos)(function(startPos) {
      return bind20(parseAngO)(function() {
        return bind20(sc)(function() {
          return bind20($lazy_parseTerm(140))(function(t) {
            var v = trace2("parsed term " + (show38(t) + " in cut (first term"))(function(v1) {
              return unit;
            });
            return bind20(sc)(function() {
                ...
                return bind20(sc)(function() {
                  return bind20(parseCutAnnot)(function(v1) {
                    return bind20(sc)(function() {
                      return bind20(parseSymbol(SymBar.value))(function() {
                        return bind20(sc)(function() {
                          return bind20($lazy_parseTerm(149))(function(u2) {
                            var v2 = trace2("parsed term " + (show38(u2) + " in cut (second term"))(function(v3) {
                              return unit;
                            });
                            return bind20(sc)(function() {
                              return bind20(parseAngC)(function() {
                                return bind20(getCurrLoc(startPos))(function(loc) {
                                  ...
                                  ;
                                  throw new Error("Failed pattern match at Parser.Terms (line 154, column 3 - line 156, column 46): " + [v1.value1.constructor.name]);
                                });
                              });
                            });
                          });
  ...
  var $lazy_parseCutCBN = /* @__PURE__ */ $runtime_lazy6("parseCutCBN", "Parser.Terms", function() {
    return bind20(getCurrPos)(function(startPos) {
      return bind20($lazy_parseTerm(231))(function(t) {
        return bind20(sc)(function() {
          return bind20(parseAngO)(function() {
            return bind20(parseAngO)(function() {
              return bind20(sc)(function() {
                return bind20(optionMaybe($$try2(bind20(parseTy)(function(ty) {
                  ...
                  return bind20($lazy_parseTerm(243))(function(u2) {
                    return bind20(getCurrLoc(startPos))(function(loc) {
                      ...
                      ;
                      throw new Error("Failed pattern match at Parser.Terms (line 245, column 3 - line 247, column 46): " + [mty.constructor.name]);
                    });
                  });
                });
              });
  ...
  var $lazy_parseCutCBV = /* @__PURE__ */ $runtime_lazy6("parseCutCBV", "Parser.Terms", function() {
    return bind20(getCurrPos)(function(startPos) {
      return bind20($lazy_parseTerm(210))(function(t) {
        return bind20(sc)(function() {
          return bind20(parseAngC)(function() {
            return bind20(parseAngC)(function() {
              return bind20(sc)(function() {
                return bind20(optionMaybe($$try2(bind20(parseTy)(function(ty) {
                  ...
                  return bind20($lazy_parseTerm(222))(function(u2) {
                    return bind20(getCurrLoc(startPos))(function(loc) {
                      if (mty instanceof Nothing) {
                      ...
                      ;
                      throw new Error("Failed pattern match at Parser.Terms (line 224, column 5 - line 226, column 48): " + [mty.constructor.name]);
                    });
                  });
                });
              });
          ...
          return bind20(parseVariable)(function(v) {
            return bind20(sc)(function() {
              return bind20(parseSymbol(SymDot.value))(function() {
                return bind20(sc)(function() {
                  return bind20($lazy_parseCommand(50))(function(c) {
                    return bind20(getCurrLoc(startPos))(function(loc) {
  ...
  var $lazy_parsePattern = /* @__PURE__ */ $runtime_lazy6("parsePattern", "Parser.Terms", function() {
    return bind20(parseXtorname)(function(nm) {
      var v = trace2("parsed xtorname " + (show31(nm) + " in pattern"))(function(v1) {
        return unit;
      });
      return bind20(sc)(function() {
        return bind20(optionMaybe(parseParens(sepBy(parseVariable)(parseCommaSep))))(function(args) {
          var v1 = trace2("parsed pattern args " + show117(args))(function(v2) {
            return unit;
          });
          return bind20(sc)(function() {
            return bind20(parseSymbol(SymEq.value))(function() {
              return bind20(parseAngC)(function() {
                return bind20(sc)(function() {
                  return bind20($lazy_parseCommand(116))(function(c) {
                    var v2 = trace2("parsed rhs of pattern " + show212(c))(function(v3) {
                      return unit;
                    });
                    ...
                    ;
                    throw new Error("Failed pattern match at Parser.Terms (line 118, column 3 - line 120, column 61): " + [args.constructor.name]);
                  });
                });
              });
            });
  ...
  var $lazy_parsePrint = /* @__PURE__ */ $runtime_lazy6("parsePrint", "Parser.Terms", function() {
    return bind20(getCurrPos)(function(startPos) {
      return bind20(alt6(parseKeyword(KwPrint.value))(parseKeyword(Kwprint.value)))(function() {
        return bind20(sc)(function() {
          return bind20($lazy_parseTerm(202))(function(t) {
            return bind20(sc)(function() {
              return bind20(getCurrLoc(startPos))(function(loc) {
  ...
  var $lazy_parsePrintAnnot = /* @__PURE__ */ $runtime_lazy6("parsePrintAnnot", "Parser.Terms", function() {
    return bind20(getCurrPos)(function(startPos) {
      return bind20(alt6(parseKeyword(KwPrint.value))(parseKeyword(Kwprint.value)))(function() {
        return bind20(sc)(function() {
          return bind20($lazy_parseTerm(188))(function(t) {
            return bind20(sc)(function() {
              return bind20(parseSymbol(SymColon.value))(function() {
                return bind20(parseSymbol(SymColon.value))(function() {
                  return bind20(sc)(function() {
  ...
  var $lazy_parseShift = /* @__PURE__ */ $runtime_lazy6("parseShift", "Parser.Terms", function() {
    return bind20(getCurrPos)(function(startPos) {
      return bind20(parseSymbol(SymBrackO.value))(function() {
        return bind20(sc)(function() {
          return bind20($lazy_parseTerm(73))(function(t) {
            return bind20(sc)(function() {
              return bind20(parseSymbol(SymColon.value))(function() {
                return bind20(sc)(function() {
                  return bind20(parseEvaluationOrder)(function(eo) {
                    return bind20(parseSymbol(SymBrackC.value))(function() {
                      return bind20(getCurrLoc(startPos))(function(loc) {
                        ...
                        ;
                        throw new Error("Failed pattern match at Parser.Terms (line 80, column 3 - line 82, column 33): " + [eo.constructor.name]);
                      });
                    });
                  });
                });
  ...
  var $lazy_parseT = /* @__PURE__ */ $runtime_lazy6("parseT", "Parser.Terms", function() {
    return alt6(function(v) {
      return $lazy_parseMu(35);
    }(unit))(alt6(function(v) {
      return $lazy_parseXCase(36);
    }(unit))(alt6(function(v) {
      return $lazy_parseShift(37);
    }(unit))(alt6(function(v) {
      return $$try2($lazy_parseXtor(38));
    }(unit))(/* @__PURE__ */ function(v) {
      return parseVar;
    }(unit)))));
  });
    ...
    return bind20(getCurrPos)(function(startPos) {
      return bind20(parseKeyword(KwCase.value))(function() {
        return bind20(sc)(function() {
          return bind20(parseSymbol(SymBrackO.value))(function() {
            return bind20(sc)(function() {
              var v = trace2("parsed case {")(function(v1) {
                return unit;
              });
              return bind20(sepBy($lazy_parsePattern(62))(parseCommaSep))(function(pts) {
                return bind20(sc)(function() {
                  return bind20(parseSymbol(SymBrackC.value))(function() {
                    return bind20(getCurrLoc(startPos))(function(loc) {
      ...
      return bind20(parseXtorname)(function(nm) {
        return bind20(sc)(function() {
          return bind20(parseSymbol(SymParensO.value))(function() {
            return bind20(sc)(function() {
              return bind20(sepBy($lazy_parseTerm(91))(parseCommaSep))(function(args) {
                return bind20(sc)(function() {
  ...
  var parseCommand = /* @__PURE__ */ $lazy_parseCommand(122);
  var parseTerm = /* @__PURE__ */ $lazy_parseTerm(30);

  // output/Syntax.Parsed.Program/index.js
  var eq45 = /* @__PURE__ */ eq(eqTerm2);
  var eq62 = /* @__PURE__ */ eq(eqVariable);
  ...
  var eqVarDecl = {
    eq: function(x) {
      return function(y) {
        return eq45(x.value0.varBody)(y.value0.varBody) && x.value0.varIsRec === y.value0.varIsRec && eq62(x.value0.varName)(y.value0.varName) && (x.value0.varPos.locEnd.srcCol === y.value0.varPos.locEnd.srcCol && x.value0.varPos.locEnd.srcLine === y.value0.varPos.locEnd.srcLine && (x.value0.varPos.locStart.srcCol === y.value0.varPos.locStart.srcCol && x.value0.varPos.locStart.srcLine === y.value0.varPos.locStart.srcLine));
      };
    }
  };
  ...
  var parseModuleDecl = /* @__PURE__ */ function() {
    return alt7(bind21(sc)(function() {
      return bind21(parseKeyword(KwModule.value))(function() {
    ...
    return bind21(parseModuleDecl)(function(nm) {
      return bind21(sc)(function() {
        return bind21(manyTill(bind21(parseDecl)(function(decl) {
          ...
          var progRes = foldr7(foldFun)(emptyProg3(nm)(src9))(decls);
          return pure20(progRes);
        });
      });
    });
  };
...
`;
    ...
    return {
      getMessage: function(v) {
        ...
        if (v instanceof ErrTyCoForShift) {
          return "Cannot use co-type of " + (show44(v.value2) + (" for shift term " + show52(v.value1)));
        }
        ;
        if (v instanceof ErrKindNeq) {
          return "Kinds of types " + (show44(v.value1) + (" and " + (show44(v.value2) + (" are not equal " + whileTerm(v.value3)))));
        }
        ;
        if (v instanceof ErrNotSubsumed) {
          return "Type " + (show44(v.value1) + (" should be subsumed by " + show44(v.value2)));
        }
        ;
        ...
        if (v instanceof ErrTypeNeq) {
          return "Types " + (show44(v.value1) + (" and " + (show44(v.value2) + (" should be equal " + whileTerm(v.value3)))));
        }
        ;
        if (v instanceof ErrNotTyDecl) {
          return "Type " + (show44(v.value2) + (" should be " + (show72(v.value1) + (" " + whileTerm(v.value3)))));
        }
        ;
        ...
        if (v instanceof ErrCutKind) {
          return "Kind of types " + (show44(v.value1) + (" and " + (show44(v.value2) + (" in cut are not equal " + whileCmd(v.value3)))));
        }
        ;
    ...
    return function(ty) {
      return bind22(modify9(function(v1) {
        return new MkCheckState({
          ...
          checkVars: insert7(v)(ty)(v1.value0.checkVars)
        });
      }))(function() {
        return pure21(unit);
      });
  ...
  var difference4 = /* @__PURE__ */ difference2(ordTypevar);
  var fromFoldable8 = /* @__PURE__ */ fromFoldable2(foldableList)(ordTypevar);
  ...
  var freeTypevarsTy = {
    freeTypevars: function(v) {
      ...
      ;
      if (v instanceof TyDecl2) {
        return unions5(map36(freeTypevars(freeTypevarsTy))(v.value1));
      }
      ;
      if (v instanceof TyShift2) {
      ...
      ;
      if (v instanceof TyForall2) {
        return difference4(freeTypevars(freeTypevarsTy)(v.value1))(fromFoldable8(v.value0));
      }
      ;
      throw new Error("Failed pattern match at FreeVars.FreeTypevars (line 22, column 1 - line 27, column 85): " + [v.constructor.name]);
    }
  };
  var freeTypevars1 = /* @__PURE__ */ freeTypevars(freeTypevarsTy);
  var generalize = function(v) {
    if (v instanceof TyForall2) {
      var args$prime = freeTypevars1(v.value1);
      return new TyForall2(append5(v.value0)(toUnfoldable9(args$prime)), v.value1);
    }
    ;
    var args = toUnfoldable9(freeTypevars1(v));
    var $35 = $$null(args);
    if ($35) {
      return v;
    }
    ;
    return new TyForall2(args, v);
  };
  ...
  var substituteTypevarsTy = {
    substTyvars: function(v) {
      return function(v1) {
        ...
        ;
        if (v1 instanceof TyForall2) {
          var newmap = foldr8($$delete6)(v)(v1.value0);
  ...
  var $$for11 = /* @__PURE__ */ $$for(applicativeReaderT12)(traversableList);
    ...
    return function(v1) {
      ...
      if (v1 instanceof TyDecl) {
        return bind23(lookupDecl2(v)(v1.value0))(function(v2) {
          return bind23(zipWithErrorM3(v1.value1)(v2.value0.declArgs)(new ErrTypeArity(v, v1.value0)))(function() {
  ...
  var zipWithErrorM4 = /* @__PURE__ */ zipWithErrorM(errorCheckerError)(monadErrorReaderT6);
  ...
  var checkTerm = function(v) {
    return function(v1) {
      ...
      ;
      if (v instanceof Var2) {
        return bind24(map38(lookup8(v.value1))(getCheckerVars))(function(checkerTy) {
          return bind24(lookupMVar4(v.value1))(function(vardecl) {
            ...
            return bind24(function() {
              ...
              var $83 = isSubsumed(generalize(v1))(ty$prime);
              if ($83) {
      ...
      if (v instanceof Xtor2 && v1 instanceof TyDecl2) {
        return bind24(lookupXtorDecl2(v.value0)(v.value1))(function(v2) {
          return bind24(lookupXtor2(v.value0)(v.value1))(function(v3) {
            return bind24(unless3(eq21(v1.value0)(v2.value0.declName))(throwError12(new ErrNotTyDecl(v.value0, v2.value0.declName, v1, v))))(function() {
              var argVars = map210(function(v4) {
                return v4.value0.variantVar;
              })(v2.value0.declArgs);
              return bind24(zipWithErrorM4(argVars)(v1.value1)(new ErrTypeArity(v.value0, v1.value0)))(function(varSubsts) {
                var argsEmbedded = map210(embedType2)(v3.value0.sigArgs);
                var xtArgTys = map210(substTyvars2(fromFoldable9(varSubsts)))(argsEmbedded);
                return bind24(zipWithErrorM4(v.value2)(xtArgTys)(new ErrXtorArity2(v.value0, v.value1)))(function(argsToCheck) {
        ...
        var checkPattern = function(v2) {
          return function(varmap) {
            return bind24(lookupXtor2(v.value0)(v2.value0.ptxt))(function(v3) {
              ...
              return bind24(zipWithErrorM4(v2.value0.ptv)(xtargs$prime)(new ErrXtorArity2(v.value0, v3.value0.sigName)))(function(argsZipped) {
                return bind24(getCheckerVars)(function(currVars) {
                  var newVars = foldr9(function(v4) {
                    return function(m) {
                      return insert8(v4.value0)(v4.value1)(m);
                    };
                  })(currVars)(argsZipped);
      ...
      return bind24(getMTypeVar(v.value1.value1))(function(mty1) {
        return bind24(getMTypeVar(v.value3.value1))(function(mty2) {
          ...
          if (v3.value0 instanceof Just && v3.value1 instanceof Just) {
            var $142 = eq28(v3.value0.value0)(v3.value1.value0);
            if ($142) {
  ...
  var eq29 = /* @__PURE__ */ eq(/* @__PURE__ */ eqList(eqVarDecl));
  ...
  var getVarOrder2 = function(v) {
    if (eq29(Nil.value)(v.value0.progVars)) {
    ...
    return bind26(debug("ordering variables in " + show311(v.value0.progName)))(function() {
      return bind26(gets7(function(v1) {
        ...
        return bind26(liftErr5(progOrder)("dependency order (variables)"))(function(progOrder$prime) {
          var orderStr = intercalate14(", ")(map39(show119)(progOrder$prime));
      ...
      return bind26(debug("Ordering Imports for " + show311(v.value0.progName)))(function() {
        return bind26(gets7(function(v2) {
          ...
          return bind26(liftErr5(order)("dependency order (modules)"))(function(order$prime) {
            ...
            return bind26(debug("ordered imports" + intercalate14(", ")(map39(function(v2) {
  ...
  var getImports = function(v) {
    ...
    return bind26(debug("loading standard library imports"))(function() {
      var imps = map39(function(v12) {
        return v12.value0.importName;
      })(v.value0.progImports);
      var maybeSrcs = map39(function(mn) {
      ...
      return bind26(unless4($$null(v1.value0))(throwError14(new ErrNotStdLib(v1.value0))))(function() {
        var impNames = map39(fst)(v1.value1);
        return bind26(debug("loading imports " + intercalate14(", ")(map39(show311)(impNames))))(function() {
          return bind26(for1(v1.value1)(function(v2) {
            return bind26(debug("loading import " + show311(v2.value0)))(function() {
            ...
            return bind26(debug("inferring declarations in " + show311(v1.value0.progName)))(function() {
              return bind26(for2(v1.value0.progDecls)(inferDataDecl(v1.value0.progName)))(function(decls$prime) {
                return bind26(getVarOrder2(v))(function(progOrder) {
                  ...
                  var varsSorted = sortBy(indexFun)(map39(snd)(toUnfoldable10(v1.value0.progVars)));
                  return bind26(debug("infering variables in " + show311(v1.value0.progName)))(function() {
                    return bind26(for1(varsSorted)(inferVarDecl(v1.value0.progName)))(function(kindedVars) {
                      var varmap = fromFoldable10(map39(function(v2) {
  ...
  var inferImportsOrdered = function(v) {
    if (v instanceof Nil) {
      return applySecond4(debug("No imports to infer, skipping inference"))(pure25(unit));
    }
    ;
  ...
  var initialState = function(v) {
    return {
      progSrc: intercalate1("\n")(lookup10(new Modulename("Bool"))(libMap)),
      runRes: new ResSucc({
        succCmd: "",
        succTrace: "",
        succDebug: ""
  ...
  var parSequence_ = function(dictParallel) {
    ...
    return function(dictApplicative) {
      ...
      return function(dictFoldable) {
        return parTraverse_2(dictFoldable)(identity12);
      };
    };
  };
  ...
  var selectExample = function(nm) {
    var v = lookup11(new Modulename(nm))(libMap);
    if (v instanceof Just) {
  ...
  var lookup14 = /* @__PURE__ */ function() {
  ...
  var buildProp = function(emit) {
    return function(el) {
      ...
      var haltProp = function(state3) {
        var v = lookup14("ref")(state3.props);
  ...
  var uncons5 = function(v) {
    ...
    if (v instanceof CatCons) {
      return new Just(new Tuple(v.value0, function() {
        ...
        ;
        return foldr10(link)(CatNil.value)(v.value1);
      }()));
    }
    ;
  ...
  var pure29 = /* @__PURE__ */ pure(freeApplicative);
  ...
  var defaultEval = /* @__PURE__ */ function() {
    return {
      handleAction: $$const(pure30(unit)),
      handleQuery: $$const(pure30(Nothing.value)),
        ...
        var go2 = function(ref2) {
          return function(v1) {
            ...
            if (v1 instanceof GetRef) {
              return bind110(liftEffect4(read(ref2)))(function(v2) {
                return pure31(v1.value1(lookup23(v1.value0)(v2.refs)));
              });
            }
            ;
                ...
                return unComponentSlot(function(slot) {
                  return function __do2() {
                    ...
                    return bind29(read($$var2))(renderStateX2(function(v) {
                      ...
                      ;
                      if (v instanceof Just) {
                        return pure32(renderSpec2.renderChild(v.value0));
                      }
                      ;
  ...
  var unsafeReadProp = function(dictMonad) {
    ...
    var pure34 = pure(applicativeExceptT(dictMonad));
    return function(k) {
      return function(value14) {
        return unsafeReadPropImpl(fail3(new TypeMismatch("object", typeOf(value14))), pure34, k, value14);
      };
    };
  };
